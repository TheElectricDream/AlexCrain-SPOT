###########################################################################
## Makefile generated for component 'CollectPhaseSpaceDataJetson'. 
## 
## Makefile     : CollectPhaseSpaceDataJetson.mk
## Generated on : Sun Jul 17 13:19:17 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/CollectPhaseSpaceDataJetson.elf
...
PRODUCT_NAME              = CollectPhaseSpaceDataJetson
MAKEFILE                  = CollectPhaseSpaceDataJetson.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/CollectPhaseSpaceDataJetson.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_WORKSPACE)/C/Users/SPOT/Documents/GitHub/AlexCrain-SPOT/Custom_Library/PhaseSpase_Cameras/PHASESPACE/include -I$(MATLAB_ROOT)/toolbox/shared/spc/src_ml/extern/include -I$(START_DIR)/CollectPhaseSpaceDataJetson_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/realtime/targets/raspi/include -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
DEFINES_STANDARD = -DMODEL=CollectPhaseSpaceDataJetson -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = socket.cpp.o owl_rpd.cpp.o owl.cpp.o libowl_socket.cpp.o libowl.cpp.o filters.cpp.o phasespace_functions.cpp.o DAHostLib_Network.c.o DAHostLib_rtw.c.o CollectPhaseSpaceDataJetson.cpp.o CollectPhaseSpaceDataJetson_data.cpp.o MW_raspi_init.c.o MW_Pyserver_control.c.o linuxinitialize.cpp.o linuxUDP.c.o
...
%.c.o : $(START_DIR)/CollectPhaseSpaceDataJetson_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/CollectPhaseSpaceDataJetson_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/CollectPhaseSpaceDataJetson_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.cpp.o : $(START_DIR)/CollectPhaseSpaceDataJetson_ert_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


CollectPhaseSpaceDataJetson.cpp.o : $(START_DIR)/CollectPhaseSpaceDataJetson_ert_rtw/CollectPhaseSpaceDataJetson.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


CollectPhaseSpaceDataJetson_data.cpp.o : $(START_DIR)/CollectPhaseSpaceDataJetson_ert_rtw/CollectPhaseSpaceDataJetson_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


MW_raspi_init.c.o : $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/realtime/targets/raspi/src/MW_raspi_init.c
	$(CC) $(CFLAGS) -o "$@" "$<"


MW_Pyserver_control.c.o : $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/realtime/targets/raspi/src/periphs/MW_Pyserver_control.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
linuxUDP.c.o : $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/realtime/targets/raspi/src/udp/linuxUDP.c
	$(CC) $(CFLAGS) -o "$@" "$<"
