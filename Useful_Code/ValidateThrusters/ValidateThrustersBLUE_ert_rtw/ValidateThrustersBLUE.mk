###########################################################################
## Makefile generated for Simulink model 'ValidateThrustersBLUE'. 
## 
## Makefile     : ValidateThrustersBLUE.mk
## Generated on : Fri Nov 11 15:42:18 2022
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ValidateThrustersBLUE.elf
...
PRODUCT_NAME              = ValidateThrustersBLUE
MAKEFILE                  = ValidateThrustersBLUE.mk
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = $(MATLAB_WORKSPACE)/C/Users/SPOT/Documents/GitHub/AlexCrain-SPOT/Useful_Code/ValidateThrusters
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ValidateThrustersBLUE.elf
...
DEFINES_STANDARD = -DMODEL=ValidateThrustersBLUE -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_pigs.c.o system.c.o ValidateThrustersBLUE.c.o ValidateThrustersBLUE_data.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o MW_raspi_init.c.o MW_Pyserver_control.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o
...
%.c.o : $(START_DIR)/ValidateThrustersBLUE_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/ValidateThrustersBLUE_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/ValidateThrustersBLUE_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/ValidateThrustersBLUE_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ValidateThrustersBLUE.c.o : $(START_DIR)/ValidateThrustersBLUE_ert_rtw/ValidateThrustersBLUE.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ValidateThrustersBLUE_data.c.o : $(START_DIR)/ValidateThrustersBLUE_ert_rtw/ValidateThrustersBLUE_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
