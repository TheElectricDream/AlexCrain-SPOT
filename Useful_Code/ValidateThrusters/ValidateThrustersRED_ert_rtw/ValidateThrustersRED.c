...
void ValidateThrustersRED_initialize(void)
{
  ...
  /* External mode info */
  ValidateThrustersRED_M->Sizes.checksums[0] = (3613661514U);
  ValidateThrustersRED_M->Sizes.checksums[1] = (1819341483U);
  ValidateThrustersRED_M->Sizes.checksums[2] = (475832331U);
  ValidateThrustersRED_M->Sizes.checksums[3] = (1839750400U);
