...
Phase3_SubPhase4_Duration      = 180;      % [s]
...
%%
Joint1Angle = [Imported_Arm.primal.time'+41, Imported_Arm.primal.states(4,:)'];
Joint2Angle = [Imported_Arm.primal.time'+41, Imported_Arm.primal.states(5,:)'];
Joint3Angle = [Imported_Arm.primal.time'+41, Imported_Arm.primal.states(6,:)'];
