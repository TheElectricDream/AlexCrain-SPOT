//
//  Combined_Experiment_ArmOnly_types.h
//
...
#ifndef RTW_HEADER_Combined_Experiment_ArmOnly_types_h_
#define RTW_HEADER_Combined_Experiment_ArmOnly_types_h_
#include "rtwtypes.h"
...
#ifndef typedef_cell_wrap_Combined_Experiment_T
#define typedef_cell_wrap_Combined_Experiment_T

typedef struct tag_PMfBDzoakfdM9QAdfx2o6D cell_wrap_Combined_Experiment_T;

#endif                                 //typedef_cell_wrap_Combined_Experiment_T
...
struct tag_MnuwZGhgu8kjqV344GyhbE
{
  ...
  cell_wrap_Combined_Experiment_T inputVarSize[3];
...
#ifndef typedef_fusion_simulink_ahrsfilter_Co_T
#define typedef_fusion_simulink_ahrsfilter_Co_T

typedef struct tag_MnuwZGhgu8kjqV344GyhbE fusion_simulink_ahrsfilter_Co_T;

#endif                                 //typedef_fusion_simulink_ahrsfilter_Co_T
...
#ifndef typedef_MoveArm_Position_Combined_Exp_T
#define typedef_MoveArm_Position_Combined_Exp_T

typedef struct tag_3RC6NfEVIcHRRlvHWvyPlD MoveArm_Position_Combined_Exp_T;

#endif                                 //typedef_MoveArm_Position_Combined_Exp_T
...
#ifndef typedef_InitializeForPosition_Combine_T
#define typedef_InitializeForPosition_Combine_T

typedef struct tag_Iad4FOcHYyCfKsXDQCpuHE InitializeForPosition_Combine_T;

#endif                                 //typedef_InitializeForPosition_Combine_T
...
#ifndef typedef_raspi_internal_PWMBlock_Combi_T
#define typedef_raspi_internal_PWMBlock_Combi_T

typedef struct tag_mJhNKAE3yyZ8cCBuxCC07F raspi_internal_PWMBlock_Combi_T;

#endif                                 //typedef_raspi_internal_PWMBlock_Combi_T
...
#ifndef typedef_codertarget_linux_blocks_Di_b_T
#define typedef_codertarget_linux_blocks_Di_b_T

typedef struct tag_rMOgeynmi8eZKnAJKOv0nC codertarget_linux_blocks_Di_b_T;

#endif                                 //typedef_codertarget_linux_blocks_Di_b_T
...
#ifndef typedef_PhaseSpace_ALL_Combined_Exper_T
#define typedef_PhaseSpace_ALL_Combined_Exper_T

typedef struct tag_ZyxIiycfJzMt4Mt69xwG3F PhaseSpace_ALL_Combined_Exper_T;

#endif                                 //typedef_PhaseSpace_ALL_Combined_Exper_T
...
typedef struct P_AHRS2_Combined_Experiment_A_T_ P_AHRS2_Combined_Experiment_A_T;

// Parameters for system: '<S179>/Calculate Running Mean'
typedef struct P_CalculateRunningMean_Combin_T_ P_CalculateRunningMean_Combin_T;

// Parameters for system: '<S194>/Calculate Running Mean'
typedef struct P_CalculateRunningMean_Comb_p_T_ P_CalculateRunningMean_Comb_p_T;

// Parameters for system: '<S8>/Change BLUE Behavior'
typedef struct P_ChangeBLUEBehavior_Combined_T_ P_ChangeBLUEBehavior_Combined_T;
...
typedef struct P_SubPhase2_Combined_Experime_T_ P_SubPhase2_Combined_Experime_T;

// Parameters for system: '<S318>/Sub-Phase #1'
typedef struct P_SubPhase1_Combined_Experime_T_ P_SubPhase1_Combined_Experime_T;

// Parameters for system: '<S318>/Sub-Phase #2 '
typedef struct P_SubPhase2_Combined_Experi_h_T_ P_SubPhase2_Combined_Experi_h_T;

// Parameters for system: '<S319>/Sub-Phase #1'
typedef struct P_SubPhase1_Combined_Experi_m_T_ P_SubPhase1_Combined_Experi_m_T;

// Parameters for system: '<S12>/Change BLUE Behavior'
typedef struct P_ChangeBLUEBehavior_Combin_c_T_ P_ChangeBLUEBehavior_Combin_c_T;

// Parameters (default storage)
typedef struct P_Combined_Experiment_ArmOnly_T_ P_Combined_Experiment_ArmOnly_T;

// Forward declaration for rtModel
typedef struct tag_RTM_Combined_Experiment_A_T RT_MODEL_Combined_Experiment__T;

#endif                       // RTW_HEADER_Combined_Experiment_ArmOnly_types_h_
