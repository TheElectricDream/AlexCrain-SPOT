...
Phase3_SubPhase1_Duration      = Phase3_Duration;        % [s]
...
drop_states_RED           = [ xLength-0.4, 1, pi]; % [m, m, rad]
drop_states_BLACK         = [ 1, 1, pi/2]; % [m, m, rad]
drop_states_BLUE          = [ 2, 1, 0]; % [m, m, rad]

init_states_RED           = [ xLength-0.4, 1, pi]; % [m, m, rad]
init_states_BLACK         = [ 1, 1, pi/2]; % [m, m, rad]
init_states_BLUE          = [ 2, 1, 0]; % [m, m, rad]
