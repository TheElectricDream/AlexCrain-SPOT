classdef PhaseSpace_RCV_Client < matlab.System ...
    ...
    methods
        % Constructor
        function obj = PhaseSpace_RCV_Client(varargin)
        ...
        function setupImpl(obj) 
            if isempty(coder.target)
                ...
                % Call C-function implementing device initialization
                 ...
                 %coder.ceval('initialize_phasespace_client',obj.PS_SampleRate);
            end
        end
    ...
    methods (Static, Access=protected)
       ...
       function header = getHeaderImpl
            header = matlab.system.display.Header('PhaseSpace_RCV_Client','Title',...
                'Stream PhaseSpace','Text',...
                ['This simulink '...
                'collects position data and attitude data for the platforms and arm.' newline]);
        end
