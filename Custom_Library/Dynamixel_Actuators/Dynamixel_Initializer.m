classdef Dynamixel_Initializer < matlab.System ...
    ...
    methods
        % Constructor
        function obj = Dynamixel_Initializer(varargin)
    ...
    methods (Static, Access=protected)
       ...
       function header = getHeaderImpl
            header = matlab.system.display.Header('Dynamixel_Initializer','Title',...
                'Initialize the Dynamixel Actuators','Text',...
                ['This block is required at the top level of any diagram and establishes a connection with'...
                 ' the dynamixel actuators. It has no inputs and no outputs.' newline]);
        end
