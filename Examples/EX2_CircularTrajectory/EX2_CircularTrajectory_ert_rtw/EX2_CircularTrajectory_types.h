//
//  EX2_CircularTrajectory_types.h
//
...
#ifndef RTW_HEADER_EX2_CircularTrajectory_types_h_
#define RTW_HEADER_EX2_CircularTrajectory_types_h_
#include "rtwtypes.h"
...
#ifndef typedef_cell_wrap_EX2_CircularTraject_T
#define typedef_cell_wrap_EX2_CircularTraject_T

typedef struct tag_PMfBDzoakfdM9QAdfx2o6D cell_wrap_EX2_CircularTraject_T;

#endif                                 //typedef_cell_wrap_EX2_CircularTraject_T
...
struct tag_MnuwZGhgu8kjqV344GyhbE
{
  ...
  cell_wrap_EX2_CircularTraject_T inputVarSize[3];
...
#ifndef typedef_raspi_internal_PWMBlock_EX2_C_T
#define typedef_raspi_internal_PWMBlock_EX2_C_T

typedef struct tag_mJhNKAE3yyZ8cCBuxCC07F raspi_internal_PWMBlock_EX2_C_T;

#endif                                 //typedef_raspi_internal_PWMBlock_EX2_C_T
...
#ifndef typedef_codertarget_linux_blocks_Di_m_T
#define typedef_codertarget_linux_blocks_Di_m_T

typedef struct tag_rMOgeynmi8eZKnAJKOv0nC codertarget_linux_blocks_Di_m_T;

#endif                                 //typedef_codertarget_linux_blocks_Di_m_T
...
#ifndef typedef_PhaseSpace_ALL_EX2_CircularTr_T
#define typedef_PhaseSpace_ALL_EX2_CircularTr_T

typedef struct tag_ZyxIiycfJzMt4Mt69xwG3F PhaseSpace_ALL_EX2_CircularTr_T;

#endif                                 //typedef_PhaseSpace_ALL_EX2_CircularTr_T
...
typedef struct P_AHRS2_EX2_CircularTrajector_T_ P_AHRS2_EX2_CircularTrajector_T;

// Parameters for system: '<S179>/Calculate Running Mean'
typedef struct P_CalculateRunningMean_EX2_Ci_T_ P_CalculateRunningMean_EX2_Ci_T;

// Parameters for system: '<S194>/Calculate Running Mean'
typedef struct P_CalculateRunningMean_EX2__p_T_ P_CalculateRunningMean_EX2__p_T;

// Parameters for system: '<S8>/Change BLUE Behavior'
typedef struct P_ChangeBLUEBehavior_EX2_Circ_T_ P_ChangeBLUEBehavior_EX2_Circ_T;
...
typedef struct P_SubPhase2_EX2_CircularTraje_T_ P_SubPhase2_EX2_CircularTraje_T;

// Parameters for system: '<S318>/Sub-Phase #1'
typedef struct P_SubPhase1_EX2_CircularTraje_T_ P_SubPhase1_EX2_CircularTraje_T;

// Parameters for system: '<S318>/Sub-Phase #2 '
typedef struct P_SubPhase2_EX2_CircularTra_h_T_ P_SubPhase2_EX2_CircularTra_h_T;

// Parameters for system: '<S319>/Sub-Phase #2 '
typedef struct P_SubPhase2_EX2_CircularTra_g_T_ P_SubPhase2_EX2_CircularTra_g_T;

// Parameters for system: '<S12>/Change BLUE Behavior'
typedef struct P_ChangeBLUEBehavior_EX2_Ci_c_T_ P_ChangeBLUEBehavior_EX2_Ci_c_T;

// Parameters (default storage)
typedef struct P_EX2_CircularTrajectory_T_ P_EX2_CircularTrajectory_T;

// Forward declaration for rtModel
typedef struct tag_RTM_EX2_CircularTrajector_T RT_MODEL_EX2_CircularTrajecto_T;

#endif                            // RTW_HEADER_EX2_CircularTrajectory_types_h_
