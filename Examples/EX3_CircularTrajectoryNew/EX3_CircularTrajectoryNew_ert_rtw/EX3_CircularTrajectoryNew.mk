###########################################################################
## Makefile generated for Simulink model 'EX3_CircularTrajectoryNew'. 
## 
## Makefile     : EX3_CircularTrajectoryNew.mk
## Generated on : Thu Mar 10 13:36:42 2022
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/EX3_CircularTrajectoryNew.elf
...
PRODUCT_NAME              = EX3_CircularTrajectoryNew
MAKEFILE                  = EX3_CircularTrajectoryNew.mk
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = $(MATLAB_WORKSPACE)/C/Users/SPOT/Documents/GitHub/AlexCrain-SPOT/Examples/EX3_CircularTrajectoryNew
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/EX3_CircularTrajectoryNew.elf
...
DEFINES_STANDARD = -DMODEL=EX3_CircularTrajectoryNew -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.c.o : $(START_DIR)/EX3_CircularTrajectoryNew_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/EX3_CircularTrajectoryNew_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/EX3_CircularTrajectoryNew_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.cpp.o : $(START_DIR)/EX3_CircularTrajectoryNew_ert_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


EX3_CircularTrajectoryNew.cpp.o : $(START_DIR)/EX3_CircularTrajectoryNew_ert_rtw/EX3_CircularTrajectoryNew.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


EX3_CircularTrajectoryNew_data.cpp.o : $(START_DIR)/EX3_CircularTrajectoryNew_ert_rtw/EX3_CircularTrajectoryNew_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetInf.cpp.o : $(START_DIR)/EX3_CircularTrajectoryNew_ert_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetNaN.cpp.o : $(START_DIR)/EX3_CircularTrajectoryNew_ert_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rt_nonfinite.cpp.o : $(START_DIR)/EX3_CircularTrajectoryNew_ert_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rt_zcfcn.cpp.o : $(START_DIR)/EX3_CircularTrajectoryNew_ert_rtw/rt_zcfcn.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
