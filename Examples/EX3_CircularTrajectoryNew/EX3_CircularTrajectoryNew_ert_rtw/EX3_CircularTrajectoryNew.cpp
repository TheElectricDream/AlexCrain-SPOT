...
#include "EX3_CircularTrajectoryNew_private.h"

// Block signals (default storage)
B_EX3_CircularTrajectoryNew_T EX3_CircularTrajectoryNew_B;

// Block states (default storage)
DW_EX3_CircularTrajectoryNew_T EX3_CircularTrajectoryNew_DW;

// Previous zero-crossings (trigger) states
PrevZCX_EX3_CircularTrajector_T EX3_CircularTrajectoryN_PrevZCX;

// Real-time model
RT_MODEL_EX3_CircularTrajecto_T EX3_CircularTrajectoryNew_M_ =
  RT_MODEL_EX3_CircularTrajecto_T();
RT_MODEL_EX3_CircularTrajecto_T *const EX3_CircularTrajectoryNew_M =
  &EX3_CircularTrajectoryNew_M_;

// Forward declaration for local functions
static void EX3_Ci_AHRSFilterBase_resetImpl(fusion_simulink_ahrsfilter_EX_T *obj);
static void IMUFusionCommon_computeAngularV(const real_T gfast[3], const real_T
  offset[3], real_T av[3]);
static void EX3_CircularTrajec_NED_ecompass(const real_T a[3], const real_T m[3],
  real_T R[9], B_AHRS2_EX3_CircularTrajector_T *localB);
static void EX3_C_quaternioncg_quaternioncg(const real_T varargin_1[9], real_T
  *obj_a, real_T *obj_b, real_T *obj_c, real_T *obj_d,
  B_AHRS2_EX3_CircularTrajector_T *localB);
static void EX3_quaternioncg_quaternioncg_f(const real_T varargin_1[3], real_T
  *obj_a, real_T *obj_b, real_T *obj_c, real_T *obj_d,
  B_AHRS2_EX3_CircularTrajector_T *localB);
static void EX3_Circu_quaternionBase_mtimes(real_T x_a, real_T x_b, real_T x_c,
...
static void IMUFusionCommon_predictOrientat(const
  ...
  real_T *b_qorient_d, B_AHRS2_EX3_CircularTrajector_T *localB);
static void EX3_Circu_quaternionBase_rotmat(real_T q_a, real_T q_b, real_T q_c,
  real_T q_d, real_T r[9], B_AHRS2_EX3_CircularTrajector_T *localB);
static void EX3__IMUFusionCommon_buildHPart(const real_T v[3], real_T h[9],
  B_AHRS2_EX3_CircularTrajector_T *localB);
static real_T EX3_CircularTrajectoryNew_norm(const real_T x[3],
  B_AHRS2_EX3_CircularTrajector_T *localB);
static void EX3_Circula_quaternionBase_conj(real_T q_a, real_T q_b, real_T q_c,
  real_T q_d, real_T *b_q_a, real_T *b_q_b, real_T *b_q_c, real_T *b_q_d);
static void EX3_Circu_quaternionBase_uminus(real_T obj_a, real_T obj_b, real_T
  obj_c, real_T obj_d, real_T *b_obj_a, real_T *b_obj_b, real_T *b_obj_c, real_T
  *b_obj_d);
static void EX3_Ci_quaternionBase_normalize(real_T q_a, real_T q_b, real_T q_c,
  real_T q_d, real_T *b_q_a, real_T *b_q_b, real_T *b_q_c, real_T *b_q_d);
static void EX3_Ci_quaternioncg_parenAssign(real_T rhs_a, real_T rhs_b, real_T
  rhs_c, real_T rhs_d, real_T *o_a, real_T *o_b, real_T *o_c, real_T *o_d);
static void EX3_Circula_ahrsfilter_stepImpl(fusion_simulink_ahrsfilter_EX_T *obj,
  const real_T accelIn[3], const real_T gyroIn[3], const real_T magIn[3], real_T
  orientOut[4], real_T av[3], B_AHRS2_EX3_CircularTrajector_T *localB);

// Forward declaration for local functions
static void matlabCodegenHandle_matlabCodeg(MoveArm_Position_EX3_Circular_T *obj);

// Forward declaration for local functions
static real_T EX3_CircularTraje_rt_atan2d_snf(real_T u0, real_T u1);
static real_T EX3__rt_urand_Upu32_Yd_f_pw_snf(uint32_T *u);
static real_T EX3__rt_nrand_Upu32_Yd_f_pw_snf(uint32_T *u);
static void EX3_CircularTraj_rt_invd3x3_snf(const real_T u[9], real_T y[9]);
static void EX3_Circul_SystemCore_release_l(const
  codertarget_linux_blocks_Digi_T *obj);
static void EX3_Circul_SystemCore_delete_lo(const
  codertarget_linux_blocks_Digi_T *obj);
static void matlabCodegenHandle_matlabCo_lo(codertarget_linux_blocks_Digi_T *obj);
static void EX3_Circu_SystemCore_release_lo(const
  codertarget_linux_blocks_Digi_T *obj);
static void EX3_Circu_SystemCore_delete_lot(const
  codertarget_linux_blocks_Digi_T *obj);
static void matlabCodegenHandle_matlabC_lot(codertarget_linux_blocks_Digi_T *obj);
static void E_SystemCore_rele_p(const PhaseSpace_ALL_EX3_CircularTr_T *obj);
static void E_SystemCore_dele_m(const PhaseSpace_ALL_EX3_CircularTr_T *obj);
static void EX3_CircularT_matlabCodegenHa_m(PhaseSpace_ALL_EX3_CircularTr_T *obj);
static void E_SystemCore_rele_m(const raspi_internal_lsm9ds1Block_E_T *obj);
static void E_SystemCore_dele_k(const raspi_internal_lsm9ds1Block_E_T *obj);
static void EX3_CircularT_matlabCodegenHa_k(raspi_internal_lsm9ds1Block_E_T *obj);
static void E_SystemCore_rele_b(j_codertarget_raspi_internal__T *obj);
static void E_SystemCore_dele_bq(j_codertarget_raspi_internal__T *obj);
static void EX3_Circular_matlabCodegenHa_bq(j_codertarget_raspi_internal__T *obj);
static void E_SystemCore_rele_k(i_codertarget_raspi_internal__T *obj);
static void E_SystemCore_dele_b(i_codertarget_raspi_internal__T *obj);
static void EX3_CircularT_matlabCodegenHa_b(i_codertarget_raspi_internal__T *obj);
static void EX3_Circular_SystemCore_release(const
  InitializeForPosition_EX3_Cir_T *obj);
static void EX3_Circula_SystemCore_delete_l(const
  InitializeForPosition_EX3_Cir_T *obj);
static void matlabCodegenHandle_matlabCod_l(InitializeForPosition_EX3_Cir_T *obj);
static void EX3_Circ_SystemCore_release_lot(const
  raspi_internal_PWMBlock_EX3_C_T *obj);
static void EX3_Circ_SystemCore_delete_loto(const
  raspi_internal_PWMBlock_EX3_C_T *obj);
static void matlabCodegenHandle_matlab_loto(raspi_internal_PWMBlock_EX3_C_T *obj);
static void SystemCore_release_loto3zjx3fst(const
  codertarget_linux_blocks_Di_l_T *obj);
static void SystemCore_delete_loto3zjx3fstw(const
  codertarget_linux_blocks_Di_l_T *obj);
static void matlabCodegenHand_loto3zjx3fstw(codertarget_linux_blocks_Di_l_T *obj);
static void SystemCore_releas_loto3zjx3fstw(const
  codertarget_linux_blocks_Digi_T *obj);
static void SystemCore_delet_loto3zjx3fstwa(const
  codertarget_linux_blocks_Digi_T *obj);
static void matlabCodegenHan_loto3zjx3fstwa(codertarget_linux_blocks_Digi_T *obj);
static void SystemCore_rele_loto3zjx3fstwan(const
  codertarget_linux_blocks_Digi_T *obj);
static void E_SystemCore_dele_p(const codertarget_linux_blocks_Digi_T *obj);
static void EX3_CircularT_matlabCodegenHa_p(codertarget_linux_blocks_Digi_T *obj);
static raspi_internal_lsm9ds1Block_E_T *EX3_C_lsm9ds1Block_lsm9ds1Block
  (raspi_internal_lsm9ds1Block_E_T *obj);
static void EX3_CircularTr_SystemCore_setup(raspi_internal_lsm9ds1Block_E_T *obj);
...
//
void EX3_CircularTrajectoryNew_SetEventsForThisBaseStep(boolean_T *eventFlags)
{
  // Task runs when its counter is zero, computed via rtmStepTask macro
  eventFlags[2] = ((boolean_T)rtmStepTask(EX3_CircularTrajectoryNew_M, 2));
}
...
static void rate_monotonic_scheduler(void)
{
  ...
  if (EX3_CircularTrajectoryNew_M->Timing.TaskCounters.TID[1] == 0) {
    EX3_CircularTrajectoryNew_M->Timing.RateInteraction.TID1_2 =
      (EX3_CircularTrajectoryNew_M->Timing.TaskCounters.TID[2] == 0);
  }
  ...
  (EX3_CircularTrajectoryNew_M->Timing.TaskCounters.TID[2])++;
  if ((EX3_CircularTrajectoryNew_M->Timing.TaskCounters.TID[2]) > 1) {// Sample time: [0.1s, 0.0s] 
    EX3_CircularTrajectoryNew_M->Timing.TaskCounters.TID[2] = 0;
  }
}
...
//
void EX3_Circula_MATLABFunction2(const real_T rtu_ThrustPer[8],
...
//
void EX3_Ci_CreateRotationMatrix(real_T rtu_Rz, B_CreateRotationMatrix_EX3_Ci_T *
  localB)
{
  real_T r;
  real_T t;
...
//
void EX3__CreateRotationMatrix_h(real_T rtu_Rz, B_CreateRotationMatrix_EX3__i_T *
  localB)
{
  real_T C_bI_tmp;
  real_T C_bI_tmp_0;
...
//
void EX3_Circular_MATLABFunction(B_MATLABFunction_EX3_Circular_T *localB)
{
  int32_T i;
  int32_T i_0;
  int32_T i_1;
  ...
  for (i = 0; i < 8; i++) {
    localB->v[i] = EX3_CircularTrajectoryNew_P.F_thrusters_BLUE[i] / 2.0;
  }
  ...
  for (i = 0; i < 8; i++) {
    ...
    localB->b[3 * i] = b[i];
    localB->b[3 * i + 1] = c[i];
    localB->b[3 * i + 2] = EX3_CircularTrajectoryNew_P.thruster_dist2CG_BLUE[i] /
      1000.0;
  }
  ...
  real_T *b_qorient_d, B_AHRS2_EX3_CircularTrajector_T *localB)
{
  ...
  EX3_quaternioncg_quaternioncg_f(localB->c, &localB->assign_temp_a_k,
    &localB->assign_temp_b_c, &localB->assign_temp_c_b, &localB->assign_temp_d_p,
    localB);
  EX3_Circu_quaternionBase_mtimes(qorient_a, qorient_b, qorient_c, qorient_d,
  ...
  orientOut[4], real_T av[3], B_AHRS2_EX3_CircularTrajector_T *localB)
{
  ...
  if (obj->pFirstTime) {
    ...
    EX3_CircularTrajec_NED_ecompass(accelIn, magIn, localB->Rprior, localB);
    EX3_C_quaternioncg_quaternioncg(localB->Rprior, &obj->pOrientPost.a,
  ...
  EX3_Circu_quaternionBase_rotmat(obj->pOrientPrior.a, obj->pOrientPrior.b,
  ...
  localB->gravityAccelGyroDiff[2] = (accelIn[2] + obj->pLinAccelPrior[2]) -
    localB->Rprior[8];
  EX3__IMUFusionCommon_buildHPart(&localB->Rprior[6], localB->h1, localB);
  for (c_0 = 0; c_0 < 3; c_0++) {
  ...
  EX3__IMUFusionCommon_buildHPart(localB->offDiag, localB->Rprior, localB);
  for (c_0 = 0; c_0 < 3; c_0++) {
  ...
  localB->temp = EX3_CircularTrajectoryNew_norm(localB->offDiag, localB);
  ...
  EX3_quaternioncg_quaternioncg_f(localB->gravityAccelGyroDiff, &localB->temp,
    &localB->smax, &localB->s, &localB->assign_temp_d_c, localB);
  EX3_Circula_quaternionBase_conj(localB->temp, localB->smax, localB->s,
    localB->assign_temp_d_c, &localB->assign_temp_a, &localB->assign_temp_b,
    &localB->assign_temp_c, &localB->assign_temp_d);
  EX3_Circu_quaternionBase_mtimes(obj->pOrientPrior.a, obj->pOrientPrior.b,
  ...
  if (obj->pOrientPost.a < 0.0) {
    EX3_Circu_quaternionBase_uminus(obj->pOrientPost.a, obj->pOrientPost.b,
      obj->pOrientPost.c, obj->pOrientPost.d, &obj->pOrientPost.a,
      &obj->pOrientPost.b, &obj->pOrientPost.c, &obj->pOrientPost.d);
  }

  EX3_Ci_quaternionBase_normalize(obj->pOrientPost.a, obj->pOrientPost.b,
    obj->pOrientPost.c, obj->pOrientPost.d, &obj->pOrientPost.a,
    &obj->pOrientPost.b, &obj->pOrientPost.c, &obj->pOrientPost.d);
  EX3_Circu_quaternionBase_rotmat(obj->pOrientPost.a, obj->pOrientPost.b,
  ...
  EX3_Ci_quaternioncg_parenAssign(obj->pOrientPost.a, obj->pOrientPost.b,
...
//    synthesized block
//
void EX3_CircularTraj_AHRS2_Init(const real_T rtu_0[3],
  ...
  *localP)
{
  ...
  EX3_Ci_AHRSFilterBase_resetImpl(&localDW->obj);
}
...
//    synthesized block
//
void EX3_CircularTrajector_AHRS2(const real_T rtu_0[3], const real_T rtu_1[3],
  const real_T rtu_2[3], B_AHRS2_EX3_CircularTrajector_T *localB,
  DW_AHRS2_EX3_CircularTrajecto_T *localDW, P_AHRS2_EX3_CircularTrajector_T
  *localP)
{
  int32_T tmp;
  ...
  EX3_Circula_ahrsfilter_stepImpl(&localDW->obj, rtu_0, rtu_1, rtu_2,
...
//
void EX3_Circu_ChangeOrientation(real_T rtu_u, real_T rtu_u_g, real_T rtu_u_d,
  B_ChangeOrientation_EX3_Circu_T *localB)
{
  int32_T i;
...
//    ...
//
void E_CalculateRunningMean_Init(B_CalculateRunningMean_EX3_Ci_T *localB,
...
//    ...
//
void EX3_Ci_CalculateRunningMean(real_T rtu_In1, B_CalculateRunningMean_EX3_Ci_T
  *localB, DW_CalculateRunningMean_EX3_C_T *localDW)
{
  int32_T n;
  int32_T str;
  int_T idxWidth;
...
//
void CalculateRunningMean_n_Init(B_CalculateRunningMean_EX3__e_T *localB,
...
//    '<S256>/Calculate Running Mean'
//
void EX3__CalculateRunningMean_a(real_T rtu_In1, B_CalculateRunningMean_EX3__e_T
  *localB, DW_CalculateRunningMean_EX3_e_T *localDW,
  P_CalculateRunningMean_EX3__p_T *localP)
{
  int32_T n;
  int32_T str;
  int_T idxWidth;
...
//
void EX3_Circul_MATLABFunction_f(real_T rtu_TIME, real_T rtu_SERVER,
...
//
void EX3_Circ_ChangeBLUEBehavior(P_ChangeBLUEBehavior_EX3_Circ_T *localP, real_T
  ...
  *rtd_RED_Tz_RW, real_T *rtd_RED_Tz_Shoulder, real_T *rtd_RED_Tz_Wrist)
{
  ...
  localDW->ThisIFblockdetermineswhetherorn = -1;
  if ((EX3_CircularTrajectoryNew_P.WhoAmI == 2.0) ||
      (EX3_CircularTrajectoryNew_P.simMode == 1.0)) {
  ...
  localDW->ThisIFblockdetermineswhethero_m = -1;
  if ((EX3_CircularTrajectoryNew_P.WhoAmI == 3.0) ||
      (EX3_CircularTrajectoryNew_P.simMode == 1.0)) {
    ...
    EX3_Circ_ChangeBLUEBehavior(&localP->ChangeBLUEBehavior, rtd_BLUE_Fx,
  ...
  localDW->ThisIFblockdetermineswhethero_n = -1;
  if ((EX3_CircularTrajectoryNew_P.WhoAmI == 1.0) ||
      (EX3_CircularTrajectoryNew_P.simMode == 1.0)) {
...
//    ...
//
void EX3_Circu_MATLABFunction2_o(real_T rtu_z, B_MATLABFunction2_EX3_Circu_n_T
  *localB)
{
  real_T Ox_tmp_tmp;
  real_T Ox_tmp_tmp_0;
...
//    ...
//
void EX3_Circula_MATLABFunction3(real_T rtu_z, B_MATLABFunction3_EX3_Circula_T
  *localB)
{
  real_T Ox_tmp;
  real_T Ox_tmp_0;
...
//    ...
//
void EX3_Circula_MATLABFunction4(const real_T rtu_Oy[2], const real_T rtu_e_in[2],
  B_MATLABFunction4_EX3_Circula_T *localB)
{
  real_T y;
  real_T scale;
  real_T absxk;
...
//    '<S317>/Sub-Phase #3 '
//
void EX3_CircularTraje_SubPhase2(P_SubPhase2_EX3_CircularTraje_T *localP, real_T
...
//
void EX3_Circu_MATLABFunction2_b(real_T rtu_z, B_MATLABFunction2_EX3_Circu_k_T
  *localB)
{
  real_T Ox_tmp_tmp;
  real_T Ox_tmp_tmp_0;
...
//    '<S318>/Sub-Phase #4'
//
void EX3_Circular_SubPhase1_Init(B_SubPhase1_EX3_CircularTraje_T *localB,
...
//    '<S318>/Sub-Phase #4'
//
void EX3_CircularTraje_SubPhase1(B_SubPhase1_EX3_CircularTraje_T *localB,
  DW_SubPhase1_EX3_CircularTraj_T *localDW, P_SubPhase1_EX3_CircularTraje_T
  ...
  *rtd_Float_State)
{
  ...
  localB->Subtract = EX3_CircularTrajectoryNew_P.init_states_BLUE[0] -
    *rtd_BLUE_Px;
  ...
  *rtd_BLUE_Fx = 1.0 / EX3_CircularTrajectoryNew_P.serverRate * localB->In1_p *
    EX3_CircularTrajectoryNew_P.Kd_xblue + EX3_CircularTrajectoryNew_P.Kp_xblue *
    localB->Subtract;

  // Sum: '<S356>/Subtract1' incorporates:
  //   Constant: '<S356>/Desired Py (BLUE)'

  localB->Subtract1 = EX3_CircularTrajectoryNew_P.init_states_BLUE[1] -
    *rtd_BLUE_Py;
  ...
  *rtd_BLUE_Fy = 1.0 / EX3_CircularTrajectoryNew_P.serverRate * localB->In1 *
    EX3_CircularTrajectoryNew_P.Kd_yblue + EX3_CircularTrajectoryNew_P.Kp_yblue *
    localB->Subtract1;

  // MATLAB Function: '<S364>/MATLAB Function2' incorporates:
  //   Constant: '<S356>/Desired Attitude (BLUE)'

  EX3_Circu_MATLABFunction2_o(EX3_CircularTrajectoryNew_P.init_states_BLUE[2],
    &localB->sf_MATLABFunction2);

  // MATLAB Function: '<S364>/MATLAB Function3'
  EX3_Circula_MATLABFunction3(*rtd_BLUE_Rz, &localB->sf_MATLABFunction3);
  ...
  EX3_Circula_MATLABFunction4(localB->sf_MATLABFunction2.Oy, rtb_Subtract2_o,
  ...
  *rtd_BLUE_Tz = 1.0 / EX3_CircularTrajectoryNew_P.serverRate * localB->In1_j *
    EX3_CircularTrajectoryNew_P.Kd_tblue + EX3_CircularTrajectoryNew_P.Kp_tblue *
...
//    '<S318>/Sub-Phase #4'
//
void EX3_Circul_SubPhase1_Update(B_SubPhase1_EX3_CircularTraje_T *localB,
...
//    '<S318>/Sub-Phase #3 '
//
void EX3_CircularTra_SubPhase2_m(P_SubPhase2_EX3_CircularTra_h_T *localP, real_T
  *rtd_BLUE_Fx, real_T *rtd_BLUE_Fy, real_T *rtd_BLUE_Tz, real_T
  *rtd_Float_State)
{
...
//    '<S319>/Sub-Phase #2 '
//
void EX3_CircularTra_SubPhase1_j(P_SubPhase1_EX3_CircularTra_m_T *localP, real_T
...
//
void E_ChangeBLUEBehavior_g_Init(B_ChangeBLUEBehavior_EX3_Ci_k_T *localB,
...
//    '<S13>/Change BLUE Behavior'
//
void EX3_Ci_ChangeBLUEBehavior_g(B_ChangeBLUEBehavior_EX3_Ci_k_T *localB,
  DW_ChangeBLUEBehavior_EX3_C_i_T *localDW, P_ChangeBLUEBehavior_EX3_Ci_c_T
  *localP, real_T *rtd_BLUE_Fx, real_T *rtd_BLUE_Fy, real_T *rtd_BLUE_Px, real_T
  *rtd_BLUE_Py, real_T *rtd_BLUE_Rz, real_T *rtd_BLUE_Tz, real_T
  *rtd_Float_State)
{
  ...
  localB->Subtract = EX3_CircularTrajectoryNew_P.home_states_BLUE[0] -
    *rtd_BLUE_Px;
  ...
  *rtd_BLUE_Fx = 1.0 / EX3_CircularTrajectoryNew_P.serverRate * localB->In1_k *
    EX3_CircularTrajectoryNew_P.Kd_xblue + EX3_CircularTrajectoryNew_P.Kp_xblue *
    localB->Subtract;
  ...
  localB->Subtract1 = EX3_CircularTrajectoryNew_P.home_states_BLUE[1] -
    *rtd_BLUE_Py;
  ...
  *rtd_BLUE_Fy = 1.0 / EX3_CircularTrajectoryNew_P.serverRate * localB->In1 *
  ...
  EX3_Circu_MATLABFunction2_o(EX3_CircularTrajectoryNew_P.home_states_BLUE[2],
    &localB->sf_MATLABFunction2);
  ...
  EX3_Circula_MATLABFunction4(localB->sf_MATLABFunction2.Oy, rtb_Subtract2_ic,
    &localB->sf_MATLABFunction4);
  ...
  *rtd_BLUE_Tz = 1.0 / EX3_CircularTrajectoryNew_P.serverRate * localB->In1_a *
    EX3_CircularTrajectoryNew_P.Kd_tblue + EX3_CircularTrajectoryNew_P.Kp_tblue *
    localB->sf_MATLABFunction4.e_out;
...
//    '<S13>/Change BLUE Behavior'
//
void E_ChangeBLUEBehavior_Update(B_ChangeBLUEBehavior_EX3_Ci_k_T *localB,
...
static real_T EX3_CircularTraje_rt_atan2d_snf(real_T u0, real_T u1)
{
  ...
  if (rtIsNaN(u0) || rtIsNaN(u1)) {
    ...
    if (u0 > 0.0) {
      EX3_CircularTrajectoryNew_B.u0 = 1;
    } else {
      EX3_CircularTrajectoryNew_B.u0 = -1;
    }

    if (u1 > 0.0) {
      EX3_CircularTrajectoryNew_B.u1 = 1;
    } else {
      EX3_CircularTrajectoryNew_B.u1 = -1;
    }

    y = atan2(static_cast<real_T>(EX3_CircularTrajectoryNew_B.u0),
              static_cast<real_T>(EX3_CircularTrajectoryNew_B.u1));
  } else if (u1 == 0.0) {
    if (u0 > 0.0) {
      y = RT_PI / 2.0;
    } else if (u0 < 0.0) {
...
static real_T EX3__rt_urand_Upu32_Yd_f_pw_snf(uint32_T *u)
{
  ...
  EX3_CircularTrajectoryNew_B.lo = *u % 127773U * 16807U;
  EX3_CircularTrajectoryNew_B.hi = *u / 127773U * 2836U;
  if (EX3_CircularTrajectoryNew_B.lo < EX3_CircularTrajectoryNew_B.hi) {
    *u = 2147483647U - (EX3_CircularTrajectoryNew_B.hi -
                        EX3_CircularTrajectoryNew_B.lo);
  } else {
    *u = EX3_CircularTrajectoryNew_B.lo - EX3_CircularTrajectoryNew_B.hi;
  }
...
static real_T EX3__rt_nrand_Upu32_Yd_f_pw_snf(uint32_T *u)
{
  ...
  do {
    EX3_CircularTrajectoryNew_B.sr = 2.0 * EX3__rt_urand_Upu32_Yd_f_pw_snf(u) -
      1.0;
    EX3_CircularTrajectoryNew_B.si = 2.0 * EX3__rt_urand_Upu32_Yd_f_pw_snf(u) -
      1.0;
    EX3_CircularTrajectoryNew_B.si = EX3_CircularTrajectoryNew_B.sr *
      EX3_CircularTrajectoryNew_B.sr + EX3_CircularTrajectoryNew_B.si *
      EX3_CircularTrajectoryNew_B.si;
  } while (EX3_CircularTrajectoryNew_B.si > 1.0);

  y = sqrt(-2.0 * log(EX3_CircularTrajectoryNew_B.si) /
           EX3_CircularTrajectoryNew_B.si) * EX3_CircularTrajectoryNew_B.sr;
  return y;
}
...
static void EX3_CircularTraj_rt_invd3x3_snf(const real_T u[9], real_T y[9])
{
  memcpy(&EX3_CircularTrajectoryNew_B.x[0], &u[0], 9U * sizeof(real_T));
  EX3_CircularTrajectoryNew_B.p1 = 1;
  EX3_CircularTrajectoryNew_B.p2 = 3;
  EX3_CircularTrajectoryNew_B.p3 = 6;
  EX3_CircularTrajectoryNew_B.absx11 = fabs(u[0]);
  EX3_CircularTrajectoryNew_B.absx21 = fabs(u[1]);
  EX3_CircularTrajectoryNew_B.absx31 = fabs(u[2]);
  if ((EX3_CircularTrajectoryNew_B.absx21 > EX3_CircularTrajectoryNew_B.absx11) &&
      (EX3_CircularTrajectoryNew_B.absx21 > EX3_CircularTrajectoryNew_B.absx31))
  {
    EX3_CircularTrajectoryNew_B.p1 = 4;
    EX3_CircularTrajectoryNew_B.p2 = 0;
    EX3_CircularTrajectoryNew_B.x[0] = u[1];
    EX3_CircularTrajectoryNew_B.x[1] = u[0];
    EX3_CircularTrajectoryNew_B.x[3] = u[4];
    EX3_CircularTrajectoryNew_B.x[4] = u[3];
    EX3_CircularTrajectoryNew_B.x[6] = u[7];
    EX3_CircularTrajectoryNew_B.x[7] = u[6];
  } else {
    if (EX3_CircularTrajectoryNew_B.absx31 > EX3_CircularTrajectoryNew_B.absx11)
    {
      EX3_CircularTrajectoryNew_B.p1 = 7;
      EX3_CircularTrajectoryNew_B.p3 = 0;
      EX3_CircularTrajectoryNew_B.x[2] = EX3_CircularTrajectoryNew_B.x[0];
      EX3_CircularTrajectoryNew_B.x[0] = u[2];
      EX3_CircularTrajectoryNew_B.x[5] = EX3_CircularTrajectoryNew_B.x[3];
      EX3_CircularTrajectoryNew_B.x[3] = u[5];
      EX3_CircularTrajectoryNew_B.x[8] = EX3_CircularTrajectoryNew_B.x[6];
      EX3_CircularTrajectoryNew_B.x[6] = u[8];
    }
  }

  EX3_CircularTrajectoryNew_B.absx31 = EX3_CircularTrajectoryNew_B.x[1] /
    EX3_CircularTrajectoryNew_B.x[0];
  EX3_CircularTrajectoryNew_B.x[1] = EX3_CircularTrajectoryNew_B.absx31;
  EX3_CircularTrajectoryNew_B.absx11 = EX3_CircularTrajectoryNew_B.x[2] /
    EX3_CircularTrajectoryNew_B.x[0];
  EX3_CircularTrajectoryNew_B.x[2] = EX3_CircularTrajectoryNew_B.absx11;
  EX3_CircularTrajectoryNew_B.x[4] -= EX3_CircularTrajectoryNew_B.absx31 *
    EX3_CircularTrajectoryNew_B.x[3];
  EX3_CircularTrajectoryNew_B.x[5] -= EX3_CircularTrajectoryNew_B.absx11 *
    EX3_CircularTrajectoryNew_B.x[3];
  EX3_CircularTrajectoryNew_B.x[7] -= EX3_CircularTrajectoryNew_B.absx31 *
    EX3_CircularTrajectoryNew_B.x[6];
  EX3_CircularTrajectoryNew_B.x[8] -= EX3_CircularTrajectoryNew_B.absx11 *
    EX3_CircularTrajectoryNew_B.x[6];
  if (fabs(EX3_CircularTrajectoryNew_B.x[5]) > fabs
      (EX3_CircularTrajectoryNew_B.x[4])) {
    EX3_CircularTrajectoryNew_B.itmp = EX3_CircularTrajectoryNew_B.p2;
    EX3_CircularTrajectoryNew_B.p2 = EX3_CircularTrajectoryNew_B.p3;
    EX3_CircularTrajectoryNew_B.p3 = EX3_CircularTrajectoryNew_B.itmp;
    EX3_CircularTrajectoryNew_B.x[1] = EX3_CircularTrajectoryNew_B.absx11;
    EX3_CircularTrajectoryNew_B.x[2] = EX3_CircularTrajectoryNew_B.absx31;
    EX3_CircularTrajectoryNew_B.absx11 = EX3_CircularTrajectoryNew_B.x[4];
    EX3_CircularTrajectoryNew_B.x[4] = EX3_CircularTrajectoryNew_B.x[5];
    EX3_CircularTrajectoryNew_B.x[5] = EX3_CircularTrajectoryNew_B.absx11;
    EX3_CircularTrajectoryNew_B.absx11 = EX3_CircularTrajectoryNew_B.x[7];
    EX3_CircularTrajectoryNew_B.x[7] = EX3_CircularTrajectoryNew_B.x[8];
    EX3_CircularTrajectoryNew_B.x[8] = EX3_CircularTrajectoryNew_B.absx11;
  }

  EX3_CircularTrajectoryNew_B.absx31 = EX3_CircularTrajectoryNew_B.x[5] /
    EX3_CircularTrajectoryNew_B.x[4];
  EX3_CircularTrajectoryNew_B.x[8] -= EX3_CircularTrajectoryNew_B.absx31 *
    EX3_CircularTrajectoryNew_B.x[7];
  EX3_CircularTrajectoryNew_B.absx11 = (EX3_CircularTrajectoryNew_B.absx31 *
    EX3_CircularTrajectoryNew_B.x[1] - EX3_CircularTrajectoryNew_B.x[2]) /
    EX3_CircularTrajectoryNew_B.x[8];
  EX3_CircularTrajectoryNew_B.absx21 = -(EX3_CircularTrajectoryNew_B.x[7] *
    EX3_CircularTrajectoryNew_B.absx11 + EX3_CircularTrajectoryNew_B.x[1]) /
    EX3_CircularTrajectoryNew_B.x[4];
  y[EX3_CircularTrajectoryNew_B.p1 - 1] = ((1.0 - EX3_CircularTrajectoryNew_B.x
    [3] * EX3_CircularTrajectoryNew_B.absx21) - EX3_CircularTrajectoryNew_B.x[6]
    * EX3_CircularTrajectoryNew_B.absx11) / EX3_CircularTrajectoryNew_B.x[0];
  y[EX3_CircularTrajectoryNew_B.p1] = EX3_CircularTrajectoryNew_B.absx21;
  y[EX3_CircularTrajectoryNew_B.p1 + 1] = EX3_CircularTrajectoryNew_B.absx11;
  EX3_CircularTrajectoryNew_B.absx11 = -EX3_CircularTrajectoryNew_B.absx31 /
    EX3_CircularTrajectoryNew_B.x[8];
  EX3_CircularTrajectoryNew_B.absx21 = (1.0 - EX3_CircularTrajectoryNew_B.x[7] *
    EX3_CircularTrajectoryNew_B.absx11) / EX3_CircularTrajectoryNew_B.x[4];
  y[EX3_CircularTrajectoryNew_B.p2] = -(EX3_CircularTrajectoryNew_B.x[3] *
    EX3_CircularTrajectoryNew_B.absx21 + EX3_CircularTrajectoryNew_B.x[6] *
    EX3_CircularTrajectoryNew_B.absx11) / EX3_CircularTrajectoryNew_B.x[0];
  y[EX3_CircularTrajectoryNew_B.p2 + 1] = EX3_CircularTrajectoryNew_B.absx21;
  y[EX3_CircularTrajectoryNew_B.p2 + 2] = EX3_CircularTrajectoryNew_B.absx11;
  EX3_CircularTrajectoryNew_B.absx11 = 1.0 / EX3_CircularTrajectoryNew_B.x[8];
  EX3_CircularTrajectoryNew_B.absx21 = -EX3_CircularTrajectoryNew_B.x[7] *
    EX3_CircularTrajectoryNew_B.absx11 / EX3_CircularTrajectoryNew_B.x[4];
  y[EX3_CircularTrajectoryNew_B.p3] = -(EX3_CircularTrajectoryNew_B.x[3] *
    EX3_CircularTrajectoryNew_B.absx21 + EX3_CircularTrajectoryNew_B.x[6] *
    EX3_CircularTrajectoryNew_B.absx11) / EX3_CircularTrajectoryNew_B.x[0];
  y[EX3_CircularTrajectoryNew_B.p3 + 1] = EX3_CircularTrajectoryNew_B.absx21;
  y[EX3_CircularTrajectoryNew_B.p3 + 2] = EX3_CircularTrajectoryNew_B.absx11;
}
...
static void EX3_Circul_SystemCore_delete_lo(const
  codertarget_linux_blocks_Digi_T *obj)
{
  EX3_Circul_SystemCore_release_l(obj);
}
...
static void matlabCodegenHandle_matlabCo_lo(codertarget_linux_blocks_Digi_T *obj)
{
  if (!obj->matlabCodegenIsDeleted) {
    obj->matlabCodegenIsDeleted = true;
    EX3_Circul_SystemCore_delete_lo(obj);
  }
}
...
static void EX3_Circu_SystemCore_delete_lot(const
  codertarget_linux_blocks_Digi_T *obj)
{
  EX3_Circu_SystemCore_release_lo(obj);
}
...
static void matlabCodegenHandle_matlabC_lot(codertarget_linux_blocks_Digi_T *obj)
{
  if (!obj->matlabCodegenIsDeleted) {
    obj->matlabCodegenIsDeleted = true;
    EX3_Circu_SystemCore_delete_lot(obj);
  }
}
...
static void EX3_Circula_SystemCore_delete_l(const
  InitializeForPosition_EX3_Cir_T *obj)
{
  EX3_Circular_SystemCore_release(obj);
}
...
static void matlabCodegenHandle_matlabCod_l(InitializeForPosition_EX3_Cir_T *obj)
{
  if (!obj->matlabCodegenIsDeleted) {
    obj->matlabCodegenIsDeleted = true;
    EX3_Circula_SystemCore_delete_l(obj);
  }
}
...
static void EX3_Circ_SystemCore_delete_loto(const
  raspi_internal_PWMBlock_EX3_C_T *obj)
{
  EX3_Circ_SystemCore_release_lot(obj);
}
...
static void matlabCodegenHandle_matlab_loto(raspi_internal_PWMBlock_EX3_C_T *obj)
{
  if (!obj->matlabCodegenIsDeleted) {
    obj->matlabCodegenIsDeleted = true;
    EX3_Circ_SystemCore_delete_loto(obj);
  }
}
...
static void SystemCore_delete_loto3zjx3fstw(const
  codertarget_linux_blocks_Di_l_T *obj)
{
  SystemCore_release_loto3zjx3fst(obj);
}
...
static void matlabCodegenHand_loto3zjx3fstw(codertarget_linux_blocks_Di_l_T *obj)
{
  if (!obj->matlabCodegenIsDeleted) {
    obj->matlabCodegenIsDeleted = true;
    SystemCore_delete_loto3zjx3fstw(obj);
  }
}
...
static void SystemCore_delet_loto3zjx3fstwa(const
  codertarget_linux_blocks_Digi_T *obj)
{
  SystemCore_releas_loto3zjx3fstw(obj);
}
...
static void matlabCodegenHan_loto3zjx3fstwa(codertarget_linux_blocks_Digi_T *obj)
{
  if (!obj->matlabCodegenIsDeleted) {
    obj->matlabCodegenIsDeleted = true;
    SystemCore_delet_loto3zjx3fstwa(obj);
  }
}
...
static void E_SystemCore_dele_p(const codertarget_linux_blocks_Digi_T *obj)
{
  SystemCore_rele_loto3zjx3fstwan(obj);
}
...
static void EX3_CircularTr_SystemCore_setup(raspi_internal_lsm9ds1Block_E_T *obj)
{
  ...
  obj->isInitialized = 1;
  EX3_CircularTrajectoryNew_B.ModeType = MW_I2C_MASTER;
  i2cname = 1;
  obj->i2cobj_A_G.MW_I2C_HANDLE = MW_I2C_Open(i2cname,
    EX3_CircularTrajectoryNew_B.ModeType);
...
void EX3_CircularTrajectoryNew_step0(void) // Sample time: [0.0s, 0.0s]
{
...

  {
    ...
    if (EX3_CircularTrajectoryNew_DW.Univ_Time <
        EX3_CircularTrajectoryNew_P.Phase0_End) {
      EX3_CircularTrajectoryNew_DW.SeparatePhases_ActiveSubsystem = 0;

      // Outputs for IfAction SubSystem: '<Root>/Phase #0:  Wait for Synchronization' incorporates:
      //   ActionPort: '<S8>/Action Port'

      Phase0WaitforSynchronizatio
        (&EX3_CircularTrajectoryNew_DW.Phase0WaitforSynchronization,
         &EX3_CircularTrajectoryNew_P.Phase0WaitforSynchronization,
         &EX3_CircularTrajectoryNew_DW.BLACK_Fx,
         &EX3_CircularTrajectoryNew_DW.BLACK_Fy,
         &EX3_CircularTrajectoryNew_DW.BLACK_Tz,
         &EX3_CircularTrajectoryNew_DW.BLUE_Fx,
         &EX3_CircularTrajectoryNew_DW.BLUE_Fy,
         &EX3_CircularTrajectoryNew_DW.BLUE_Tz,
         &EX3_CircularTrajectoryNew_DW.Float_State,
         &EX3_CircularTrajectoryNew_DW.RED_Fx,
         &EX3_CircularTrajectoryNew_DW.RED_Fy,
         &EX3_CircularTrajectoryNew_DW.RED_Tz,
         &EX3_CircularTrajectoryNew_B.Sum6_l1,
         &EX3_CircularTrajectoryNew_DW.RED_Tz_RW,
         &EX3_CircularTrajectoryNew_B.Sum6_dk,
         &EX3_CircularTrajectoryNew_B.RED_Tz_Wrist);

      // End of Outputs for SubSystem: '<Root>/Phase #0:  Wait for Synchronization' 
    } else if (EX3_CircularTrajectoryNew_DW.Univ_Time <
               EX3_CircularTrajectoryNew_P.Phase1_End) {
      EX3_CircularTrajectoryNew_DW.SeparatePhases_ActiveSubsystem = 1;

      // Outputs for IfAction SubSystem: '<Root>/Phase #1:  Start Floating ' incorporates:
      //   ActionPort: '<S9>/Action Port'

      Phase0WaitforSynchronizatio
        (&EX3_CircularTrajectoryNew_DW.Phase1StartFloating,
         &EX3_CircularTrajectoryNew_P.Phase1StartFloating,
         &EX3_CircularTrajectoryNew_DW.BLACK_Fx,
         &EX3_CircularTrajectoryNew_DW.BLACK_Fy,
         &EX3_CircularTrajectoryNew_DW.BLACK_Tz,
         &EX3_CircularTrajectoryNew_DW.BLUE_Fx,
      ...
      // End of Outputs for SubSystem: '<Root>/Phase #1:  Start Floating '
               ...
               EX3_CircularTrajectoryNew_P.Phase2_End) {
      EX3_CircularTrajectoryNew_DW.SeparatePhases_ActiveSubsystem = 2;
      ...
      EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhether_dy = -1;
      if ((EX3_CircularTrajectoryNew_P.WhoAmI == 2.0) ||
          (EX3_CircularTrajectoryNew_P.simMode == 1.0)) {
        EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhether_dy = 0;
        ...
        EX3_CircularTrajectoryNew_B.Subtract_ou =
          EX3_CircularTrajectoryNew_P.init_states_BLACK[0] -
          EX3_CircularTrajectoryNew_DW.BLACK_Px;

        // Delay: '<S284>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_ns != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_k =
            EX3_CircularTrajectoryNew_B.Subtract_ou;
        }
        ...
        EX3_CircularTrajectoryNew_DW.BLACK_Fx = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_e * EX3_CircularTrajectoryNew_P.Kd_xb
          + EX3_CircularTrajectoryNew_P.Kp_xb *
          EX3_CircularTrajectoryNew_B.Subtract_ou;
        ...
        EX3_CircularTrajectoryNew_B.Subtract1_m0 =
          EX3_CircularTrajectoryNew_P.init_states_BLACK[1] -
          EX3_CircularTrajectoryNew_DW.BLACK_Py;

        // Delay: '<S286>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_k1 != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_d =
            EX3_CircularTrajectoryNew_B.Subtract1_m0;
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_gc =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_DW.BLACK_Fy = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_gc * EX3_CircularTrajectoryNew_P.Kd_yb
          + EX3_CircularTrajectoryNew_P.Kp_yb *
          EX3_CircularTrajectoryNew_B.Subtract1_m0;

        // MATLAB Function: '<S281>/MATLAB Function2' incorporates:
        //   Constant: '<S274>/Desired Attitude (BLACK)'

        EX3_Circu_MATLABFunction2_o
          (EX3_CircularTrajectoryNew_P.init_states_BLACK[2],
           &EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_o);

        // MATLAB Function: '<S281>/MATLAB Function3' incorporates:
        //   DataStoreRead: '<S274>/BLACK_Rz'

        EX3_Circula_MATLABFunction3(EX3_CircularTrajectoryNew_DW.BLACK_Rz,
          &EX3_CircularTrajectoryNew_B.sf_MATLABFunction3);

        // Sum: '<S281>/Subtract2'
        EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c[0] =
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_o.Ox[0] -
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction3.Ox[0];
        EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c[1] =
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_o.Ox[1] -
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction3.Ox[1];

        // MATLAB Function: '<S281>/MATLAB Function4'
        EX3_Circula_MATLABFunction4
          (EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_o.Oy,
           EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c,
           &EX3_CircularTrajectoryNew_B.sf_MATLABFunction4);

        // Delay: '<S282>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_ep != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_j =
            EX3_CircularTrajectoryNew_B.sf_MATLABFunction4.e_out;
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_fau =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_DW.BLACK_Tz = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_fau *
          EX3_CircularTrajectoryNew_P.Kd_tb + EX3_CircularTrajectoryNew_P.Kp_tb *
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction4.e_out;
        ...
        EX3_CircularTrajectoryNew_DW.Float_State =
          EX3_CircularTrajectoryNew_P.PuckState_Value;
      ...
      EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhether_jm = -1;
      if ((EX3_CircularTrajectoryNew_P.WhoAmI == 3.0) ||
          (EX3_CircularTrajectoryNew_P.simMode == 1.0)) {
        EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhether_jm = 0;
        ...
        EX3_CircularTrajectoryNew_B.Subtract_j =
          EX3_CircularTrajectoryNew_P.init_states_BLUE[0] -
          EX3_CircularTrajectoryNew_DW.BLUE_Px;

        // Delay: '<S297>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_dy != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_fb =
            EX3_CircularTrajectoryNew_B.Subtract_j;
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_lc =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_DW.BLUE_Fx = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_lc *
          EX3_CircularTrajectoryNew_P.Kd_xblue +
          EX3_CircularTrajectoryNew_P.Kp_xblue *
          EX3_CircularTrajectoryNew_B.Subtract_j;
        ...
        EX3_CircularTrajectoryNew_B.Subtract1_o =
          EX3_CircularTrajectoryNew_P.init_states_BLUE[1] -
          EX3_CircularTrajectoryNew_DW.BLUE_Py;

        // Delay: '<S299>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_hf != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_n1 =
            EX3_CircularTrajectoryNew_B.Subtract1_o;
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_jw =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_DW.BLUE_Fy = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_jw *
          EX3_CircularTrajectoryNew_P.Kd_yblue +
          EX3_CircularTrajectoryNew_P.Kp_yblue *
          EX3_CircularTrajectoryNew_B.Subtract1_o;
        ...
        EX3_Circu_MATLABFunction2_o
          (EX3_CircularTrajectoryNew_P.init_states_BLUE[2],
           &EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_m);

        // MATLAB Function: '<S294>/MATLAB Function3' incorporates:
        //   DataStoreRead: '<S275>/BLUE_Rz'

        EX3_Circula_MATLABFunction3(EX3_CircularTrajectoryNew_DW.BLUE_Rz,
          &EX3_CircularTrajectoryNew_B.sf_MATLABFunction3_c);

        // Sum: '<S294>/Subtract2'
        EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c[0] =
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_m.Ox[0] -
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction3_c.Ox[0];
        EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c[1] =
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_m.Ox[1] -
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction3_c.Ox[1];

        // MATLAB Function: '<S294>/MATLAB Function4'
        EX3_Circula_MATLABFunction4
          (EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_m.Oy,
           EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c,
           &EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_c);

        // Delay: '<S295>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_kl != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_cq =
            EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_c.e_out;
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_o =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_DW.BLUE_Tz = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_o *
          EX3_CircularTrajectoryNew_P.Kd_tblue +
          EX3_CircularTrajectoryNew_P.Kp_tblue *
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_c.e_out;
        ...
        EX3_CircularTrajectoryNew_DW.Float_State =
          EX3_CircularTrajectoryNew_P.PuckState_Value_o;
      ...
      EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhether_aj = -1;
      if ((EX3_CircularTrajectoryNew_P.WhoAmI == 1.0) ||
          (EX3_CircularTrajectoryNew_P.simMode == 1.0)) {
        EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhether_aj = 0;
        ...
        EX3_Circu_MATLABFunction2_o(EX3_CircularTrajectoryNew_P.init_states_RED
          [2], &EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_ol);

        // MATLAB Function: '<S307>/MATLAB Function3' incorporates:
        //   DataStoreRead: '<S276>/RED_Rz'

        EX3_Circula_MATLABFunction3(EX3_CircularTrajectoryNew_DW.RED_Rz,
          &EX3_CircularTrajectoryNew_B.sf_MATLABFunction3_k);

        // Sum: '<S307>/Subtract2'
        EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c[0] =
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_ol.Ox[0] -
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction3_k.Ox[0];
        EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c[1] =
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_ol.Ox[1] -
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction3_k.Ox[1];

        // MATLAB Function: '<S307>/MATLAB Function4'
        EX3_Circula_MATLABFunction4
          (EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_ol.Oy,
           EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c,
           &EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_b);

        // Delay: '<S308>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_ji != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_ct =
            EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_b.e_out;
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_k =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_DW.RED_Tz = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_k * EX3_CircularTrajectoryNew_P.Kd_tr
          + EX3_CircularTrajectoryNew_P.Kp_tr *
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_b.e_out;
        ...
        EX3_CircularTrajectoryNew_B.Subtract_f =
          EX3_CircularTrajectoryNew_P.init_states_RED[0] -
          EX3_CircularTrajectoryNew_DW.RED_Px;

        // Delay: '<S310>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_a1 != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_bm =
            EX3_CircularTrajectoryNew_B.Subtract_f;
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_cr =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_DW.RED_Fx = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_cr * EX3_CircularTrajectoryNew_P.Kd_xr
          + EX3_CircularTrajectoryNew_P.Kp_xr *
          EX3_CircularTrajectoryNew_B.Subtract_f;
        ...
        EX3_CircularTrajectoryNew_DW.RED_Tz_RW =
          EX3_CircularTrajectoryNew_P.Constant2_Value;

        // Sum: '<S276>/Subtract1' incorporates:
        //   Constant: '<S276>/Constant3'
        //   DataStoreRead: '<S276>/RED_Py '

        EX3_CircularTrajectoryNew_B.Subtract1_dr =
          EX3_CircularTrajectoryNew_P.init_states_RED[1] -
          EX3_CircularTrajectoryNew_DW.RED_Py;

        // Delay: '<S312>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_o0 != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_pr =
            EX3_CircularTrajectoryNew_B.Subtract1_dr;
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_if =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_DW.RED_Fy = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_if * EX3_CircularTrajectoryNew_P.Kd_yr
          + EX3_CircularTrajectoryNew_P.Kp_yr *
          EX3_CircularTrajectoryNew_B.Subtract1_dr;
        ...
        EX3_CircularTrajectoryNew_DW.Float_State =
          EX3_CircularTrajectoryNew_P.PuckState_Value_l;
        SendPositionCommandstoManip(EX3_CircularTrajectoryNew_P.Constant7_Value,
          EX3_CircularTrajectoryNew_P.Constant8_Value,
          EX3_CircularTrajectoryNew_P.Constant9_Value);
      ...
      // End of Outputs for SubSystem: '<Root>/Phase #2:  Move to  Initial Position' 
               ...
               EX3_CircularTrajectoryNew_P.Phase3_End) {
      EX3_CircularTrajectoryNew_DW.SeparatePhases_ActiveSubsystem = 3;
      ...
      EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhethero_p = -1;
      if ((EX3_CircularTrajectoryNew_P.WhoAmI == 2.0) ||
          (EX3_CircularTrajectoryNew_P.simMode == 1.0)) {
        EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhethero_p = 0;
        ...
        EX3_CircularTrajectoryNew_DW.ExperimentSubPhases_ActiveSub_o = -1;
        if (EX3_CircularTrajectoryNew_DW.Univ_Time <
            EX3_CircularTrajectoryNew_P.Phase3_SubPhase1_End) {
          EX3_CircularTrajectoryNew_DW.ExperimentSubPhases_ActiveSub_o = 0;
          ...
          EX3_CircularTrajectoryNew_B.Subtract_oi =
            EX3_CircularTrajectoryNew_P.init_states_BLACK[0] -
            EX3_CircularTrajectoryNew_DW.BLACK_Px;

          // Delay: '<S332>/Delay1'
          if (EX3_CircularTrajectoryNew_DW.icLoad_ot != 0) {
            EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_g =
              EX3_CircularTrajectoryNew_B.Subtract_oi;
          }
          ...
          if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
            ...
            EX3_CircularTrajectoryNew_B.In1_cw =
              EX3_CircularTrajectoryNew_B.Sum6_l1;
          ...
          EX3_CircularTrajectoryNew_DW.BLACK_Fx = 1.0 /
            EX3_CircularTrajectoryNew_P.serverRate *
            EX3_CircularTrajectoryNew_B.In1_cw *
            EX3_CircularTrajectoryNew_P.Kd_xb +
            EX3_CircularTrajectoryNew_P.Kp_xb *
            EX3_CircularTrajectoryNew_B.Subtract_oi;
          ...
          EX3_CircularTrajectoryNew_B.Subtract1_d2 =
            EX3_CircularTrajectoryNew_P.init_states_BLACK[1] -
            EX3_CircularTrajectoryNew_DW.BLACK_Py;

          // Delay: '<S334>/Delay1'
          if (EX3_CircularTrajectoryNew_DW.icLoad_k != 0) {
            EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_pe =
              EX3_CircularTrajectoryNew_B.Subtract1_d2;
          }
          ...
          if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
            ...
            EX3_CircularTrajectoryNew_B.In1_ly =
              EX3_CircularTrajectoryNew_B.Sum6_l1;
          ...
          EX3_CircularTrajectoryNew_DW.BLACK_Fy = 1.0 /
            EX3_CircularTrajectoryNew_P.serverRate *
            EX3_CircularTrajectoryNew_B.In1_ly *
            EX3_CircularTrajectoryNew_P.Kd_yb +
            EX3_CircularTrajectoryNew_P.Kp_yb *
            EX3_CircularTrajectoryNew_B.Subtract1_d2;
          ...
          EX3_Circu_MATLABFunction2_o
            (EX3_CircularTrajectoryNew_P.init_states_BLACK[2],
             &EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_i);

          // MATLAB Function: '<S329>/MATLAB Function3' incorporates:
          //   DataStoreRead: '<S321>/BLACK_Rz'

          EX3_Circula_MATLABFunction3(EX3_CircularTrajectoryNew_DW.BLACK_Rz,
            &EX3_CircularTrajectoryNew_B.sf_MATLABFunction3_l);

          // Sum: '<S329>/Subtract2'
          EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c[0] =
            EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_i.Ox[0] -
            EX3_CircularTrajectoryNew_B.sf_MATLABFunction3_l.Ox[0];
          EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c[1] =
            EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_i.Ox[1] -
            EX3_CircularTrajectoryNew_B.sf_MATLABFunction3_l.Ox[1];

          // MATLAB Function: '<S329>/MATLAB Function4'
          EX3_Circula_MATLABFunction4
            (EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_i.Oy,
             EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c,
             &EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_d);

          // Delay: '<S330>/Delay1'
          if (EX3_CircularTrajectoryNew_DW.icLoad_l != 0) {
            EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_lu =
              EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_d.e_out;
          }
          ...
          if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
            ...
            EX3_CircularTrajectoryNew_B.In1_a =
              EX3_CircularTrajectoryNew_B.Sum6_l1;
          ...
          EX3_CircularTrajectoryNew_DW.BLACK_Tz = 1.0 /
            EX3_CircularTrajectoryNew_P.serverRate *
            EX3_CircularTrajectoryNew_B.In1_a *
            EX3_CircularTrajectoryNew_P.Kd_tb +
            EX3_CircularTrajectoryNew_P.Kp_tb *
            EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_d.e_out;
          ...
          EX3_CircularTrajectoryNew_DW.Float_State =
            EX3_CircularTrajectoryNew_P.PuckState_Value_n;

          // End of Outputs for SubSystem: '<S317>/Sub-Phase #1'
        } else if (EX3_CircularTrajectoryNew_DW.Univ_Time <
                   EX3_CircularTrajectoryNew_P.Phase3_SubPhase2_End) {
          EX3_CircularTrajectoryNew_DW.ExperimentSubPhases_ActiveSub_o = 1;

          // Outputs for IfAction SubSystem: '<S317>/Sub-Phase #2 ' incorporates:
          //   ActionPort: '<S322>/Action Port'

          EX3_CircularTraje_SubPhase2(&EX3_CircularTrajectoryNew_P.SubPhase2,
            &EX3_CircularTrajectoryNew_DW.BLACK_Fx,
            &EX3_CircularTrajectoryNew_DW.BLACK_Fy,
            &EX3_CircularTrajectoryNew_DW.BLACK_Tz,
            &EX3_CircularTrajectoryNew_DW.Float_State);
          ...
          // End of Outputs for SubSystem: '<S317>/Sub-Phase #2 '
                   ...
                   EX3_CircularTrajectoryNew_P.Phase3_SubPhase3_End) {
          EX3_CircularTrajectoryNew_DW.ExperimentSubPhases_ActiveSub_o = 2;

          // Outputs for IfAction SubSystem: '<S317>/Sub-Phase #3 ' incorporates:
          //   ActionPort: '<S323>/Action Port'

          EX3_CircularTraje_SubPhase2(&EX3_CircularTrajectoryNew_P.SubPhase3,
            &EX3_CircularTrajectoryNew_DW.BLACK_Fx,
            &EX3_CircularTrajectoryNew_DW.BLACK_Fy,
            &EX3_CircularTrajectoryNew_DW.BLACK_Tz,
            &EX3_CircularTrajectoryNew_DW.Float_State);
          ...
          if (EX3_CircularTrajectoryNew_DW.Univ_Time <
              EX3_CircularTrajectoryNew_P.Phase3_SubPhase4_End) {
            EX3_CircularTrajectoryNew_DW.ExperimentSubPhases_ActiveSub_o = 3;
            ...
            EX3_CircularTrajectoryNew_B.Subtract_a =
              EX3_CircularTrajectoryNew_P.xLength / 2.0 -
              EX3_CircularTrajectoryNew_DW.BLACK_Px;

            // Delay: '<S349>/Delay1'
            if (EX3_CircularTrajectoryNew_DW.icLoad_fr != 0) {
              EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_hp =
                EX3_CircularTrajectoryNew_B.Subtract_a;
            }
            ...
            if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
              ...
              EX3_CircularTrajectoryNew_B.In1_l =
                EX3_CircularTrajectoryNew_B.Sum6_l1;
            ...
            EX3_CircularTrajectoryNew_B.Subtract1_h =
              EX3_CircularTrajectoryNew_P.yLength / 2.0 -
              EX3_CircularTrajectoryNew_DW.BLACK_Py;

            // Delay: '<S351>/Delay1'
            if (EX3_CircularTrajectoryNew_DW.icLoad_me != 0) {
              EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_ha =
                EX3_CircularTrajectoryNew_B.Subtract1_h;
            }
            ...
            if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
              ...
              EX3_CircularTrajectoryNew_B.In1_n =
                EX3_CircularTrajectoryNew_B.Sum6_l1;
            ...
            EX3_CircularTrajectoryNew_B.Sum6_l1 =
              (EX3_CircularTrajectoryNew_DW.Univ_Time -
               EX3_CircularTrajectoryNew_P.Phase3_SubPhase3_End) *
              EX3_CircularTrajectoryNew_P.DesiredRateBLACK_Value;
            ...
            EX3_Circu_MATLABFunction2_b(EX3_CircularTraje_rt_atan2d_snf(sin
              (EX3_CircularTrajectoryNew_B.Sum6_l1), cos
              (EX3_CircularTrajectoryNew_B.Sum6_l1)),
              &EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_b);

            // MATLAB Function: '<S343>/MATLAB Function3' incorporates:
            //   DataStoreRead: '<S324>/BLACK_Rz'

            EX3_Circula_MATLABFunction3(EX3_CircularTrajectoryNew_DW.BLACK_Rz,
              &EX3_CircularTrajectoryNew_B.sf_MATLABFunction3_ly);

            // Sum: '<S343>/Subtract2'
            EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c[0] =
              EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_b.Ox[0] -
              EX3_CircularTrajectoryNew_B.sf_MATLABFunction3_ly.Ox[0];
            EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c[1] =
              EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_b.Ox[1] -
              EX3_CircularTrajectoryNew_B.sf_MATLABFunction3_ly.Ox[1];

            // MATLAB Function: '<S343>/MATLAB Function4'
            EX3_Circula_MATLABFunction4
              (EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_b.Oy,
               EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c,
               &EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_dk);

            // Delay: '<S347>/Delay1'
            if (EX3_CircularTrajectoryNew_DW.icLoad_ey != 0) {
              EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_li =
                EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_dk.e_out;
            }
            ...
            if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
              ...
              EX3_CircularTrajectoryNew_B.In1_ck =
                EX3_CircularTrajectoryNew_B.Sum6_l1;
            ...
            EX3_CircularTrajectoryNew_DW.Float_State =
              EX3_CircularTrajectoryNew_P.PuckState_Value_e;
      ...
      EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhether_pu = -1;
      if ((EX3_CircularTrajectoryNew_P.WhoAmI == 3.0) ||
          (EX3_CircularTrajectoryNew_P.simMode == 1.0)) {
        EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhether_pu = 0;
        ...
        EX3_CircularTrajectoryNew_DW.ExperimentSubPhases_ActiveSub_e = -1;
        if (EX3_CircularTrajectoryNew_DW.Univ_Time <
            EX3_CircularTrajectoryNew_P.Phase3_SubPhase1_End) {
          EX3_CircularTrajectoryNew_DW.ExperimentSubPhases_ActiveSub_e = 0;

          // Outputs for IfAction SubSystem: '<S318>/Sub-Phase #1' incorporates:
          //   ActionPort: '<S356>/Action Port'

          EX3_CircularTraje_SubPhase1(&EX3_CircularTrajectoryNew_B.SubPhase1_a,
            &EX3_CircularTrajectoryNew_DW.SubPhase1_a,
            &EX3_CircularTrajectoryNew_P.SubPhase1_a,
            &EX3_CircularTrajectoryNew_DW.BLUE_Fx,
            &EX3_CircularTrajectoryNew_DW.BLUE_Fy,
            &EX3_CircularTrajectoryNew_DW.BLUE_Px,
            &EX3_CircularTrajectoryNew_DW.BLUE_Py,
            &EX3_CircularTrajectoryNew_DW.BLUE_Rz,
            &EX3_CircularTrajectoryNew_DW.BLUE_Tz,
            &EX3_CircularTrajectoryNew_DW.Float_State);
          ...
          EX3_CircularTra_SubPhase2_m(&EX3_CircularTrajectoryNew_P.SubPhase2_m,
            &EX3_CircularTrajectoryNew_DW.BLUE_Fx,
            &EX3_CircularTrajectoryNew_DW.BLUE_Fy,
            &EX3_CircularTrajectoryNew_DW.BLUE_Tz,
            &EX3_CircularTrajectoryNew_DW.Float_State);
          ...
          // End of Outputs for SubSystem: '<S318>/Sub-Phase #2 '
                   ...
                   EX3_CircularTrajectoryNew_P.Phase3_SubPhase3_End) {
          EX3_CircularTrajectoryNew_DW.ExperimentSubPhases_ActiveSub_e = 2;

          // Outputs for IfAction SubSystem: '<S318>/Sub-Phase #3 ' incorporates:
          //   ActionPort: '<S358>/Action Port'

          EX3_CircularTra_SubPhase2_m(&EX3_CircularTrajectoryNew_P.SubPhase3_p,
            &EX3_CircularTrajectoryNew_DW.BLUE_Fx,
            &EX3_CircularTrajectoryNew_DW.BLUE_Fy,
            &EX3_CircularTrajectoryNew_DW.BLUE_Tz,
            &EX3_CircularTrajectoryNew_DW.Float_State);
          ...
          if (EX3_CircularTrajectoryNew_DW.Univ_Time <
              EX3_CircularTrajectoryNew_P.Phase3_SubPhase4_End) {
            EX3_CircularTrajectoryNew_DW.ExperimentSubPhases_ActiveSub_e = 3;

            // Outputs for IfAction SubSystem: '<S318>/Sub-Phase #4' incorporates:
            //   ActionPort: '<S359>/Action Port'

            EX3_CircularTraje_SubPhase1(&EX3_CircularTrajectoryNew_B.SubPhase4_f,
              &EX3_CircularTrajectoryNew_DW.SubPhase4_f,
              &EX3_CircularTrajectoryNew_P.SubPhase4_f,
              &EX3_CircularTrajectoryNew_DW.BLUE_Fx,
              &EX3_CircularTrajectoryNew_DW.BLUE_Fy,
              &EX3_CircularTrajectoryNew_DW.BLUE_Px,
              &EX3_CircularTrajectoryNew_DW.BLUE_Py,
      ...
      EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhether_au = -1;
      if ((EX3_CircularTrajectoryNew_P.WhoAmI == 1.0) ||
          (EX3_CircularTrajectoryNew_P.simMode == 1.0)) {
        EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhether_au = 0;
        ...
        EX3_CircularTrajectoryNew_DW.ExperimentSubPhases_ActiveSubsy = -1;
        if (EX3_CircularTrajectoryNew_DW.Univ_Time <
            EX3_CircularTrajectoryNew_P.Phase3_SubPhase1_End) {
          EX3_CircularTrajectoryNew_DW.ExperimentSubPhases_ActiveSubsy = 0;

          // Outputs for IfAction SubSystem: '<S319>/Sub-Phase #1' incorporates:
          //   ActionPort: '<S387>/Action Port'

          EX3_CircularTra_SubPhase1_j(&EX3_CircularTrajectoryNew_P.SubPhase1_j,
            &EX3_CircularTrajectoryNew_DW.Float_State,
            &EX3_CircularTrajectoryNew_DW.RED_Fx,
            &EX3_CircularTrajectoryNew_DW.RED_Fy,
            &EX3_CircularTrajectoryNew_DW.RED_Tz,
          ...
          EX3_CircularTra_SubPhase1_j(&EX3_CircularTrajectoryNew_P.SubPhase2_g,
            &EX3_CircularTrajectoryNew_DW.Float_State,
            &EX3_CircularTrajectoryNew_DW.RED_Fx,
            &EX3_CircularTrajectoryNew_DW.RED_Fy,
            &EX3_CircularTrajectoryNew_DW.RED_Tz,
          ...
          // End of Outputs for SubSystem: '<S319>/Sub-Phase #2 '
                   ...
                   EX3_CircularTrajectoryNew_P.Phase3_SubPhase3_End) {
          EX3_CircularTrajectoryNew_DW.ExperimentSubPhases_ActiveSubsy = 2;
          ...
          EX3_CircularTrajectoryNew_DW.RED_Fx =
            EX3_CircularTrajectoryNew_P.Constant_Value_f;
          ...
          EX3_CircularTrajectoryNew_DW.RED_Tz_RW =
            EX3_CircularTrajectoryNew_P.Constant1_Value;

          // DataStoreWrite: '<S389>/Data Store Write3' incorporates:
          //   Constant: '<S389>/Puck State'

          EX3_CircularTrajectoryNew_DW.Float_State =
            EX3_CircularTrajectoryNew_P.PuckState_Value_lm;

          // FromWorkspace: '<S389>/From Workspace'
          {
            real_T *pDataValues = (real_T *)
              EX3_CircularTrajectoryNew_DW.FromWorkspace_PWORK.DataPtr;
            real_T *pTimeValues = (real_T *)
              EX3_CircularTrajectoryNew_DW.FromWorkspace_PWORK.TimePtr;
            int_T currTimeIndex =
              EX3_CircularTrajectoryNew_DW.FromWorkspace_IWORK.PrevIndex;
            real_T t = EX3_CircularTrajectoryNew_M->Timing.t[0];
            ...
            // Post output
            {
              ...
              if (t1 == t2) {
                if (t < t1) {
                  EX3_CircularTrajectoryNew_B.FromWorkspace =
                ...
                EX3_CircularTrajectoryNew_B.FromWorkspace = (real_T)
          ...
          {
            real_T *pDataValues = (real_T *)
              EX3_CircularTrajectoryNew_DW.FromWorkspace1_PWORK.DataPtr;
            real_T *pTimeValues = (real_T *)
              EX3_CircularTrajectoryNew_DW.FromWorkspace1_PWORK.TimePtr;
            int_T currTimeIndex =
              EX3_CircularTrajectoryNew_DW.FromWorkspace1_IWORK.PrevIndex;
            real_T t = EX3_CircularTrajectoryNew_M->Timing.t[0];
            ...
            // Post output
            {
              ...
              if (t1 == t2) {
                if (t < t1) {
                  EX3_CircularTrajectoryNew_B.FromWorkspace1 =
                    pDataValues[currTimeIndex];
                } else {
                  EX3_CircularTrajectoryNew_B.FromWorkspace1 =
                    pDataValues[currTimeIndex + 1];
                ...
                d1 = pDataValues[TimeIndex];
                d2 = pDataValues[TimeIndex + 1];
                EX3_CircularTrajectoryNew_B.FromWorkspace1 = (real_T)
                  rtInterpolate(d1, d2, f1, f2);
                pDataValues += 10;
              }
            }
          ...
          {
            real_T *pDataValues = (real_T *)
              EX3_CircularTrajectoryNew_DW.FromWorkspace2_PWORK.DataPtr;
            real_T *pTimeValues = (real_T *)
              EX3_CircularTrajectoryNew_DW.FromWorkspace2_PWORK.TimePtr;
            int_T currTimeIndex =
              EX3_CircularTrajectoryNew_DW.FromWorkspace2_IWORK.PrevIndex;
            real_T t = EX3_CircularTrajectoryNew_M->Timing.t[0];
            ...
            // Post output
            {
              ...
              if (t1 == t2) {
                if (t < t1) {
                  EX3_CircularTrajectoryNew_B.FromWorkspace2 =
                    pDataValues[currTimeIndex];
                } else {
                  EX3_CircularTrajectoryNew_B.FromWorkspace2 =
                    pDataValues[currTimeIndex + 1];
                ...
                d1 = pDataValues[TimeIndex];
                d2 = pDataValues[TimeIndex + 1];
                EX3_CircularTrajectoryNew_B.FromWorkspace2 = (real_T)
                  rtInterpolate(d1, d2, f1, f2);
                pDataValues += 10;
              }
            }
          ...
          SendPositionCommandstoManip(EX3_CircularTrajectoryNew_B.FromWorkspace,
            EX3_CircularTrajectoryNew_B.FromWorkspace1,
            EX3_CircularTrajectoryNew_B.FromWorkspace2);
          ...
          if (EX3_CircularTrajectoryNew_DW.Univ_Time <
              EX3_CircularTrajectoryNew_P.Phase3_SubPhase4_End) {
            EX3_CircularTrajectoryNew_DW.ExperimentSubPhases_ActiveSubsy = 3;
            ...
            EX3_CircularTrajectoryNew_DW.RED_Tz_RW =
              EX3_CircularTrajectoryNew_P.Constant1_Value_f;
            ...
            EX3_Circu_MATLABFunction2_b(EX3_CircularTraje_rt_atan2d_snf
              (EX3_CircularTrajectoryNew_DW.BLACK_Py -
               EX3_CircularTrajectoryNew_DW.RED_Py,
               EX3_CircularTrajectoryNew_DW.BLACK_Px -
               EX3_CircularTrajectoryNew_DW.RED_Px) +
              EX3_CircularTrajectoryNew_P.Constant_Value_bf,
              &EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_g);

            // MATLAB Function: '<S395>/MATLAB Function3' incorporates:
            //   DataStoreRead: '<S390>/RED_Rz'

            EX3_Circula_MATLABFunction3(EX3_CircularTrajectoryNew_DW.RED_Rz,
              &EX3_CircularTrajectoryNew_B.sf_MATLABFunction3_lg);

            // Sum: '<S395>/Subtract2'
            EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c[0] =
              EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_g.Ox[0] -
              EX3_CircularTrajectoryNew_B.sf_MATLABFunction3_lg.Ox[0];
            EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c[1] =
              EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_g.Ox[1] -
              EX3_CircularTrajectoryNew_B.sf_MATLABFunction3_lg.Ox[1];

            // MATLAB Function: '<S395>/MATLAB Function4'
            EX3_Circula_MATLABFunction4
              (EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_g.Oy,
               EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c,
               &EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_n);

            // Delay: '<S400>/Delay1'
            if (EX3_CircularTrajectoryNew_DW.icLoad_jl != 0) {
              EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_c =
                EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_n.e_out;
            }
            ...
            if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
              ...
              EX3_CircularTrajectoryNew_B.In1_fa =
                EX3_CircularTrajectoryNew_B.Sum6_l1;
            ...
            EX3_CircularTrajectoryNew_DW.RED_Tz = 1.0 /
              EX3_CircularTrajectoryNew_P.serverRate *
              EX3_CircularTrajectoryNew_B.In1_fa *
              EX3_CircularTrajectoryNew_P.Kd_tr +
              EX3_CircularTrajectoryNew_P.Kp_tr *
              EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_n.e_out;
            ...
            // '<S396>:1:3' x = 0.7*cos((0.034906585*2)*t) + xLength/2;
            EX3_CircularTrajectoryNew_B.Subtract_b = (cos(0.06981317 *
              EX3_CircularTrajectoryNew_B.Sum6_l1) * 0.7 +
              EX3_CircularTrajectoryNew_P.xLength / 2.0) -
              EX3_CircularTrajectoryNew_DW.RED_Px;

            // Delay: '<S402>/Delay1'
            if (EX3_CircularTrajectoryNew_DW.icLoad_n != 0) {
              EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_mu =
                EX3_CircularTrajectoryNew_B.Subtract_b;
            }
            ...
            EX3_CircularTrajectoryNew_DW.RED_Fx = 1.0 /
              EX3_CircularTrajectoryNew_P.serverRate *
              EX3_CircularTrajectoryNew_B.In1_go *
              EX3_CircularTrajectoryNew_P.Kd_xr +
              EX3_CircularTrajectoryNew_P.Kp_xr *
              EX3_CircularTrajectoryNew_B.Subtract_b;
            ...
            // '<S397>:1:3' y = 0.7*sin((0.034906585*2)*t) + yLength/2;
            EX3_CircularTrajectoryNew_B.Subtract1_m = (sin(0.06981317 *
              EX3_CircularTrajectoryNew_B.Sum6_l1) * 0.7 +
              EX3_CircularTrajectoryNew_P.yLength / 2.0) -
              EX3_CircularTrajectoryNew_DW.RED_Py;

            // Delay: '<S404>/Delay1'
            if (EX3_CircularTrajectoryNew_DW.icLoad_g != 0) {
              EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_il =
                EX3_CircularTrajectoryNew_B.Subtract1_m;
            }
            ...
            if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
              ...
              EX3_CircularTrajectoryNew_B.In1_g4 =
                EX3_CircularTrajectoryNew_B.Sum6_l1;
            ...
            EX3_CircularTrajectoryNew_DW.RED_Fy = 1.0 /
              EX3_CircularTrajectoryNew_P.serverRate *
              EX3_CircularTrajectoryNew_B.In1_g4 *
              EX3_CircularTrajectoryNew_P.Kd_yr +
              EX3_CircularTrajectoryNew_P.Kp_yr *
              EX3_CircularTrajectoryNew_B.Subtract1_m;
            ...
            EX3_CircularTrajectoryNew_DW.Float_State =
              EX3_CircularTrajectoryNew_P.PuckState_Value_f;
      ...
      // End of Outputs for SubSystem: '<Root>/Phase #3: Experiment'
               ...
               EX3_CircularTrajectoryNew_P.Phase4_End) {
      EX3_CircularTrajectoryNew_DW.SeparatePhases_ActiveSubsystem = 4;
      ...
      EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhethero_d = -1;
      if ((EX3_CircularTrajectoryNew_P.WhoAmI == 2.0) ||
          (EX3_CircularTrajectoryNew_P.simMode == 1.0)) {
        EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhethero_d = 0;
        ...
        EX3_CircularTrajectoryNew_B.Subtract_d =
          EX3_CircularTrajectoryNew_P.home_states_BLACK[0] -
          EX3_CircularTrajectoryNew_DW.BLACK_Px;

        // Delay: '<S420>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_dq != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_lt =
            EX3_CircularTrajectoryNew_B.Subtract_d;
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_fx =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_DW.BLACK_Fx = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_fx * EX3_CircularTrajectoryNew_P.Kd_xb
          + EX3_CircularTrajectoryNew_P.Kp_xb *
          EX3_CircularTrajectoryNew_B.Subtract_d;
        ...
        EX3_CircularTrajectoryNew_B.Subtract1_d =
          EX3_CircularTrajectoryNew_P.home_states_BLACK[1] -
          EX3_CircularTrajectoryNew_DW.BLACK_Py;

        // Delay: '<S422>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_h != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_im =
            EX3_CircularTrajectoryNew_B.Subtract1_d;
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_d0 =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_DW.BLACK_Fy = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_d0 * EX3_CircularTrajectoryNew_P.Kd_yb
          + EX3_CircularTrajectoryNew_P.Kp_yb *
          EX3_CircularTrajectoryNew_B.Subtract1_d;
        ...
        EX3_Circu_MATLABFunction2_o
          (EX3_CircularTrajectoryNew_P.home_states_BLACK[2],
           &EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_p);

        // MATLAB Function: '<S417>/MATLAB Function3' incorporates:
        //   DataStoreRead: '<S410>/BLACK_Rz'

        EX3_Circula_MATLABFunction3(EX3_CircularTrajectoryNew_DW.BLACK_Rz,
          &EX3_CircularTrajectoryNew_B.sf_MATLABFunction3_b);

        // Sum: '<S417>/Subtract2'
        EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c[0] =
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_p.Ox[0] -
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction3_b.Ox[0];
        EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c[1] =
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_p.Ox[1] -
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction3_b.Ox[1];

        // MATLAB Function: '<S417>/MATLAB Function4'
        EX3_Circula_MATLABFunction4
          (EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_p.Oy,
           EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c,
           &EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_l);

        // Delay: '<S418>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_o != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_f =
            EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_l.e_out;
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_fk =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_DW.BLACK_Tz = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_fk * EX3_CircularTrajectoryNew_P.Kd_tb
          + EX3_CircularTrajectoryNew_P.Kp_tb *
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_l.e_out;
        ...
        EX3_CircularTrajectoryNew_DW.Float_State =
          EX3_CircularTrajectoryNew_P.PuckState_Value_fj;
      ...
      EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhether_jc = -1;
      if ((EX3_CircularTrajectoryNew_P.WhoAmI == 3.0) ||
          (EX3_CircularTrajectoryNew_P.simMode == 1.0)) {
        EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhether_jc = 0;

        // Outputs for IfAction SubSystem: '<S12>/Change BLUE Behavior' incorporates:
        //   ActionPort: '<S411>/Action Port'

        EX3_Ci_ChangeBLUEBehavior_g
          (&EX3_CircularTrajectoryNew_B.ChangeBLUEBehavior_gj,
           &EX3_CircularTrajectoryNew_DW.ChangeBLUEBehavior_gj,
           &EX3_CircularTrajectoryNew_P.ChangeBLUEBehavior_gj,
           &EX3_CircularTrajectoryNew_DW.BLUE_Fx,
           &EX3_CircularTrajectoryNew_DW.BLUE_Fy,
           &EX3_CircularTrajectoryNew_DW.BLUE_Px,
           &EX3_CircularTrajectoryNew_DW.BLUE_Py,
      ...
      EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhether_a4 = -1;
      if ((EX3_CircularTrajectoryNew_P.WhoAmI == 1.0) ||
          (EX3_CircularTrajectoryNew_P.simMode == 1.0)) {
        EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhether_a4 = 0;
        ...
        EX3_Circu_MATLABFunction2_o(EX3_CircularTrajectoryNew_P.home_states_RED
          [2], &EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_ia);

        // MATLAB Function: '<S443>/MATLAB Function3' incorporates:
        //   DataStoreRead: '<S412>/RED_Rz'

        EX3_Circula_MATLABFunction3(EX3_CircularTrajectoryNew_DW.RED_Rz,
          &EX3_CircularTrajectoryNew_B.sf_MATLABFunction3_c1);

        // Sum: '<S443>/Subtract2'
        EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c[0] =
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_ia.Ox[0] -
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction3_c1.Ox[0];
        EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c[1] =
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_ia.Ox[1] -
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction3_c1.Ox[1];

        // MATLAB Function: '<S443>/MATLAB Function4'
        EX3_Circula_MATLABFunction4
          (EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_ia.Oy,
           EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c,
           &EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_na);

        // Delay: '<S444>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_dh != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_i =
            EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_na.e_out;
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_h =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_DW.RED_Tz = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_h * EX3_CircularTrajectoryNew_P.Kd_tr
          + EX3_CircularTrajectoryNew_P.Kp_tr *
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_na.e_out;
        ...
        EX3_CircularTrajectoryNew_B.Subtract_l =
          EX3_CircularTrajectoryNew_P.home_states_RED[0] -
          EX3_CircularTrajectoryNew_DW.RED_Px;

        // Delay: '<S446>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_a2 != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_h =
            EX3_CircularTrajectoryNew_B.Subtract_l;
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_b =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_DW.RED_Fx = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_b * EX3_CircularTrajectoryNew_P.Kd_xr
          + EX3_CircularTrajectoryNew_P.Kp_xr *
          EX3_CircularTrajectoryNew_B.Subtract_l;
        ...
        EX3_CircularTrajectoryNew_DW.RED_Tz_RW =
          EX3_CircularTrajectoryNew_P.Constant2_Value_g;

        // Sum: '<S412>/Subtract1' incorporates:
        //   Constant: '<S412>/Constant3'
        //   DataStoreRead: '<S412>/RED_Py '

        EX3_CircularTrajectoryNew_B.Subtract1_g =
          EX3_CircularTrajectoryNew_P.home_states_RED[1] -
          EX3_CircularTrajectoryNew_DW.RED_Py;

        // Delay: '<S448>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_f != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_l =
            EX3_CircularTrajectoryNew_B.Subtract1_g;
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_f =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_DW.RED_Fy = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_f * EX3_CircularTrajectoryNew_P.Kd_yr
          + EX3_CircularTrajectoryNew_P.Kp_yr *
          EX3_CircularTrajectoryNew_B.Subtract1_g;
        ...
        EX3_CircularTrajectoryNew_DW.Float_State =
          EX3_CircularTrajectoryNew_P.PuckState_Value_od;
      ...
      // End of Outputs for SubSystem: '<Root>/Phase #4:  Return Home'
               ...
               EX3_CircularTrajectoryNew_P.Phase5_End) {
      EX3_CircularTrajectoryNew_DW.SeparatePhases_ActiveSubsystem = 5;
      ...
      EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhethero_b = -1;
      if ((EX3_CircularTrajectoryNew_P.WhoAmI == 2.0) ||
          (EX3_CircularTrajectoryNew_P.simMode == 1.0)) {
        EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhethero_b = 0;
        ...
        EX3_CircularTrajectoryNew_B.Subtract_o =
          EX3_CircularTrajectoryNew_P.home_states_BLACK[0] -
          EX3_CircularTrajectoryNew_DW.BLACK_Px;

        // Delay: '<S463>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_e != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_o =
            EX3_CircularTrajectoryNew_B.Subtract_o;
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_i =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_DW.BLACK_Fx = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_i * EX3_CircularTrajectoryNew_P.Kd_xb
          + EX3_CircularTrajectoryNew_P.Kp_xb *
          EX3_CircularTrajectoryNew_B.Subtract_o;
        ...
        EX3_CircularTrajectoryNew_B.Subtract1_c =
          EX3_CircularTrajectoryNew_P.home_states_BLACK[1] -
          EX3_CircularTrajectoryNew_DW.BLACK_Py;

        // Delay: '<S465>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_m != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_p =
            EX3_CircularTrajectoryNew_B.Subtract1_c;
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_c =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_DW.BLACK_Fy = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_c * EX3_CircularTrajectoryNew_P.Kd_yb
          + EX3_CircularTrajectoryNew_P.Kp_yb *
          EX3_CircularTrajectoryNew_B.Subtract1_c;
        ...
        EX3_Circu_MATLABFunction2_o
          (EX3_CircularTrajectoryNew_P.home_states_BLACK[2],
           &EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_gh);

        // MATLAB Function: '<S460>/MATLAB Function3' incorporates:
        //   DataStoreRead: '<S453>/BLACK_Rz'

        EX3_Circula_MATLABFunction3(EX3_CircularTrajectoryNew_DW.BLACK_Rz,
          &EX3_CircularTrajectoryNew_B.sf_MATLABFunction3_o);

        // Sum: '<S460>/Subtract2'
        EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c[0] =
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_gh.Ox[0] -
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction3_o.Ox[0];
        EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c[1] =
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_gh.Ox[1] -
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction3_o.Ox[1];

        // MATLAB Function: '<S460>/MATLAB Function4'
        EX3_Circula_MATLABFunction4
          (EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_gh.Oy,
           EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c,
           &EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_de);

        // Delay: '<S461>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_d != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_b =
            EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_de.e_out;
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_g =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_DW.BLACK_Tz = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_g * EX3_CircularTrajectoryNew_P.Kd_tb
          + EX3_CircularTrajectoryNew_P.Kp_tb *
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_de.e_out;
        ...
        EX3_CircularTrajectoryNew_DW.Float_State =
          EX3_CircularTrajectoryNew_P.PuckState_Value_g;
      ...
      EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhethero_n = -1;
      if ((EX3_CircularTrajectoryNew_P.WhoAmI == 3.0) ||
          (EX3_CircularTrajectoryNew_P.simMode == 1.0)) {
        EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhethero_n = 0;

        // Outputs for IfAction SubSystem: '<S13>/Change BLUE Behavior' incorporates:
        //   ActionPort: '<S454>/Action Port'

        EX3_Ci_ChangeBLUEBehavior_g
          (&EX3_CircularTrajectoryNew_B.ChangeBLUEBehavior_b,
           &EX3_CircularTrajectoryNew_DW.ChangeBLUEBehavior_b,
           &EX3_CircularTrajectoryNew_P.ChangeBLUEBehavior_b,
           &EX3_CircularTrajectoryNew_DW.BLUE_Fx,
           &EX3_CircularTrajectoryNew_DW.BLUE_Fy,
           &EX3_CircularTrajectoryNew_DW.BLUE_Px,
           &EX3_CircularTrajectoryNew_DW.BLUE_Py,
      ...
      EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhethero_j = -1;
      if ((EX3_CircularTrajectoryNew_P.WhoAmI == 1.0) ||
          (EX3_CircularTrajectoryNew_P.simMode == 1.0)) {
        EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhethero_j = 0;
        ...
        EX3_CircularTrajectoryNew_B.Subtract =
          EX3_CircularTrajectoryNew_P.home_states_RED[0] -
          EX3_CircularTrajectoryNew_DW.RED_Px;

        // Delay: '<S489>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE =
            EX3_CircularTrajectoryNew_B.Subtract;
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_j =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_DW.RED_Fx = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_j * EX3_CircularTrajectoryNew_P.Kd_xr
          + EX3_CircularTrajectoryNew_P.Kp_xr *
          EX3_CircularTrajectoryNew_B.Subtract;
        ...
        EX3_CircularTrajectoryNew_DW.RED_Tz_RW =
          EX3_CircularTrajectoryNew_P.Constant1_Value_k;

        // Sum: '<S455>/Subtract1' incorporates:
        //   Constant: '<S455>/Constant2'
        //   DataStoreRead: '<S455>/RED_Py '

        EX3_CircularTrajectoryNew_B.Subtract1 =
          EX3_CircularTrajectoryNew_P.home_states_RED[1] -
          EX3_CircularTrajectoryNew_DW.RED_Py;

        // Delay: '<S491>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_j != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_m =
            EX3_CircularTrajectoryNew_B.Subtract1;
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1 = EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_DW.RED_Fy = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1 * EX3_CircularTrajectoryNew_P.Kd_yr +
          EX3_CircularTrajectoryNew_P.Kp_yr *
          EX3_CircularTrajectoryNew_B.Subtract1;
        ...
        EX3_Circu_MATLABFunction2_o(EX3_CircularTrajectoryNew_P.home_states_RED
          [2], &EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_mx);

        // MATLAB Function: '<S486>/MATLAB Function3' incorporates:
        //   DataStoreRead: '<S455>/RED_Rz'

        EX3_Circula_MATLABFunction3(EX3_CircularTrajectoryNew_DW.RED_Rz,
          &EX3_CircularTrajectoryNew_B.sf_MATLABFunction3_bc);

        // Sum: '<S486>/Subtract2'
        EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c[0] =
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_mx.Ox[0] -
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction3_bc.Ox[0];
        EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c[1] =
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_mx.Ox[1] -
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction3_bc.Ox[1];

        // MATLAB Function: '<S486>/MATLAB Function4'
        EX3_Circula_MATLABFunction4
          (EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_mx.Oy,
           EX3_CircularTrajectoryNew_B.rtb_Subtract2_f_c,
           &EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_df);

        // Delay: '<S487>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_a != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_n =
            EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_df.e_out;
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_d =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_DW.RED_Tz = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_d * EX3_CircularTrajectoryNew_P.Kd_tr
          + EX3_CircularTrajectoryNew_P.Kp_tr *
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_df.e_out;
        ...
        EX3_CircularTrajectoryNew_DW.Float_State =
          EX3_CircularTrajectoryNew_P.PuckState_Value_es;
      ...
      EX3_CircularTrajectoryNew_DW.SeparatePhases_ActiveSubsystem = 6;
      ...
      if ((EX3_CircularTrajectoryNew_P.WhoAmI == 3.0) ||
        ...
        EX3_Circ_ChangeBLUEBehavior
          (&EX3_CircularTrajectoryNew_P.ChangeBLUEBehavior_k,
           &EX3_CircularTrajectoryNew_DW.BLUE_Fx,
           &EX3_CircularTrajectoryNew_DW.BLUE_Fy,
           &EX3_CircularTrajectoryNew_DW.BLUE_Tz,
           &EX3_CircularTrajectoryNew_DW.Float_State);
      ...
      if ((EX3_CircularTrajectoryNew_P.WhoAmI == 1.0) ||
        ...
        EX3_CircularTrajectoryNew_DW.RED_Fx =
          EX3_CircularTrajectoryNew_P.Constant_Value_j;

        // DataStoreWrite: '<S498>/RED_Fy' incorporates:
        //   Constant: '<S498>/Constant1'

        EX3_CircularTrajectoryNew_DW.RED_Fy =
          EX3_CircularTrajectoryNew_P.Constant1_Value_l;

        // DataStoreWrite: '<S498>/RED_Tz' incorporates:
        //   Constant: '<S498>/Constant2'

        EX3_CircularTrajectoryNew_DW.RED_Tz =
          EX3_CircularTrajectoryNew_P.Constant2_Value_m;

        // DataStoreWrite: '<S498>/Data Store Write3' incorporates:
        //   Constant: '<S498>/Puck State'

        EX3_CircularTrajectoryNew_DW.Float_State =
          EX3_CircularTrajectoryNew_P.PuckState_Value_h;

        // Gain: '<S498>/Gain' incorporates:
        //   DataStoreRead: '<S498>/RED_dRz_Speed'

        EX3_CircularTrajectoryNew_B.Sum6_l1 =
          EX3_CircularTrajectoryNew_P.Gain_Gain_a3 *
          EX3_CircularTrajectoryNew_DW.RED_dRz_RW_Sat;

        // Saturate: '<S498>/Saturation'
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 >
            EX3_CircularTrajectoryNew_P.Saturation_UpperSat) {
          EX3_CircularTrajectoryNew_DW.RED_Tz_RW =
            EX3_CircularTrajectoryNew_P.Saturation_UpperSat;
        } else if (EX3_CircularTrajectoryNew_B.Sum6_l1 <
                   EX3_CircularTrajectoryNew_P.Saturation_LowerSat) {
          EX3_CircularTrajectoryNew_DW.RED_Tz_RW =
            EX3_CircularTrajectoryNew_P.Saturation_LowerSat;
        } else {
          EX3_CircularTrajectoryNew_DW.RED_Tz_RW =
    ...
    if (EX3_CircularTrajectoryNew_P.simMode == 1.0) {
      ...
      EX3_CircularTrajectoryNew_B.RED_Tz_Wrist =
        EX3_CircularTrajectoryNew_DW.BLACK_Fx_Sat /
        EX3_CircularTrajectoryNew_P.model_param[2] *
        EX3_CircularTrajectoryNew_P.AccelerationtoVelocity_gainval +
        EX3_CircularTrajectoryNew_DW.AccelerationtoVelocity_DSTATE[0];

      // DiscreteIntegrator: '<S500>/Velocity to Position'
      EX3_CircularTrajectoryNew_B.VelocitytoPosition[0] =
        EX3_CircularTrajectoryNew_P.VelocitytoPosition_gainval *
        EX3_CircularTrajectoryNew_B.RED_Tz_Wrist +
        EX3_CircularTrajectoryNew_DW.VelocitytoPosition_DSTATE[0];
      EX3_CircularTrajectoryNew_B.x_ddot_a[0] =
        EX3_CircularTrajectoryNew_B.RED_Tz_Wrist;
      ...
      EX3_CircularTrajectoryNew_B.RED_Tz_Wrist =
        EX3_CircularTrajectoryNew_DW.BLACK_Fy_Sat /
        EX3_CircularTrajectoryNew_P.model_param[2] *
        EX3_CircularTrajectoryNew_P.AccelerationtoVelocity_gainval +
        EX3_CircularTrajectoryNew_DW.AccelerationtoVelocity_DSTATE[1];

      // DiscreteIntegrator: '<S500>/Velocity to Position'
      EX3_CircularTrajectoryNew_B.VelocitytoPosition[1] =
        EX3_CircularTrajectoryNew_P.VelocitytoPosition_gainval *
        EX3_CircularTrajectoryNew_B.RED_Tz_Wrist +
        EX3_CircularTrajectoryNew_DW.VelocitytoPosition_DSTATE[1];
      EX3_CircularTrajectoryNew_B.x_ddot_a[1] =
        EX3_CircularTrajectoryNew_B.RED_Tz_Wrist;
      ...
      EX3_CircularTrajectoryNew_B.RED_Tz_Wrist =
        EX3_CircularTrajectoryNew_DW.BLACK_Tz_Sat /
        EX3_CircularTrajectoryNew_P.model_param[3] *
        EX3_CircularTrajectoryNew_P.AccelerationtoVelocity_gainval +
        EX3_CircularTrajectoryNew_DW.AccelerationtoVelocity_DSTATE[2];

      // DiscreteIntegrator: '<S500>/Velocity to Position'
      EX3_CircularTrajectoryNew_B.VelocitytoPosition[2] =
        EX3_CircularTrajectoryNew_P.VelocitytoPosition_gainval *
        EX3_CircularTrajectoryNew_B.RED_Tz_Wrist +
        EX3_CircularTrajectoryNew_DW.VelocitytoPosition_DSTATE[2];

      // MATLAB Function: '<S506>/MATLAB Function' incorporates:
      //   Constant: '<S506>/Constant1'
      //   DataStoreRead: '<S506>/Data Store Read2'

      EX3_Circul_MATLABFunction_f(EX3_CircularTrajectoryNew_DW.Univ_Time,
        EX3_CircularTrajectoryNew_P.serverRate,
        &EX3_CircularTrajectoryNew_B.sf_MATLABFunction_fm);

      // Outputs for Triggered SubSystem: '<S506>/Sample and Hold1' incorporates:
      //   TriggerPort: '<S528>/Trigger'

      EX3_CircularTrajectoryNew_B.zcEvent = rt_ZCFcn(RISING_ZERO_CROSSING,
        &EX3_CircularTrajectoryN_PrevZCX.SampleandHold1_Trig_ZCE_c,
        (EX3_CircularTrajectoryNew_B.sf_MATLABFunction_fm.y));
      if (EX3_CircularTrajectoryNew_B.zcEvent != NO_ZCEVENT) {
        EX3_CircularTrajectoryNew_B.In_l[0] =
          EX3_CircularTrajectoryNew_B.VelocitytoPosition[0] +
          EX3_CircularTrajectoryNew_DW.NextOutput;
        EX3_CircularTrajectoryNew_B.In_l[1] =
          EX3_CircularTrajectoryNew_B.VelocitytoPosition[1] +
          EX3_CircularTrajectoryNew_DW.NextOutput;
        EX3_CircularTrajectoryNew_B.In_l[2] =
          EX3_CircularTrajectoryNew_B.VelocitytoPosition[2] +
          EX3_CircularTrajectoryNew_DW.NextOutput;
      }
      ...
      if (EX3_CircularTrajectoryNew_DW.icLoad_lm != 0) {
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_ff =
          EX3_CircularTrajectoryNew_B.In_l[0];
      }
      ...
      EX3_CircularTrajectoryNew_B.Sum6_l1 = EX3_CircularTrajectoryNew_B.In_l[0]
        - EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_ff;
      ...
      if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
        ...
        EX3_CircularTrajectoryNew_B.In1_gi = EX3_CircularTrajectoryNew_B.Sum6_l1;
      ...
      EX3_CircularTrajectoryNew_DW.BLACK_Vx = 1.0 /
        EX3_CircularTrajectoryNew_P.serverRate *
        EX3_CircularTrajectoryNew_B.In1_gi;

      // Delay: '<S512>/Delay1' incorporates:
      //   DataStoreWrite: '<S16>/BLACK_Vx'

      if (EX3_CircularTrajectoryNew_DW.icLoad_em != 0) {
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_p5 =
          EX3_CircularTrajectoryNew_DW.BLACK_Vx;
      }
      ...
      if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
        ...
        EX3_CircularTrajectoryNew_B.In1_k0 = EX3_CircularTrajectoryNew_B.Sum6_l1;
      ...
      EX3_CircularTrajectoryNew_DW.BLACK_IMU_Ax_I = 1.0 /
        EX3_CircularTrajectoryNew_P.serverRate *
        EX3_CircularTrajectoryNew_B.In1_k0 +
        EX3_CircularTrajectoryNew_DW.NextOutput_g;

      // Delay: '<S519>/Delay1'
      if (EX3_CircularTrajectoryNew_DW.icLoad_nw != 0) {
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_e =
          EX3_CircularTrajectoryNew_B.In_l[1];
      }
      ...
      EX3_CircularTrajectoryNew_B.Sum6_l1 = EX3_CircularTrajectoryNew_B.In_l[1]
        - EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_e;
      ...
      if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
        ...
        EX3_CircularTrajectoryNew_B.In1_fu = EX3_CircularTrajectoryNew_B.Sum6_l1;
      ...
      EX3_CircularTrajectoryNew_DW.BLACK_Vy = 1.0 /
        EX3_CircularTrajectoryNew_P.serverRate *
        EX3_CircularTrajectoryNew_B.In1_fu;

      // Delay: '<S513>/Delay1' incorporates:
      //   DataStoreWrite: '<S16>/BLACK_Vy'

      if (EX3_CircularTrajectoryNew_DW.icLoad_og != 0) {
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_cb =
          EX3_CircularTrajectoryNew_DW.BLACK_Vy;
      }
      ...
      if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
        ...
        EX3_CircularTrajectoryNew_B.In1_fw = EX3_CircularTrajectoryNew_B.Sum6_l1;
      ...
      EX3_CircularTrajectoryNew_DW.BLACK_IMU_Ay_I = 1.0 /
        EX3_CircularTrajectoryNew_P.serverRate *
        EX3_CircularTrajectoryNew_B.In1_fw +
        EX3_CircularTrajectoryNew_DW.NextOutput_h;

      // Delay: '<S520>/Delay1'
      if (EX3_CircularTrajectoryNew_DW.icLoad_ka != 0) {
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_ew =
          EX3_CircularTrajectoryNew_B.In_l[2];
      }
      ...
      EX3_CircularTrajectoryNew_B.Sum6_l1 = EX3_CircularTrajectoryNew_B.In_l[2]
        - EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_ew;
      ...
      if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
        ...
        EX3_CircularTrajectoryNew_B.In1_m = EX3_CircularTrajectoryNew_B.Sum6_l1;
      ...
      EX3_CircularTrajectoryNew_DW.BLACK_RzD = 1.0 /
        EX3_CircularTrajectoryNew_P.serverRate *
        EX3_CircularTrajectoryNew_B.In1_m;
      ...
      EX3_CircularTrajectoryNew_DW.BLACK_IMU_R =
        EX3_CircularTrajectoryNew_DW.BLACK_RzD +
        EX3_CircularTrajectoryNew_DW.NextOutput_e;

      // DataStoreWrite: '<S16>/BLACK_Px'
      EX3_CircularTrajectoryNew_DW.BLACK_Px = EX3_CircularTrajectoryNew_B.In_l[0];

      // DataStoreWrite: '<S16>/BLACK_Py'
      EX3_CircularTrajectoryNew_DW.BLACK_Py = EX3_CircularTrajectoryNew_B.In_l[1];

      // DataStoreWrite: '<S16>/BLACK_Rz'
      EX3_CircularTrajectoryNew_DW.BLACK_Rz = EX3_CircularTrajectoryNew_B.In_l[2];
      ...
      EX3_CircularTrajectoryNew_B.y5 = EX3_CircularTrajectoryNew_DW.BLUE_Fx_Sat /
        EX3_CircularTrajectoryNew_P.model_param[4] *
        EX3_CircularTrajectoryNew_P.AccelerationtoVelocity_gainva_e +
        EX3_CircularTrajectoryNew_DW.AccelerationtoVelocity_DSTATE_k[0];

      // DiscreteIntegrator: '<S501>/Velocity to Position'
      EX3_CircularTrajectoryNew_B.VelocitytoPosition_d_idx_0 =
        EX3_CircularTrajectoryNew_P.VelocitytoPosition_gainval_n *
        EX3_CircularTrajectoryNew_B.y5 +
        EX3_CircularTrajectoryNew_DW.VelocitytoPosition_DSTATE_p[0];
      EX3_CircularTrajectoryNew_B.x_ddot_m[0] = EX3_CircularTrajectoryNew_B.y5;
      ...
      EX3_CircularTrajectoryNew_B.y5 = EX3_CircularTrajectoryNew_DW.BLUE_Fy_Sat /
        EX3_CircularTrajectoryNew_P.model_param[4] *
        EX3_CircularTrajectoryNew_P.AccelerationtoVelocity_gainva_e +
        EX3_CircularTrajectoryNew_DW.AccelerationtoVelocity_DSTATE_k[1];

      // DiscreteIntegrator: '<S501>/Velocity to Position'
      EX3_CircularTrajectoryNew_B.VelocitytoPosition_d_idx_1 =
        EX3_CircularTrajectoryNew_P.VelocitytoPosition_gainval_n *
        EX3_CircularTrajectoryNew_B.y5 +
        EX3_CircularTrajectoryNew_DW.VelocitytoPosition_DSTATE_p[1];
      EX3_CircularTrajectoryNew_B.x_ddot_m[1] = EX3_CircularTrajectoryNew_B.y5;
      ...
      EX3_CircularTrajectoryNew_B.y5 = EX3_CircularTrajectoryNew_DW.BLUE_Tz_Sat /
        EX3_CircularTrajectoryNew_P.model_param[5] *
        EX3_CircularTrajectoryNew_P.AccelerationtoVelocity_gainva_e +
        EX3_CircularTrajectoryNew_DW.AccelerationtoVelocity_DSTATE_k[2];

      // DiscreteIntegrator: '<S501>/Velocity to Position'
      EX3_CircularTrajectoryNew_B.VelocitytoPosition_d_idx_2 =
        EX3_CircularTrajectoryNew_P.VelocitytoPosition_gainval_n *
        EX3_CircularTrajectoryNew_B.y5 +
        EX3_CircularTrajectoryNew_DW.VelocitytoPosition_DSTATE_p[2];
      ...
      EX3_Circul_MATLABFunction_f(EX3_CircularTrajectoryNew_DW.Univ_Time,
        EX3_CircularTrajectoryNew_P.serverRate,
        &EX3_CircularTrajectoryNew_B.sf_MATLABFunction_g);

      // Outputs for Triggered SubSystem: '<S507>/Sample and Hold1' incorporates:
      //   TriggerPort: '<S530>/Trigger'

      EX3_CircularTrajectoryNew_B.zcEvent = rt_ZCFcn(RISING_ZERO_CROSSING,
        &EX3_CircularTrajectoryN_PrevZCX.SampleandHold1_Trig_ZCE,
        (EX3_CircularTrajectoryNew_B.sf_MATLABFunction_g.y));
      if (EX3_CircularTrajectoryNew_B.zcEvent != NO_ZCEVENT) {
        EX3_CircularTrajectoryNew_B.In_k[0] =
          EX3_CircularTrajectoryNew_B.VelocitytoPosition_d_idx_0 +
          EX3_CircularTrajectoryNew_DW.NextOutput_m;
        EX3_CircularTrajectoryNew_B.In_k[1] =
          EX3_CircularTrajectoryNew_B.VelocitytoPosition_d_idx_1 +
          EX3_CircularTrajectoryNew_DW.NextOutput_m;
        EX3_CircularTrajectoryNew_B.In_k[2] =
          EX3_CircularTrajectoryNew_B.VelocitytoPosition_d_idx_2 +
          EX3_CircularTrajectoryNew_DW.NextOutput_m;
      }
      ...
      if (EX3_CircularTrajectoryNew_DW.icLoad_lf != 0) {
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_kn =
          EX3_CircularTrajectoryNew_B.In_k[0];
      }
      ...
      EX3_CircularTrajectoryNew_B.Sum6_l1 = EX3_CircularTrajectoryNew_B.In_k[0]
        - EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_kn;
      ...
      if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
        ...
        EX3_CircularTrajectoryNew_B.In1_b0 = EX3_CircularTrajectoryNew_B.Sum6_l1;
      ...
      EX3_CircularTrajectoryNew_DW.BLUE_Vx = 1.0 /
        EX3_CircularTrajectoryNew_P.serverRate *
        EX3_CircularTrajectoryNew_B.In1_b0;

      // Delay: '<S514>/Delay1' incorporates:
      //   DataStoreWrite: '<S16>/BLUE_Vx'

      if (EX3_CircularTrajectoryNew_DW.icLoad_aq != 0) {
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_gc =
          EX3_CircularTrajectoryNew_DW.BLUE_Vx;
      }

      // End of Delay: '<S514>/Delay1'

      // Delay: '<S522>/Delay1'
      if (EX3_CircularTrajectoryNew_DW.icLoad_nc != 0) {
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_gu =
          EX3_CircularTrajectoryNew_B.In_k[1];
      }
      ...
      EX3_CircularTrajectoryNew_B.Sum6_l1 = EX3_CircularTrajectoryNew_B.In_k[1]
        - EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_gu;
      ...
      if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
        ...
        EX3_CircularTrajectoryNew_B.In1_hg = EX3_CircularTrajectoryNew_B.Sum6_l1;
      ...
      EX3_CircularTrajectoryNew_DW.BLUE_Vy = 1.0 /
        EX3_CircularTrajectoryNew_P.serverRate *
        EX3_CircularTrajectoryNew_B.In1_hg;

      // Delay: '<S515>/Delay1' incorporates:
      //   DataStoreWrite: '<S16>/BLUE_Vy'

      if (EX3_CircularTrajectoryNew_DW.icLoad_kx != 0) {
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_a =
          EX3_CircularTrajectoryNew_DW.BLUE_Vy;
      }

      // End of Delay: '<S515>/Delay1'

      // Delay: '<S523>/Delay1'
      if (EX3_CircularTrajectoryNew_DW.icLoad_fa != 0) {
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_dd =
          EX3_CircularTrajectoryNew_B.In_k[2];
      }
      ...
      EX3_CircularTrajectoryNew_B.Sum6_l1 = EX3_CircularTrajectoryNew_B.In_k[2]
        - EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_dd;
      ...
      if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
        ...
        EX3_CircularTrajectoryNew_B.In1_n0 = EX3_CircularTrajectoryNew_B.Sum6_l1;
      ...
      EX3_CircularTrajectoryNew_DW.BLUE_RzD = 1.0 /
        EX3_CircularTrajectoryNew_P.serverRate *
        EX3_CircularTrajectoryNew_B.In1_n0;
      ...
      EX3_CircularTrajectoryNew_B.Sum6_l1 =
        EX3_CircularTrajectoryNew_DW.BLUE_RzD +
        EX3_CircularTrajectoryNew_DW.NextOutput_f;

      // DataStoreWrite: '<S16>/BLUE_Px '
      EX3_CircularTrajectoryNew_DW.BLUE_Px = EX3_CircularTrajectoryNew_B.In_k[0];

      // DataStoreWrite: '<S16>/BLUE_Py'
      EX3_CircularTrajectoryNew_DW.BLUE_Py = EX3_CircularTrajectoryNew_B.In_k[1];

      // DataStoreWrite: '<S16>/BLUE_Rz'
      EX3_CircularTrajectoryNew_DW.BLUE_Rz = EX3_CircularTrajectoryNew_B.In_k[2];

      // RelationalOperator: '<S502>/Compare' incorporates:
      //   Constant: '<S502>/Constant'
      //   DataStoreRead: '<S16>/Data Store Read1'

      EX3_CircularTrajectoryNew_B.rtb_Compare_p =
        (EX3_CircularTrajectoryNew_DW.BLUE_Rz ==
         EX3_CircularTrajectoryNew_P.Constant_Value_l);

      // DiscreteIntegrator: '<S16>/Discrete-Time Integrator' incorporates:
      //   DataStoreRead: '<S16>/Data Store Read1'

      if (EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator_IC_LOADI != 0) {
        EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator_DSTATE =
          EX3_CircularTrajectoryNew_DW.BLUE_Rz;
      }

      if ((EX3_CircularTrajectoryNew_B.rtb_Compare_p &&
           (EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator_PrevRese <= 0)) ||
          ((!EX3_CircularTrajectoryNew_B.rtb_Compare_p) &&
           (EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator_PrevRese == 1)))
      {
        EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator_DSTATE =
          EX3_CircularTrajectoryNew_DW.BLUE_Rz;
      }
      ...
      EX3_CircularTrajectoryNew_B.rtb_Compare_m_n =
        (EX3_CircularTrajectoryNew_DW.BLACK_Rz ==
         EX3_CircularTrajectoryNew_P.Constant_Value_b);
      ...
      if (EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_IC_LOAD != 0) {
        EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_DSTATE =
          EX3_CircularTrajectoryNew_DW.BLACK_Rz;
      }

      if ((EX3_CircularTrajectoryNew_B.rtb_Compare_m_n &&
           (EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_PrevRes <= 0)) ||
          ((!EX3_CircularTrajectoryNew_B.rtb_Compare_m_n) &&
           (EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_PrevRes == 1)))
      {
        EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_DSTATE =
          EX3_CircularTrajectoryNew_DW.BLACK_Rz;
      }

      EX3_CircularTrajectoryNew_DW.BLACK_IMU_Psi =
        EX3_CircularTrajectoryNew_P.DiscreteTimeIntegrator1_gainv_c *
        EX3_CircularTrajectoryNew_DW.BLACK_IMU_R +
        EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_DSTATE;
      ...
      EX3_CircularTrajectoryNew_B.rtb_Compare_g_m =
        (EX3_CircularTrajectoryNew_DW.RED_Rz ==
         EX3_CircularTrajectoryNew_P.Constant_Value_hs);
      ...
      if (EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator2_IC_LOAD != 0) {
        EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator2_DSTATE =
          EX3_CircularTrajectoryNew_DW.RED_Rz;
      }

      if ((EX3_CircularTrajectoryNew_B.rtb_Compare_g_m &&
           (EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator2_PrevRes <= 0)) ||
          ((!EX3_CircularTrajectoryNew_B.rtb_Compare_g_m) &&
           (EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator2_PrevRes == 1)))
      {
        EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator2_DSTATE =
          EX3_CircularTrajectoryNew_DW.RED_Rz;
      }

      EX3_CircularTrajectoryNew_DW.RED_IMU_Psi =
        EX3_CircularTrajectoryNew_P.DiscreteTimeIntegrator2_gainval *
        EX3_CircularTrajectoryNew_DW.RED_IMU_R +
        EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator2_DSTATE;
      ...
      EX3_CircularTrajectoryNew_B.y10 = EX3_CircularTrajectoryNew_DW.RED_Fx_Sat /
        EX3_CircularTrajectoryNew_P.model_param[0] *
        EX3_CircularTrajectoryNew_P.AccelerationtoVelocity_gainva_n +
        EX3_CircularTrajectoryNew_DW.AccelerationtoVelocity_DSTATE_j[0];

      // DiscreteIntegrator: '<S505>/Velocity to Position'
      EX3_CircularTrajectoryNew_B.rtb_TmpSignalConversionAtSFun_f =
        EX3_CircularTrajectoryNew_P.VelocitytoPosition_gainval_p *
        EX3_CircularTrajectoryNew_B.y10 +
        EX3_CircularTrajectoryNew_DW.VelocitytoPosition_DSTATE_h[0];
      EX3_CircularTrajectoryNew_B.rtb_x_ddot_idx_0 =
        EX3_CircularTrajectoryNew_B.y10;
      ...
      EX3_CircularTrajectoryNew_B.y10 = EX3_CircularTrajectoryNew_DW.RED_Fy_Sat /
        EX3_CircularTrajectoryNew_P.model_param[0] *
        EX3_CircularTrajectoryNew_P.AccelerationtoVelocity_gainva_n +
        EX3_CircularTrajectoryNew_DW.AccelerationtoVelocity_DSTATE_j[1];

      // DiscreteIntegrator: '<S505>/Velocity to Position'
      EX3_CircularTrajectoryNew_B.rtb_TmpSignalConversionAtSFun_g =
        EX3_CircularTrajectoryNew_P.VelocitytoPosition_gainval_p *
        EX3_CircularTrajectoryNew_B.y10 +
        EX3_CircularTrajectoryNew_DW.VelocitytoPosition_DSTATE_h[1];
      EX3_CircularTrajectoryNew_B.rtb_x_ddot_idx_1 =
        EX3_CircularTrajectoryNew_B.y10;
      ...
      EX3_CircularTrajectoryNew_B.y10 = (EX3_CircularTrajectoryNew_DW.RED_Tz_Sat
        + EX3_CircularTrajectoryNew_DW.RED_Tz_RW_Sat) /
        EX3_CircularTrajectoryNew_P.model_param[1] *
        EX3_CircularTrajectoryNew_P.AccelerationtoVelocity_gainva_n +
        EX3_CircularTrajectoryNew_DW.AccelerationtoVelocity_DSTATE_j[2];

      // DiscreteIntegrator: '<S505>/Velocity to Position'
      EX3_CircularTrajectoryNew_B.rtb_TmpSignalConversionAtSFu_g1 =
        EX3_CircularTrajectoryNew_P.VelocitytoPosition_gainval_p *
        EX3_CircularTrajectoryNew_B.y10 +
        EX3_CircularTrajectoryNew_DW.VelocitytoPosition_DSTATE_h[2];
      ...
      EX3_Circul_MATLABFunction_f(EX3_CircularTrajectoryNew_DW.Univ_Time,
        EX3_CircularTrajectoryNew_P.serverRate,
        &EX3_CircularTrajectoryNew_B.sf_MATLABFunction_d);

      // Outputs for Triggered SubSystem: '<S508>/Sample and Hold' incorporates:
      //   TriggerPort: '<S532>/Trigger'

      EX3_CircularTrajectoryNew_B.zcEvent = rt_ZCFcn(RISING_ZERO_CROSSING,
        &EX3_CircularTrajectoryN_PrevZCX.SampleandHold_Trig_ZCE,
        (EX3_CircularTrajectoryNew_B.sf_MATLABFunction_d.y));
      if (EX3_CircularTrajectoryNew_B.zcEvent != NO_ZCEVENT) {
        EX3_CircularTrajectoryNew_B.In[0] =
          EX3_CircularTrajectoryNew_B.rtb_TmpSignalConversionAtSFun_f +
          EX3_CircularTrajectoryNew_DW.NextOutput_l;
        EX3_CircularTrajectoryNew_B.In[1] =
          EX3_CircularTrajectoryNew_B.rtb_TmpSignalConversionAtSFun_g +
          EX3_CircularTrajectoryNew_DW.NextOutput_l;
        EX3_CircularTrajectoryNew_B.In[2] =
          EX3_CircularTrajectoryNew_B.rtb_TmpSignalConversionAtSFu_g1 +
          EX3_CircularTrajectoryNew_DW.NextOutput_l;
      }
      ...
      if (EX3_CircularTrajectoryNew_DW.icLoad_ky != 0) {
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_ol =
          EX3_CircularTrajectoryNew_B.In[0];
      }
      ...
      EX3_CircularTrajectoryNew_B.Sum6_dk = EX3_CircularTrajectoryNew_B.In[0] -
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_ol;
      ...
      if (EX3_CircularTrajectoryNew_B.Sum6_dk != 0.0) {
        ...
        EX3_CircularTrajectoryNew_B.In1_p = EX3_CircularTrajectoryNew_B.Sum6_dk;
      ...
      EX3_CircularTrajectoryNew_DW.RED_Vx = 1.0 /
        EX3_CircularTrajectoryNew_P.serverRate *
        EX3_CircularTrajectoryNew_B.In1_p;

      // Delay: '<S510>/Delay1' incorporates:
      //   DataStoreWrite: '<S16>/RED_Vx'

      if (EX3_CircularTrajectoryNew_DW.icLoad_eg != 0) {
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_pm =
          EX3_CircularTrajectoryNew_DW.RED_Vx;
      }
      ...
      EX3_CircularTrajectoryNew_B.Sum6_dk = EX3_CircularTrajectoryNew_DW.RED_Vx
        - EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_pm;
      ...
      if (EX3_CircularTrajectoryNew_B.Sum6_dk != 0.0) {
        ...
        EX3_CircularTrajectoryNew_B.In1_kd = EX3_CircularTrajectoryNew_B.Sum6_dk;
      ...
      EX3_CircularTrajectoryNew_DW.RED_IMU_Ax_I = 1.0 /
        EX3_CircularTrajectoryNew_P.serverRate *
        EX3_CircularTrajectoryNew_B.In1_kd +
        EX3_CircularTrajectoryNew_DW.NextOutput_n;

      // Delay: '<S516>/Delay1'
      if (EX3_CircularTrajectoryNew_DW.icLoad_h5 != 0) {
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_a5 =
          EX3_CircularTrajectoryNew_B.In[1];
      }
      ...
      EX3_CircularTrajectoryNew_B.Sum6_dk = EX3_CircularTrajectoryNew_B.In[1] -
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_a5;
      ...
      if (EX3_CircularTrajectoryNew_B.Sum6_dk != 0.0) {
        ...
        EX3_CircularTrajectoryNew_B.In1_dl = EX3_CircularTrajectoryNew_B.Sum6_dk;
      ...
      EX3_CircularTrajectoryNew_DW.RED_Vy = 1.0 /
        EX3_CircularTrajectoryNew_P.serverRate *
        EX3_CircularTrajectoryNew_B.In1_dl;

      // Delay: '<S511>/Delay1' incorporates:
      //   DataStoreWrite: '<S16>/RED_Vy'

      if (EX3_CircularTrajectoryNew_DW.icLoad_p != 0) {
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_c3 =
          EX3_CircularTrajectoryNew_DW.RED_Vy;
      }
      ...
      EX3_CircularTrajectoryNew_B.Sum6_dk = EX3_CircularTrajectoryNew_DW.RED_Vy
        - EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_c3;
      ...
      if (EX3_CircularTrajectoryNew_B.Sum6_dk != 0.0) {
        ...
        EX3_CircularTrajectoryNew_B.In1_ed = EX3_CircularTrajectoryNew_B.Sum6_dk;
      ...
      EX3_CircularTrajectoryNew_DW.RED_IMU_Ay_I = 1.0 /
        EX3_CircularTrajectoryNew_P.serverRate *
        EX3_CircularTrajectoryNew_B.In1_ed +
        EX3_CircularTrajectoryNew_DW.NextOutput_hl;

      // Delay: '<S517>/Delay1'
      if (EX3_CircularTrajectoryNew_DW.icLoad_c != 0) {
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_mj =
          EX3_CircularTrajectoryNew_B.In[2];
      }
      ...
      EX3_CircularTrajectoryNew_B.Sum6_dk = EX3_CircularTrajectoryNew_B.In[2] -
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_mj;
      ...
      if (EX3_CircularTrajectoryNew_B.Sum6_dk != 0.0) {
        ...
        EX3_CircularTrajectoryNew_B.In1_ju = EX3_CircularTrajectoryNew_B.Sum6_dk;
      ...
      EX3_CircularTrajectoryNew_DW.RED_RzD = 1.0 /
        EX3_CircularTrajectoryNew_P.serverRate *
        EX3_CircularTrajectoryNew_B.In1_ju;
      ...
      EX3_CircularTrajectoryNew_DW.RED_IMU_R =
        EX3_CircularTrajectoryNew_DW.RED_RzD +
        EX3_CircularTrajectoryNew_DW.NextOutput_fw;

      // DataStoreWrite: '<S16>/RED_Px'
      EX3_CircularTrajectoryNew_DW.RED_Px = EX3_CircularTrajectoryNew_B.In[0];

      // DataStoreWrite: '<S16>/RED_Py'
      EX3_CircularTrajectoryNew_DW.RED_Py = EX3_CircularTrajectoryNew_B.In[1];

      // DataStoreWrite: '<S16>/RED_Rz'
      EX3_CircularTrajectoryNew_DW.RED_Rz = EX3_CircularTrajectoryNew_B.In[2];
      ...
      EX3_CircularTrajectoryNew_DW.NextOutput = EX3__rt_nrand_Upu32_Yd_f_pw_snf(
        &EX3_CircularTrajectoryNew_DW.RandSeed) * sqrt
        (EX3_CircularTrajectoryNew_P.noise_variance_BLACK) +
        EX3_CircularTrajectoryNew_P.RandomNumber_Mean;

      // Update for Delay: '<S518>/Delay1'
      EX3_CircularTrajectoryNew_DW.icLoad_lm = 0U;
      EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_ff =
        EX3_CircularTrajectoryNew_B.In_l[0];
      ...
      EX3_CircularTrajectoryNew_DW.icLoad_em = 0U;
      EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_p5 =
        EX3_CircularTrajectoryNew_DW.BLACK_Vx;

      // Update for RandomNumber: '<S16>/Random Number1'
      EX3_CircularTrajectoryNew_DW.NextOutput_g =
        EX3__rt_nrand_Upu32_Yd_f_pw_snf(&EX3_CircularTrajectoryNew_DW.RandSeed_p)
        * EX3_CircularTrajectoryNew_P.RandomNumber1_StdDev +
        EX3_CircularTrajectoryNew_P.RandomNumber1_Mean;

      // Update for Delay: '<S519>/Delay1'
      EX3_CircularTrajectoryNew_DW.icLoad_nw = 0U;
      EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_e =
        EX3_CircularTrajectoryNew_B.In_l[1];
      ...
      EX3_CircularTrajectoryNew_DW.icLoad_og = 0U;
      EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_cb =
        EX3_CircularTrajectoryNew_DW.BLACK_Vy;

      // Update for RandomNumber: '<S16>/Random Number'
      EX3_CircularTrajectoryNew_DW.NextOutput_h =
        EX3__rt_nrand_Upu32_Yd_f_pw_snf(&EX3_CircularTrajectoryNew_DW.RandSeed_i)
        * EX3_CircularTrajectoryNew_P.RandomNumber_StdDev +
        EX3_CircularTrajectoryNew_P.RandomNumber_Mean_g;

      // Update for Delay: '<S520>/Delay1'
      EX3_CircularTrajectoryNew_DW.icLoad_ka = 0U;
      EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_ew =
        EX3_CircularTrajectoryNew_B.In_l[2];

      // Update for RandomNumber: '<S16>/Random Number2'
      EX3_CircularTrajectoryNew_DW.NextOutput_e =
        EX3__rt_nrand_Upu32_Yd_f_pw_snf(&EX3_CircularTrajectoryNew_DW.RandSeed_b)
        * EX3_CircularTrajectoryNew_P.RandomNumber2_StdDev +
        EX3_CircularTrajectoryNew_P.RandomNumber2_Mean;

      // Update for RandomNumber: '<S501>/Random Number'
      EX3_CircularTrajectoryNew_DW.NextOutput_m =
        EX3__rt_nrand_Upu32_Yd_f_pw_snf(&EX3_CircularTrajectoryNew_DW.RandSeed_m)
        * sqrt(EX3_CircularTrajectoryNew_P.noise_variance_BLUE) +
        EX3_CircularTrajectoryNew_P.RandomNumber_Mean_o;

      // Update for Delay: '<S521>/Delay1'
      EX3_CircularTrajectoryNew_DW.icLoad_lf = 0U;
      EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_kn =
        EX3_CircularTrajectoryNew_B.In_k[0];
      ...
      EX3_CircularTrajectoryNew_DW.icLoad_aq = 0U;
      EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_gc =
        EX3_CircularTrajectoryNew_DW.BLUE_Vx;

      // Update for RandomNumber: '<S16>/Random Number4'
      EX3__rt_nrand_Upu32_Yd_f_pw_snf(&EX3_CircularTrajectoryNew_DW.RandSeed_bw);

      // Update for Delay: '<S522>/Delay1'
      EX3_CircularTrajectoryNew_DW.icLoad_nc = 0U;
      EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_gu =
        EX3_CircularTrajectoryNew_B.In_k[1];
      ...
      EX3_CircularTrajectoryNew_DW.icLoad_kx = 0U;
      EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_a =
        EX3_CircularTrajectoryNew_DW.BLUE_Vy;

      // Update for RandomNumber: '<S16>/Random Number3'
      EX3__rt_nrand_Upu32_Yd_f_pw_snf(&EX3_CircularTrajectoryNew_DW.RandSeed_n);

      // Update for Delay: '<S523>/Delay1'
      EX3_CircularTrajectoryNew_DW.icLoad_fa = 0U;
      EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_dd =
        EX3_CircularTrajectoryNew_B.In_k[2];

      // Update for RandomNumber: '<S16>/Random Number5'
      EX3_CircularTrajectoryNew_DW.NextOutput_f =
        EX3__rt_nrand_Upu32_Yd_f_pw_snf(&EX3_CircularTrajectoryNew_DW.RandSeed_g)
        * EX3_CircularTrajectoryNew_P.RandomNumber5_StdDev +
        EX3_CircularTrajectoryNew_P.RandomNumber5_Mean;

      // Update for DiscreteIntegrator: '<S16>/Discrete-Time Integrator' incorporates:
      //   DataStoreRead: '<S16>/Data Store Read3'

      EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator_IC_LOADI = 0U;
      EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator_DSTATE +=
        EX3_CircularTrajectoryNew_P.DiscreteTimeIntegrator_gainval *
        EX3_CircularTrajectoryNew_B.Sum6_l1;
      EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator_PrevRese =
        static_cast<int8_T>(EX3_CircularTrajectoryNew_B.rtb_Compare_p);

      // Update for DiscreteIntegrator: '<S16>/Discrete-Time Integrator1' incorporates:
      //   DataStoreWrite: '<S16>/RED_Px1'

      EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_IC_LOAD = 0U;
      EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_DSTATE =
        EX3_CircularTrajectoryNew_DW.BLACK_IMU_Psi;
      EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_PrevRes =
        static_cast<int8_T>(EX3_CircularTrajectoryNew_B.rtb_Compare_m_n);

      // Update for DiscreteIntegrator: '<S16>/Discrete-Time Integrator2' incorporates:
      //   DataStoreWrite: '<S16>/RED_Px2'

      EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator2_IC_LOAD = 0U;
      EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator2_DSTATE =
        EX3_CircularTrajectoryNew_DW.RED_IMU_Psi;
      EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator2_PrevRes =
        static_cast<int8_T>(EX3_CircularTrajectoryNew_B.rtb_Compare_g_m);

      // Update for DiscreteIntegrator: '<S501>/Acceleration  to Velocity'
      EX3_CircularTrajectoryNew_DW.AccelerationtoVelocity_DSTATE_k[0] =
        EX3_CircularTrajectoryNew_B.x_ddot_m[0];
      ...
      // Update for DiscreteIntegrator: '<S501>/Acceleration  to Velocity'
      EX3_CircularTrajectoryNew_DW.AccelerationtoVelocity_DSTATE_k[1] =
        EX3_CircularTrajectoryNew_B.x_ddot_m[1];
      ...
      EX3_CircularTrajectoryNew_DW.NextOutput_l =
        EX3__rt_nrand_Upu32_Yd_f_pw_snf
        (&EX3_CircularTrajectoryNew_DW.RandSeed_pz) * sqrt
        (EX3_CircularTrajectoryNew_P.noise_variance_RED) +
        EX3_CircularTrajectoryNew_P.RandomNumber_Mean_n;

      // Update for Delay: '<S509>/Delay1'
      EX3_CircularTrajectoryNew_DW.icLoad_ky = 0U;
      EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_ol =
        EX3_CircularTrajectoryNew_B.In[0];
      ...
      EX3_CircularTrajectoryNew_DW.icLoad_eg = 0U;
      EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_pm =
        EX3_CircularTrajectoryNew_DW.RED_Vx;

      // Update for RandomNumber: '<S16>/Random Number7'
      EX3_CircularTrajectoryNew_DW.NextOutput_n =
        EX3__rt_nrand_Upu32_Yd_f_pw_snf(&EX3_CircularTrajectoryNew_DW.RandSeed_a)
        * EX3_CircularTrajectoryNew_P.RandomNumber7_StdDev +
        EX3_CircularTrajectoryNew_P.RandomNumber7_Mean;

      // Update for Delay: '<S516>/Delay1'
      EX3_CircularTrajectoryNew_DW.icLoad_h5 = 0U;
      EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_a5 =
        EX3_CircularTrajectoryNew_B.In[1];
      ...
      EX3_CircularTrajectoryNew_DW.icLoad_p = 0U;
      EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_c3 =
        EX3_CircularTrajectoryNew_DW.RED_Vy;
      ...
      EX3_CircularTrajectoryNew_DW.NextOutput_hl =
        EX3__rt_nrand_Upu32_Yd_f_pw_snf
        (&EX3_CircularTrajectoryNew_DW.RandSeed_b3) *
        EX3_CircularTrajectoryNew_P.RandomNumber6_StdDev +
        EX3_CircularTrajectoryNew_P.RandomNumber6_Mean;

      // Update for Delay: '<S517>/Delay1'
      EX3_CircularTrajectoryNew_DW.icLoad_c = 0U;
      EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_mj =
        EX3_CircularTrajectoryNew_B.In[2];
      ...
      EX3_CircularTrajectoryNew_DW.NextOutput_fw =
        EX3__rt_nrand_Upu32_Yd_f_pw_snf
        (&EX3_CircularTrajectoryNew_DW.RandSeed_iv) *
        EX3_CircularTrajectoryNew_P.RandomNumber8_StdDev +
        EX3_CircularTrajectoryNew_P.RandomNumber8_Mean;
    ...
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[0] =
      EX3_CircularTrajectoryNew_DW.Univ_Time;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[1] =
      EX3_CircularTrajectoryNew_DW.RED_Fx_Sat;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[2] =
      EX3_CircularTrajectoryNew_DW.RED_Fy_Sat;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[3] =
      EX3_CircularTrajectoryNew_DW.RED_Tz_Sat;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[4] =
      EX3_CircularTrajectoryNew_DW.RED_Px;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[5] =
      EX3_CircularTrajectoryNew_DW.RED_Py;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[6] =
      EX3_CircularTrajectoryNew_DW.RED_Rz;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[7] =
      EX3_CircularTrajectoryNew_DW.RED_Vx;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[8] =
      EX3_CircularTrajectoryNew_DW.RED_Vy;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[9] =
      EX3_CircularTrajectoryNew_DW.RED_RzD;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[10] =
      EX3_CircularTrajectoryNew_DW.RED_AHRS_Q;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[11] =
      EX3_CircularTrajectoryNew_DW.RED_AHRS_P;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[12] =
      EX3_CircularTrajectoryNew_DW.RED_AHRS_R;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[13] =
      EX3_CircularTrajectoryNew_DW.RED_IMU_Ax_b;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[14] =
      EX3_CircularTrajectoryNew_DW.RED_IMU_Ay_b;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[15] =
      EX3_CircularTrajectoryNew_DW.RED_IMU_Az_b;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[16] =
      EX3_CircularTrajectoryNew_DW.RED_IMU_Ax_I;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[17] =
      EX3_CircularTrajectoryNew_DW.RED_IMU_Ay_I;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[18] =
      EX3_CircularTrajectoryNew_DW.RED_Ax;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[19] =
      EX3_CircularTrajectoryNew_DW.RED_Ay;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[20] =
      EX3_CircularTrajectoryNew_DW.RED_RzDD;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[21] =
      EX3_CircularTrajectoryNew_DW.BLACK_Fx_Sat;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[22] =
      EX3_CircularTrajectoryNew_DW.BLACK_Fy_Sat;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[23] =
      EX3_CircularTrajectoryNew_DW.BLACK_Tz_Sat;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[24] =
      EX3_CircularTrajectoryNew_DW.BLACK_Px;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[25] =
      EX3_CircularTrajectoryNew_DW.BLACK_Py;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[26] =
      EX3_CircularTrajectoryNew_DW.BLACK_Rz;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[27] =
      EX3_CircularTrajectoryNew_DW.BLACK_Vx;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[28] =
      EX3_CircularTrajectoryNew_DW.BLACK_Vy;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[29] =
      EX3_CircularTrajectoryNew_DW.BLACK_RzD;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[30] =
      EX3_CircularTrajectoryNew_DW.BLACK_AHRS_Q;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[31] =
      EX3_CircularTrajectoryNew_DW.BLACK_AHRS_P;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[32] =
      EX3_CircularTrajectoryNew_DW.BLACK_AHRS_R;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[33] =
      EX3_CircularTrajectoryNew_DW.BLACK_IMU_Ax_b;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[34] =
      EX3_CircularTrajectoryNew_DW.BLACK_IMU_Ay_b;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[35] =
      EX3_CircularTrajectoryNew_DW.BLACK_IMU_Az_b;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[36] =
      EX3_CircularTrajectoryNew_DW.BLACK_IMU_Ax_I;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[37] =
      EX3_CircularTrajectoryNew_DW.BLACK_IMU_Ay_I;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[38] =
      EX3_CircularTrajectoryNew_DW.BLACK_Ax;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[39] =
      EX3_CircularTrajectoryNew_DW.BLACK_Ay;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[40] =
      EX3_CircularTrajectoryNew_DW.BLACK_RzDD;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[41] =
      EX3_CircularTrajectoryNew_DW.BLUE_Fx_Sat;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[42] =
      EX3_CircularTrajectoryNew_DW.BLUE_Fy_Sat;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[43] =
      EX3_CircularTrajectoryNew_DW.BLUE_Tz_Sat;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[44] =
      EX3_CircularTrajectoryNew_DW.BLUE_Px;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[45] =
      EX3_CircularTrajectoryNew_DW.BLUE_Py;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[46] =
      EX3_CircularTrajectoryNew_DW.BLUE_Rz;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[47] =
      EX3_CircularTrajectoryNew_DW.BLUE_Vx;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[48] =
      EX3_CircularTrajectoryNew_DW.BLUE_Vy;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[49] =
      EX3_CircularTrajectoryNew_DW.BLUE_RzD;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[50] =
      EX3_CircularTrajectoryNew_DW.RED_IMU_Q;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[51] =
      EX3_CircularTrajectoryNew_DW.RED_IMU_P;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[52] =
      EX3_CircularTrajectoryNew_DW.RED_IMU_R;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[53] =
      EX3_CircularTrajectoryNew_DW.BLACK_IMU_Q;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[54] =
      EX3_CircularTrajectoryNew_DW.BLACK_IMU_P;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[55] =
      EX3_CircularTrajectoryNew_DW.BLACK_IMU_R;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[56] =
      EX3_CircularTrajectoryNew_DW.RED_IMU_Psi;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[57] =
      EX3_CircularTrajectoryNew_DW.BLACK_IMU_Psi;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[58] =
      EX3_CircularTrajectoryNew_DW.ARM_Elbow_Px;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[59] =
      EX3_CircularTrajectoryNew_DW.ARM_Elbow_Py;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[60] =
      EX3_CircularTrajectoryNew_DW.ARM_Wrist_Px;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[61] =
      EX3_CircularTrajectoryNew_DW.ARM_Wrist_Py;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[62] =
      EX3_CircularTrajectoryNew_DW.ARM_EndEff_Px;
    EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[63] =
      EX3_CircularTrajectoryNew_DW.ARM_EndEff_Py;

    // ToWorkspace: '<S1>/To Workspace'
    rt_UpdateLogVar((LogVar *)(LogVar*)
                    (EX3_CircularTrajectoryNew_DW.ToWorkspace_PWORK.LoggedData),
                    &EX3_CircularTrajectoryNew_B.TmpSignalConversionAtToWork[0],
                    0);
    ...
    if (EX3_CircularTrajectoryNew_P.simMode == 0.0) {
      ...
      EX3_CircularTrajectoryNew_B.Sum6_l1 = rt_roundd_snf
        (EX3_CircularTrajectoryNew_DW.Magnet_State);
      if (EX3_CircularTrajectoryNew_B.Sum6_l1 < 256.0) {
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 >= 0.0) {
          EX3_CircularTrajectoryNew_B.status = static_cast<uint8_T>
            (EX3_CircularTrajectoryNew_B.Sum6_l1);
        } else {
          EX3_CircularTrajectoryNew_B.status = 0U;
        }
      } else {
        EX3_CircularTrajectoryNew_B.status = MAX_uint8_T;
      }

      MW_gpioWrite(10U, EX3_CircularTrajectoryNew_B.status);
      ...
      MW_gpioWrite(26U, EX3_CircularTrajectoryNew_B.status);
    ...
    if ((EX3_CircularTrajectoryNew_P.WhoAmI == 2.0) ||
      ...
      EX3_Ci_CreateRotationMatrix(EX3_CircularTrajectoryNew_DW.BLACK_Rz,
        &EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix);
      ...
      memset(&EX3_CircularTrajectoryNew_B.Mat2[0], 0, sizeof(real_T) << 6U);
      ...
      for (EX3_CircularTrajectoryNew_B.uElOffset1 = 0;
           EX3_CircularTrajectoryNew_B.uElOffset1 < 8;
           EX3_CircularTrajectoryNew_B.uElOffset1++) {
        EX3_CircularTrajectoryNew_B.Mat2[EX3_CircularTrajectoryNew_B.uElOffset1
          + (EX3_CircularTrajectoryNew_B.uElOffset1 << 3)] =
          EX3_CircularTrajectoryNew_P.F_thrusters_BLACK[EX3_CircularTrajectoryNew_B.uElOffset1];

        // MATLAB Function: '<S27>/MATLAB Function'
        EX3_CircularTrajectoryNew_B.rtb_RemoveNegatives_i_p[EX3_CircularTrajectoryNew_B.uElOffset1]
          =
          EX3_CircularTrajectoryNew_P.F_thrusters_BLACK[EX3_CircularTrajectoryNew_B.uElOffset1]
          / 2.0;
      }
      ...
      // MATLAB Function: '<S27>/MATLAB Function'
      memset(&EX3_CircularTrajectoryNew_B.Mat2_m[0], 0, sizeof(real_T) << 6U);

      // '<S29>:1:27' H    = Mat1*Mat2;
      for (EX3_CircularTrajectoryNew_B.uElOffset1 = 0;
           EX3_CircularTrajectoryNew_B.uElOffset1 < 8;
           EX3_CircularTrajectoryNew_B.uElOffset1++) {
        EX3_CircularTrajectoryNew_B.Mat2_m[EX3_CircularTrajectoryNew_B.uElOffset1
          + (EX3_CircularTrajectoryNew_B.uElOffset1 << 3)] =
          EX3_CircularTrajectoryNew_B.rtb_RemoveNegatives_i_p[EX3_CircularTrajectoryNew_B.uElOffset1];
        EX3_CircularTrajectoryNew_B.b[3 * EX3_CircularTrajectoryNew_B.uElOffset1]
          = b[EX3_CircularTrajectoryNew_B.uElOffset1];
        EX3_CircularTrajectoryNew_B.b[3 * EX3_CircularTrajectoryNew_B.uElOffset1
          + 1] = c[EX3_CircularTrajectoryNew_B.uElOffset1];
        EX3_CircularTrajectoryNew_B.b[3 * EX3_CircularTrajectoryNew_B.uElOffset1
          + 2] =
          EX3_CircularTrajectoryNew_P.thruster_dist2CG_BLACK[EX3_CircularTrajectoryNew_B.uElOffset1]
          / 1000.0;
      }
      ...
      for (EX3_CircularTrajectoryNew_B.uElOffset1 = 0;
           EX3_CircularTrajectoryNew_B.uElOffset1 < 8;
           EX3_CircularTrajectoryNew_B.uElOffset1++) {
        for (EX3_CircularTrajectoryNew_B.ntIdx1 = 0;
             EX3_CircularTrajectoryNew_B.ntIdx1 < 3;
             EX3_CircularTrajectoryNew_B.ntIdx1++) {
          EX3_CircularTrajectoryNew_B.yElIdx =
            EX3_CircularTrajectoryNew_B.ntIdx1 + 3 *
            EX3_CircularTrajectoryNew_B.uElOffset1;
          EX3_CircularTrajectoryNew_B.H_bu[EX3_CircularTrajectoryNew_B.yElIdx] =
            0.0;
          for (EX3_CircularTrajectoryNew_B.ntIdx0 = 0;
               EX3_CircularTrajectoryNew_B.ntIdx0 < 8;
               EX3_CircularTrajectoryNew_B.ntIdx0++) {
            EX3_CircularTrajectoryNew_B.H_bu[EX3_CircularTrajectoryNew_B.yElIdx]
              += EX3_CircularTrajectoryNew_B.b[3 *
              EX3_CircularTrajectoryNew_B.ntIdx0 +
              EX3_CircularTrajectoryNew_B.ntIdx1] *
              EX3_CircularTrajectoryNew_B.Mat2_m
              [(EX3_CircularTrajectoryNew_B.uElOffset1 << 3) +
              EX3_CircularTrajectoryNew_B.ntIdx0];
          }
        }
      ...
      EX3_CircularTrajectoryNew_B.yElIdx = 0;
      EX3_CircularTrajectoryNew_B.uElOffset1 = 0;
      for (EX3_CircularTrajectoryNew_B.ntIdx1 = 0;
           EX3_CircularTrajectoryNew_B.ntIdx1 < 3;
           EX3_CircularTrajectoryNew_B.ntIdx1++) {
        EX3_CircularTrajectoryNew_B.uElOffset0 =
          EX3_CircularTrajectoryNew_B.uElOffset1;
        for (EX3_CircularTrajectoryNew_B.ntIdx0 = 0;
             EX3_CircularTrajectoryNew_B.ntIdx0 < 8;
             EX3_CircularTrajectoryNew_B.ntIdx0++) {
          EX3_CircularTrajectoryNew_B.transpose_d[EX3_CircularTrajectoryNew_B.yElIdx]
            =
            EX3_CircularTrajectoryNew_B.H_bu[EX3_CircularTrajectoryNew_B.uElOffset0];
          EX3_CircularTrajectoryNew_B.yElIdx++;
          EX3_CircularTrajectoryNew_B.uElOffset0 += 3;
        }
      ...
      EX3__CreateRotationMatrix_h(EX3_CircularTrajectoryNew_DW.BLACK_Rz,
        &EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_h);
      ...
      for (EX3_CircularTrajectoryNew_B.uElOffset1 = 0;
        ...
        for (EX3_CircularTrajectoryNew_B.ntIdx1 = 0;
          ...
          EX3_CircularTrajectoryNew_B.yElIdx =
            EX3_CircularTrajectoryNew_B.ntIdx1 + 3 *
            EX3_CircularTrajectoryNew_B.uElOffset1;
          EX3_CircularTrajectoryNew_B.rtb_H_bu_k[EX3_CircularTrajectoryNew_B.yElIdx]
            = 0.0;
          for (EX3_CircularTrajectoryNew_B.ntIdx0 = 0;
               EX3_CircularTrajectoryNew_B.ntIdx0 < 8;
               EX3_CircularTrajectoryNew_B.ntIdx0++) {
            EX3_CircularTrajectoryNew_B.rtb_H_bu_k[EX3_CircularTrajectoryNew_B.yElIdx]
              += EX3_CircularTrajectoryNew_B.H_bu[3 *
              EX3_CircularTrajectoryNew_B.ntIdx0 +
              EX3_CircularTrajectoryNew_B.ntIdx1] *
              EX3_CircularTrajectoryNew_B.transpose_d
              [(EX3_CircularTrajectoryNew_B.uElOffset1 << 3) +
              EX3_CircularTrajectoryNew_B.ntIdx0];
          }
        }
      ...
      EX3_CircularTraj_rt_invd3x3_snf(EX3_CircularTrajectoryNew_B.rtb_H_bu_k,
        EX3_CircularTrajectoryNew_B.b_c);
      EX3_CircularTrajectoryNew_B.Sum6_l1 =
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_h.C_bI[0] *
        EX3_CircularTrajectoryNew_DW.BLACK_Fx +
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_h.C_bI[2] *
        EX3_CircularTrajectoryNew_DW.BLACK_Fy;
      ...
      EX3_CircularTrajectoryNew_B.Sum6_dk =
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_h.C_bI[1] *
        EX3_CircularTrajectoryNew_DW.BLACK_Fx +
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_h.C_bI[3] *
        EX3_CircularTrajectoryNew_DW.BLACK_Fy;
      ...
      for (EX3_CircularTrajectoryNew_B.uElOffset1 = 0;
           ...
           EX3_CircularTrajectoryNew_B.uElOffset1++) {
        for (EX3_CircularTrajectoryNew_B.ntIdx1 = 0;
             EX3_CircularTrajectoryNew_B.ntIdx1 < 8;
             EX3_CircularTrajectoryNew_B.ntIdx1++) {
          EX3_CircularTrajectoryNew_B.ntIdx0 =
            EX3_CircularTrajectoryNew_B.ntIdx1 +
            (EX3_CircularTrajectoryNew_B.uElOffset1 << 3);
          EX3_CircularTrajectoryNew_B.b[EX3_CircularTrajectoryNew_B.ntIdx0] =
            0.0;
          EX3_CircularTrajectoryNew_B.b[EX3_CircularTrajectoryNew_B.ntIdx0] +=
            EX3_CircularTrajectoryNew_B.b_c[3 *
            EX3_CircularTrajectoryNew_B.uElOffset1] *
            EX3_CircularTrajectoryNew_B.transpose_d[EX3_CircularTrajectoryNew_B.ntIdx1];
          EX3_CircularTrajectoryNew_B.b[EX3_CircularTrajectoryNew_B.ntIdx0] +=
            EX3_CircularTrajectoryNew_B.b_c[3 *
            EX3_CircularTrajectoryNew_B.uElOffset1 + 1] *
            EX3_CircularTrajectoryNew_B.transpose_d[EX3_CircularTrajectoryNew_B.ntIdx1
            + 8];
          EX3_CircularTrajectoryNew_B.b[EX3_CircularTrajectoryNew_B.ntIdx0] +=
            EX3_CircularTrajectoryNew_B.b_c[3 *
            EX3_CircularTrajectoryNew_B.uElOffset1 + 2] *
            EX3_CircularTrajectoryNew_B.transpose_d[EX3_CircularTrajectoryNew_B.ntIdx1
            + 16];
        }
      }
      ...
      for (EX3_CircularTrajectoryNew_B.uElOffset1 = 0;
           ...
           EX3_CircularTrajectoryNew_B.uElOffset1++) {
        EX3_CircularTrajectoryNew_B.RED_Tz_Wrist =
          EX3_CircularTrajectoryNew_B.b[EX3_CircularTrajectoryNew_B.uElOffset1 +
          16] * EX3_CircularTrajectoryNew_DW.BLACK_Tz +
          (EX3_CircularTrajectoryNew_B.b[EX3_CircularTrajectoryNew_B.uElOffset1
           + 8] * EX3_CircularTrajectoryNew_B.Sum6_dk +
           EX3_CircularTrajectoryNew_B.b[EX3_CircularTrajectoryNew_B.uElOffset1]
           * EX3_CircularTrajectoryNew_B.Sum6_l1);
        ...
        if (EX3_CircularTrajectoryNew_B.RED_Tz_Wrist >
            EX3_CircularTrajectoryNew_P.RemoveNegatives_UpperSat) {
          EX3_CircularTrajectoryNew_B.rtb_RemoveNegatives_i_p[EX3_CircularTrajectoryNew_B.uElOffset1]
            = EX3_CircularTrajectoryNew_P.RemoveNegatives_UpperSat;
        } else if (EX3_CircularTrajectoryNew_B.RED_Tz_Wrist <
                   EX3_CircularTrajectoryNew_P.RemoveNegatives_LowerSat) {
          EX3_CircularTrajectoryNew_B.rtb_RemoveNegatives_i_p[EX3_CircularTrajectoryNew_B.uElOffset1]
            = EX3_CircularTrajectoryNew_P.RemoveNegatives_LowerSat;
        } else {
          EX3_CircularTrajectoryNew_B.rtb_RemoveNegatives_i_p[EX3_CircularTrajectoryNew_B.uElOffset1]
      ...
      EX3_Circula_MATLABFunction2
        (EX3_CircularTrajectoryNew_B.rtb_RemoveNegatives_i_p,
         &EX3_CircularTrajectoryNew_B.sf_MATLABFunction2);
        ...
        for (EX3_CircularTrajectoryNew_B.ntIdx1 = 0;
          ...
          for (EX3_CircularTrajectoryNew_B.ntIdx0 = 0;
            ...
            EX3_CircularTrajectoryNew_B.transpose_d[EX3_CircularTrajectoryNew_B.yElIdx]
              ...
              EX3_CircularTrajectoryNew_B.ntIdx0 +
              EX3_CircularTrajectoryNew_B.ntIdx1] *
              EX3_CircularTrajectoryNew_B.Mat2
              [(EX3_CircularTrajectoryNew_B.uElOffset1 << 3) +
              EX3_CircularTrajectoryNew_B.ntIdx0];
          }
        }
      ...
      for (EX3_CircularTrajectoryNew_B.uElOffset1 = 0;
           EX3_CircularTrajectoryNew_B.uElOffset1 < 3;
           EX3_CircularTrajectoryNew_B.uElOffset1++) {
        EX3_CircularTrajectoryNew_B.x_ddot_a[EX3_CircularTrajectoryNew_B.uElOffset1]
          = 0.0;
        for (EX3_CircularTrajectoryNew_B.ntIdx1 = 0;
             EX3_CircularTrajectoryNew_B.ntIdx1 < 8;
             EX3_CircularTrajectoryNew_B.ntIdx1++) {
          EX3_CircularTrajectoryNew_B.x_ddot_a[EX3_CircularTrajectoryNew_B.uElOffset1]
            += EX3_CircularTrajectoryNew_B.transpose_d[3 *
            EX3_CircularTrajectoryNew_B.ntIdx1 +
            EX3_CircularTrajectoryNew_B.uElOffset1] *
            EX3_CircularTrajectoryNew_B.sf_MATLABFunction2.ThrustPer_Final[EX3_CircularTrajectoryNew_B.ntIdx1];
        }
      }
      ...
      EX3_CircularTrajectoryNew_DW.BLACK_Fx_Sat =
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix.C_Ib[0] *
        EX3_CircularTrajectoryNew_B.x_ddot_a[0] +
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix.C_Ib[2] *
        EX3_CircularTrajectoryNew_B.x_ddot_a[1];
      ...
      EX3_CircularTrajectoryNew_DW.BLACK_Fy_Sat =
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix.C_Ib[1] *
        EX3_CircularTrajectoryNew_B.x_ddot_a[0] +
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix.C_Ib[3] *
        EX3_CircularTrajectoryNew_B.x_ddot_a[1];

      // DataStoreWrite: '<S27>/BLACK_Tz_Sat'
      EX3_CircularTrajectoryNew_DW.BLACK_Tz_Sat =
        EX3_CircularTrajectoryNew_B.x_ddot_a[2];
    ...
    if ((EX3_CircularTrajectoryNew_P.WhoAmI == 3.0) ||
      ...
      EX3_Ci_CreateRotationMatrix(EX3_CircularTrajectoryNew_DW.BLUE_Rz,
        &EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_i);

      // MATLAB Function: '<S36>/MATLAB Function1'
      EX3_Circular_MATLABFunction
        (&EX3_CircularTrajectoryNew_B.sf_MATLABFunction1_b);

      // MATLAB Function: '<S36>/MATLAB Function'
      EX3_Circular_MATLABFunction
        (&EX3_CircularTrajectoryNew_B.sf_MATLABFunction_i);
      ...
      for (EX3_CircularTrajectoryNew_B.ntIdx1 = 0;
        ...
        for (EX3_CircularTrajectoryNew_B.ntIdx0 = 0;
             EX3_CircularTrajectoryNew_B.ntIdx0 < 8;
             EX3_CircularTrajectoryNew_B.ntIdx0++) {
          EX3_CircularTrajectoryNew_B.transpose_p[EX3_CircularTrajectoryNew_B.yElIdx]
            =
            EX3_CircularTrajectoryNew_B.sf_MATLABFunction_i.H[EX3_CircularTrajectoryNew_B.uElOffset0];
          EX3_CircularTrajectoryNew_B.yElIdx++;
          EX3_CircularTrajectoryNew_B.uElOffset0 += 3;
        }
      ...
      EX3__CreateRotationMatrix_h(EX3_CircularTrajectoryNew_DW.BLUE_Rz,
        &EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_f);
      ...
      for (EX3_CircularTrajectoryNew_B.uElOffset1 = 0;
        ...
        for (EX3_CircularTrajectoryNew_B.ntIdx1 = 0;
          ...
          EX3_CircularTrajectoryNew_B.ntIdx0 =
            EX3_CircularTrajectoryNew_B.ntIdx1 + 3 *
            EX3_CircularTrajectoryNew_B.uElOffset1;
          EX3_CircularTrajectoryNew_B.b_c[EX3_CircularTrajectoryNew_B.ntIdx0] =
            0.0;
          for (EX3_CircularTrajectoryNew_B.yElIdx = 0;
               EX3_CircularTrajectoryNew_B.yElIdx < 8;
               EX3_CircularTrajectoryNew_B.yElIdx++) {
            EX3_CircularTrajectoryNew_B.b_c[EX3_CircularTrajectoryNew_B.ntIdx0] +=
              EX3_CircularTrajectoryNew_B.sf_MATLABFunction_i.H[3 *
              EX3_CircularTrajectoryNew_B.yElIdx +
              EX3_CircularTrajectoryNew_B.ntIdx1] *
              EX3_CircularTrajectoryNew_B.transpose_p
              [(EX3_CircularTrajectoryNew_B.uElOffset1 << 3) +
              EX3_CircularTrajectoryNew_B.yElIdx];
          }
        }
      ...
      EX3_CircularTraj_rt_invd3x3_snf(EX3_CircularTrajectoryNew_B.b_c,
        EX3_CircularTrajectoryNew_B.rtb_H_bu_k);
      EX3_CircularTrajectoryNew_B.Sum6_l1 =
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_f.C_bI[0] *
        EX3_CircularTrajectoryNew_DW.BLUE_Fx +
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_f.C_bI[2] *
        EX3_CircularTrajectoryNew_DW.BLUE_Fy;
      ...
      EX3_CircularTrajectoryNew_B.Sum6_dk =
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_f.C_bI[1] *
        EX3_CircularTrajectoryNew_DW.BLUE_Fx +
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_f.C_bI[3] *
        EX3_CircularTrajectoryNew_DW.BLUE_Fy;
      ...
      for (EX3_CircularTrajectoryNew_B.uElOffset1 = 0;
        ...
        for (EX3_CircularTrajectoryNew_B.ntIdx1 = 0;
          ...
          EX3_CircularTrajectoryNew_B.b[EX3_CircularTrajectoryNew_B.ntIdx0] =
            0.0;
          EX3_CircularTrajectoryNew_B.b[EX3_CircularTrajectoryNew_B.ntIdx0] +=
            EX3_CircularTrajectoryNew_B.rtb_H_bu_k[3 *
            EX3_CircularTrajectoryNew_B.uElOffset1] *
            EX3_CircularTrajectoryNew_B.transpose_p[EX3_CircularTrajectoryNew_B.ntIdx1];
          EX3_CircularTrajectoryNew_B.b[EX3_CircularTrajectoryNew_B.ntIdx0] +=
            EX3_CircularTrajectoryNew_B.rtb_H_bu_k[3 *
            EX3_CircularTrajectoryNew_B.uElOffset1 + 1] *
            EX3_CircularTrajectoryNew_B.transpose_p[EX3_CircularTrajectoryNew_B.ntIdx1
      ...
      for (EX3_CircularTrajectoryNew_B.uElOffset1 = 0;
        ...
        EX3_CircularTrajectoryNew_B.RED_Tz_Wrist =
          EX3_CircularTrajectoryNew_B.b[EX3_CircularTrajectoryNew_B.uElOffset1 +
          16] * EX3_CircularTrajectoryNew_DW.BLUE_Tz +
          (EX3_CircularTrajectoryNew_B.b[EX3_CircularTrajectoryNew_B.uElOffset1
           + 8] * EX3_CircularTrajectoryNew_B.Sum6_dk +
           EX3_CircularTrajectoryNew_B.b[EX3_CircularTrajectoryNew_B.uElOffset1]
           * EX3_CircularTrajectoryNew_B.Sum6_l1);
        ...
        if (EX3_CircularTrajectoryNew_B.RED_Tz_Wrist >
            EX3_CircularTrajectoryNew_P.RemoveNegatives_UpperSat_p) {
          EX3_CircularTrajectoryNew_B.rtb_RemoveNegatives_i_p[EX3_CircularTrajectoryNew_B.uElOffset1]
            = EX3_CircularTrajectoryNew_P.RemoveNegatives_UpperSat_p;
        } else if (EX3_CircularTrajectoryNew_B.RED_Tz_Wrist <
                   EX3_CircularTrajectoryNew_P.RemoveNegatives_LowerSat_c) {
          EX3_CircularTrajectoryNew_B.rtb_RemoveNegatives_i_p[EX3_CircularTrajectoryNew_B.uElOffset1]
            = EX3_CircularTrajectoryNew_P.RemoveNegatives_LowerSat_c;
        } else {
          EX3_CircularTrajectoryNew_B.rtb_RemoveNegatives_i_p[EX3_CircularTrajectoryNew_B.uElOffset1]
      ...
      EX3_Circula_MATLABFunction2
        (EX3_CircularTrajectoryNew_B.rtb_RemoveNegatives_i_p,
         &EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_n);
      ...
      for (EX3_CircularTrajectoryNew_B.uElOffset1 = 0;
        ...
        for (EX3_CircularTrajectoryNew_B.ntIdx1 = 0;
             ...
             EX3_CircularTrajectoryNew_B.ntIdx1++) {
          EX3_CircularTrajectoryNew_B.x_ddot_a[EX3_CircularTrajectoryNew_B.uElOffset1]
            += EX3_CircularTrajectoryNew_B.sf_MATLABFunction1_b.H[3 *
            EX3_CircularTrajectoryNew_B.ntIdx1 +
            EX3_CircularTrajectoryNew_B.uElOffset1] *
            EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_n.ThrustPer_Final[EX3_CircularTrajectoryNew_B.ntIdx1];
        }
      }
      ...
      EX3_CircularTrajectoryNew_DW.BLUE_Fx_Sat =
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_i.C_Ib[0] *
        EX3_CircularTrajectoryNew_B.x_ddot_a[0] +
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_i.C_Ib[2] *
        EX3_CircularTrajectoryNew_B.x_ddot_a[1];
      ...
      EX3_CircularTrajectoryNew_DW.BLUE_Fy_Sat =
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_i.C_Ib[1] *
        EX3_CircularTrajectoryNew_B.x_ddot_a[0] +
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_i.C_Ib[3] *
        EX3_CircularTrajectoryNew_B.x_ddot_a[1];
    ...
    if ((EX3_CircularTrajectoryNew_P.WhoAmI == 1.0) ||
      ...
      EX3_Ci_CreateRotationMatrix(EX3_CircularTrajectoryNew_DW.RED_Rz,
        &EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_l);
      ...
      for (EX3_CircularTrajectoryNew_B.uElOffset1 = 0;
        ...
        EX3_CircularTrajectoryNew_B.Mat2[EX3_CircularTrajectoryNew_B.uElOffset1
          + (EX3_CircularTrajectoryNew_B.uElOffset1 << 3)] =
          EX3_CircularTrajectoryNew_P.F_thrusters_RED[EX3_CircularTrajectoryNew_B.uElOffset1];
      ...
      for (EX3_CircularTrajectoryNew_B.uElOffset1 = 0;
        ...
        EX3_CircularTrajectoryNew_B.b[3 * EX3_CircularTrajectoryNew_B.uElOffset1
          + 2] =
          EX3_CircularTrajectoryNew_P.thruster_dist2CG_RED[EX3_CircularTrajectoryNew_B.uElOffset1]
          / 1000.0;
      }
      ...
      for (EX3_CircularTrajectoryNew_B.ntIdx1 = 0;
        ...
        for (EX3_CircularTrajectoryNew_B.ntIdx0 = 0;
             EX3_CircularTrajectoryNew_B.ntIdx0 < 8;
             EX3_CircularTrajectoryNew_B.ntIdx0++) {
          EX3_CircularTrajectoryNew_B.transpose[EX3_CircularTrajectoryNew_B.yElIdx]
            =
            EX3_CircularTrajectoryNew_B.H_bu[EX3_CircularTrajectoryNew_B.uElOffset0];
          EX3_CircularTrajectoryNew_B.yElIdx++;
          EX3_CircularTrajectoryNew_B.uElOffset0 += 3;
      ...
      EX3__CreateRotationMatrix_h(EX3_CircularTrajectoryNew_DW.RED_Rz,
        &EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_n);
        ...
        for (EX3_CircularTrajectoryNew_B.ntIdx1 = 0;
          ...
          for (EX3_CircularTrajectoryNew_B.ntIdx0 = 0;
            ...
            EX3_CircularTrajectoryNew_B.rtb_H_bu_k[EX3_CircularTrajectoryNew_B.yElIdx]
              ...
              EX3_CircularTrajectoryNew_B.ntIdx0 +
              EX3_CircularTrajectoryNew_B.ntIdx1] *
              EX3_CircularTrajectoryNew_B.transpose
              [(EX3_CircularTrajectoryNew_B.uElOffset1 << 3) +
              EX3_CircularTrajectoryNew_B.ntIdx0];
          }
        }
      ...
      EX3_CircularTraj_rt_invd3x3_snf(EX3_CircularTrajectoryNew_B.rtb_H_bu_k,
        EX3_CircularTrajectoryNew_B.b_c);
      EX3_CircularTrajectoryNew_B.Sum6_l1 =
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_n.C_bI[0] *
        EX3_CircularTrajectoryNew_DW.RED_Fx +
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_n.C_bI[2] *
        EX3_CircularTrajectoryNew_DW.RED_Fy;
      ...
      EX3_CircularTrajectoryNew_B.Sum6_dk =
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_n.C_bI[1] *
        EX3_CircularTrajectoryNew_DW.RED_Fx +
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_n.C_bI[3] *
        EX3_CircularTrajectoryNew_DW.RED_Fy;
      ...
      for (EX3_CircularTrajectoryNew_B.uElOffset1 = 0;
        ...
        for (EX3_CircularTrajectoryNew_B.ntIdx1 = 0;
          ...
          EX3_CircularTrajectoryNew_B.ntIdx0 =
            EX3_CircularTrajectoryNew_B.ntIdx1 +
            (EX3_CircularTrajectoryNew_B.uElOffset1 << 3);
          EX3_CircularTrajectoryNew_B.transpose_p[EX3_CircularTrajectoryNew_B.ntIdx0]
            = 0.0;
          EX3_CircularTrajectoryNew_B.transpose_p[EX3_CircularTrajectoryNew_B.ntIdx0]
            += EX3_CircularTrajectoryNew_B.b_c[3 *
            EX3_CircularTrajectoryNew_B.uElOffset1] *
            EX3_CircularTrajectoryNew_B.transpose[EX3_CircularTrajectoryNew_B.ntIdx1];
          EX3_CircularTrajectoryNew_B.transpose_p[EX3_CircularTrajectoryNew_B.ntIdx0]
            += EX3_CircularTrajectoryNew_B.b_c[3 *
            EX3_CircularTrajectoryNew_B.uElOffset1 + 1] *
            EX3_CircularTrajectoryNew_B.transpose[EX3_CircularTrajectoryNew_B.ntIdx1
      ...
      for (EX3_CircularTrajectoryNew_B.uElOffset1 = 0;
           ...
           EX3_CircularTrajectoryNew_B.uElOffset1++) {
        EX3_CircularTrajectoryNew_B.RED_Tz_Wrist =
          EX3_CircularTrajectoryNew_B.transpose_p[EX3_CircularTrajectoryNew_B.uElOffset1
          + 16] * EX3_CircularTrajectoryNew_DW.RED_Tz +
          (EX3_CircularTrajectoryNew_B.transpose_p[EX3_CircularTrajectoryNew_B.uElOffset1
           + 8] * EX3_CircularTrajectoryNew_B.Sum6_dk +
           EX3_CircularTrajectoryNew_B.transpose_p[EX3_CircularTrajectoryNew_B.uElOffset1]
           * EX3_CircularTrajectoryNew_B.Sum6_l1);
        ...
        if (EX3_CircularTrajectoryNew_B.RED_Tz_Wrist >
            EX3_CircularTrajectoryNew_P.RemoveNegatives_UpperSat_d) {
          EX3_CircularTrajectoryNew_B.rtb_RemoveNegatives_i_p[EX3_CircularTrajectoryNew_B.uElOffset1]
            = EX3_CircularTrajectoryNew_P.RemoveNegatives_UpperSat_d;
        } else if (EX3_CircularTrajectoryNew_B.RED_Tz_Wrist <
                   EX3_CircularTrajectoryNew_P.RemoveNegatives_LowerSat_a) {
          EX3_CircularTrajectoryNew_B.rtb_RemoveNegatives_i_p[EX3_CircularTrajectoryNew_B.uElOffset1]
            = EX3_CircularTrajectoryNew_P.RemoveNegatives_LowerSat_a;
        } else {
          EX3_CircularTrajectoryNew_B.rtb_RemoveNegatives_i_p[EX3_CircularTrajectoryNew_B.uElOffset1]
      ...
      EX3_Circula_MATLABFunction2
        (EX3_CircularTrajectoryNew_B.rtb_RemoveNegatives_i_p,
         &EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_l);
      ...
      for (EX3_CircularTrajectoryNew_B.uElOffset1 = 0;
        ...
        for (EX3_CircularTrajectoryNew_B.ntIdx1 = 0;
          ...
          EX3_CircularTrajectoryNew_B.x_ddot_a[EX3_CircularTrajectoryNew_B.uElOffset1]
            ...
            EX3_CircularTrajectoryNew_B.ntIdx1 +
            EX3_CircularTrajectoryNew_B.uElOffset1] *
            EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_l.ThrustPer_Final[EX3_CircularTrajectoryNew_B.ntIdx1];
        }
      }
      ...
      EX3_CircularTrajectoryNew_DW.RED_Fx_Sat =
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_l.C_Ib[0] *
        EX3_CircularTrajectoryNew_B.x_ddot_a[0] +
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_l.C_Ib[2] *
        EX3_CircularTrajectoryNew_B.x_ddot_a[1];
      ...
      EX3_CircularTrajectoryNew_DW.RED_Fy_Sat =
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_l.C_Ib[1] *
        EX3_CircularTrajectoryNew_B.x_ddot_a[0] +
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_l.C_Ib[3] *
        EX3_CircularTrajectoryNew_B.x_ddot_a[1];
    ...
    if (EX3_CircularTrajectoryNew_M->Timing.RateInteraction.TID1_2) {
      EX3_CircularTrajectoryNew_DW.RateTransition_Buffer =
        (EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_l.ThrustPer_Final[0] +
         EX3_CircularTrajectoryNew_B.sf_MATLABFunction2.ThrustPer_Final[7]) +
        EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_n.ThrustPer_Final[7];
      EX3_CircularTrajectoryNew_DW.RateTransition1_Buffer =
        (EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_l.ThrustPer_Final[1] +
         EX3_CircularTrajectoryNew_B.sf_MATLABFunction2.ThrustPer_Final[2]) +
        EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_n.ThrustPer_Final[2];

      // RateTransition: '<S3>/Rate Transition2' incorporates:
      //   Sum: '<S3>/Sum'
      //   Sum: '<S3>/Sum1'

      EX3_CircularTrajectoryNew_DW.RateTransition2_Buffer =
        EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_l.ThrustPer_Final[2];
      EX3_CircularTrajectoryNew_DW.RateTransition3_Buffer =
        (EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_l.ThrustPer_Final[3] +
         EX3_CircularTrajectoryNew_B.sf_MATLABFunction2.ThrustPer_Final[4]) +
        EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_n.ThrustPer_Final[4];
      EX3_CircularTrajectoryNew_DW.RateTransition4_Buffer =
        (EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_l.ThrustPer_Final[4] +
         EX3_CircularTrajectoryNew_B.sf_MATLABFunction2.ThrustPer_Final[3]) +
        EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_n.ThrustPer_Final[3];
      EX3_CircularTrajectoryNew_DW.RateTransition5_Buffer =
        (EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_l.ThrustPer_Final[5] +
         EX3_CircularTrajectoryNew_B.sf_MATLABFunction2.ThrustPer_Final[6]) +
        EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_n.ThrustPer_Final[6];
      EX3_CircularTrajectoryNew_DW.RateTransition6_Buffer =
        (EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_l.ThrustPer_Final[6] +
         EX3_CircularTrajectoryNew_B.sf_MATLABFunction2.ThrustPer_Final[5]) +
        EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_n.ThrustPer_Final[5];
      EX3_CircularTrajectoryNew_DW.RateTransition7_Buffer =
        (EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_l.ThrustPer_Final[7] +
         EX3_CircularTrajectoryNew_B.sf_MATLABFunction2.ThrustPer_Final[0]) +
        EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_n.ThrustPer_Final[0];
      EX3_CircularTrajectoryNew_DW.RateTransition8_Buffer =
        EX3_CircularTrajectoryNew_B.sf_MATLABFunction2.ThrustPer_Final[1] +
        EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_n.ThrustPer_Final[1];
    }
    ...
    EX3_CircularTrajectoryNew_B.rtPrevAction =
      EX3_CircularTrajectoryNew_DW.Ifperforminganexperimentgrabthe;
    EX3_CircularTrajectoryNew_B.rtAction = -1;
    if (EX3_CircularTrajectoryNew_P.simMode == 0.0) {
      EX3_CircularTrajectoryNew_B.rtAction = 0;
    } else {
      if (EX3_CircularTrajectoryNew_P.simMode == 1.0) {
        EX3_CircularTrajectoryNew_B.rtAction = 1;
      }
    ...
    EX3_CircularTrajectoryNew_DW.Ifperforminganexperimentgrabthe =
      EX3_CircularTrajectoryNew_B.rtAction;
    if ((EX3_CircularTrajectoryNew_B.rtPrevAction !=
         EX3_CircularTrajectoryNew_B.rtAction) &&
        (EX3_CircularTrajectoryNew_B.rtPrevAction == 0)) {
      // Disable for If: '<S75>/Check whether both platforms are being used, and if so then use RED to send data to BLACK ' 
      switch (EX3_CircularTrajectoryNew_DW.Checkwhetherbothplatformsarebei) {
       case 0:
        // Disable for Enabled SubSystem: '<S77>/Enabled Subsystem'
        if (EX3_CircularTrajectoryNew_DW.EnabledSubsystem_MODE_j) {
          EX3_CircularTrajectoryNew_DW.EnabledSubsystem_MODE_j = false;
        }

        // End of Disable for SubSystem: '<S77>/Enabled Subsystem'

        // Disable for Enabled SubSystem: '<S77>/Enabled Subsystem1'
        if (EX3_CircularTrajectoryNew_DW.EnabledSubsystem1_MODE_d) {
          EX3_CircularTrajectoryNew_DW.EnabledSubsystem1_MODE_d = false;
        }

        // End of Disable for SubSystem: '<S77>/Enabled Subsystem1'

        // Disable for Enabled SubSystem: '<S138>/Enabled Subsystem'
        if (EX3_CircularTrajectoryNew_DW.EnabledSubsystem_MODE_m) {
          EX3_CircularTrajectoryNew_DW.EnabledSubsystem_MODE_m = false;
        }
       ...
       case 1:
        ...
        EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhether_d1 = -1;

        // Disable for If: '<S76>/This IF block determines whether or not to run the RED sim//exp ' 
        if (EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhethero_o == 0) {
          // Disable for Enabled SubSystem: '<S80>/Enabled Subsystem1'
          if (EX3_CircularTrajectoryNew_DW.EnabledSubsystem1_MODE) {
            EX3_CircularTrajectoryNew_DW.EnabledSubsystem1_MODE = false;
          }

          // End of Disable for SubSystem: '<S80>/Enabled Subsystem1'

          // Disable for Enabled SubSystem: '<S106>/Enabled Subsystem'
          if (EX3_CircularTrajectoryNew_DW.EnabledSubsystem_MODE) {
            EX3_CircularTrajectoryNew_DW.EnabledSubsystem_MODE = false;
          }

          // End of Disable for SubSystem: '<S106>/Enabled Subsystem'
        }

        EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhethero_o = -1;
        break;
      }

      EX3_CircularTrajectoryNew_DW.Checkwhetherbothplatformsarebei = -1;

      // End of Disable for If: '<S75>/Check whether both platforms are being used, and if so then use RED to send data to BLACK ' 
    }

    switch (EX3_CircularTrajectoryNew_B.rtAction) {
     case 0:
      ...
      EX3_CircularTrajectoryNew_B.rtPrevAction =
        EX3_CircularTrajectoryNew_DW.Checkwhetherbothplatformsarebei;
      EX3_CircularTrajectoryNew_B.rtAction = -1;
      if ((EX3_CircularTrajectoryNew_P.platformSelection == 1.0) ||
          (EX3_CircularTrajectoryNew_P.platformSelection == 2.0) ||
          (EX3_CircularTrajectoryNew_P.platformSelection == 5.0)) {
        EX3_CircularTrajectoryNew_B.rtAction = 0;
      } else {
        if ((EX3_CircularTrajectoryNew_P.platformSelection == 3.0) ||
            (EX3_CircularTrajectoryNew_P.platformSelection == 4.0)) {
          EX3_CircularTrajectoryNew_B.rtAction = 1;
        }
      }
      ...
      if (EX3_CircularTrajectoryNew_B.rtPrevAction !=
          EX3_CircularTrajectoryNew_B.rtAction) {
        switch (EX3_CircularTrajectoryNew_B.rtPrevAction) {
         case 0:
          // Disable for Enabled SubSystem: '<S77>/Enabled Subsystem'
          if (EX3_CircularTrajectoryNew_DW.EnabledSubsystem_MODE_j) {
            EX3_CircularTrajectoryNew_DW.EnabledSubsystem_MODE_j = false;
      ...
      switch (EX3_CircularTrajectoryNew_B.rtAction) {
       case 0:
        ...
        EX3_CircularTrajectoryNew_B.Sum6_l1 = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate;
        if (EX3_CircularTrajectoryNew_DW.obj_f.platformSelection !=
            EX3_CircularTrajectoryNew_P.platformSelection) {
          EX3_CircularTrajectoryNew_DW.obj_f.platformSelection =
            EX3_CircularTrajectoryNew_P.platformSelection;
        }

        if (EX3_CircularTrajectoryNew_DW.obj_f.PS_SampleRate !=
            EX3_CircularTrajectoryNew_B.Sum6_l1) {
          EX3_CircularTrajectoryNew_DW.obj_f.PS_SampleRate =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        }

        EX3_CircularTrajectoryNew_B.Sum6_l1 = 0.0;
        EX3_CircularTrajectoryNew_B.Sum6_dk = 0.0;
        EX3_CircularTrajectoryNew_B.StreamPhaseSpacetoPlatform[3] = 0.0;
        EX3_CircularTrajectoryNew_B.RED_Tz_Wrist = 0.0;
        EX3_CircularTrajectoryNew_B.y5 = 0.0;
        EX3_CircularTrajectoryNew_B.StreamPhaseSpacetoPlatform[6] = 0.0;
        EX3_CircularTrajectoryNew_B.VelocitytoPosition_d_idx_0 = 0.0;
        EX3_CircularTrajectoryNew_B.VelocitytoPosition_d_idx_1 = 0.0;
        EX3_CircularTrajectoryNew_B.VelocitytoPosition_d_idx_2 = 0.0;
        EX3_CircularTrajectoryNew_B.y10 = 0.0;
        EX3_CircularTrajectoryNew_B.rtb_TmpSignalConversionAtSFun_f = 0.0;
        EX3_CircularTrajectoryNew_B.rtb_x_ddot_idx_0 = 0.0;
        EX3_CircularTrajectoryNew_B.rtb_TmpSignalConversionAtSFun_g = 0.0;
        stream_phasespace(&EX3_CircularTrajectoryNew_B.Sum6_l1,
                          &EX3_CircularTrajectoryNew_B.Sum6_dk,
                          &EX3_CircularTrajectoryNew_B.StreamPhaseSpacetoPlatform
                          [3], &EX3_CircularTrajectoryNew_B.RED_Tz_Wrist,
                          &EX3_CircularTrajectoryNew_B.y5,
                          &EX3_CircularTrajectoryNew_B.StreamPhaseSpacetoPlatform
                          [6],
                          &EX3_CircularTrajectoryNew_B.VelocitytoPosition_d_idx_0,
                          ...
                          &EX3_CircularTrajectoryNew_B.rtb_TmpSignalConversionAtSFun_g,
                          EX3_CircularTrajectoryNew_DW.obj_f.platformSelection);
        EX3_CircularTrajectoryNew_B.StreamPhaseSpacetoPlatform[0] =
          EX3_CircularTrajectoryNew_B.VelocitytoPosition_d_idx_0 /
          EX3_CircularTrajectoryNew_DW.obj_f.PS_SampleRate;
        EX3_CircularTrajectoryNew_B.StreamPhaseSpacetoPlatform[1] =
          EX3_CircularTrajectoryNew_B.Sum6_l1 / 1000.0;
        EX3_CircularTrajectoryNew_B.StreamPhaseSpacetoPlatform[2] =
          EX3_CircularTrajectoryNew_B.Sum6_dk / 1000.0;
        EX3_CircularTrajectoryNew_B.StreamPhaseSpacetoPlatform[4] =
          EX3_CircularTrajectoryNew_B.RED_Tz_Wrist / 1000.0;
        EX3_CircularTrajectoryNew_B.StreamPhaseSpacetoPlatform[5] =
          EX3_CircularTrajectoryNew_B.y5 / 1000.0;
        EX3_CircularTrajectoryNew_B.StreamPhaseSpacetoPlatform[7] =
          EX3_CircularTrajectoryNew_B.VelocitytoPosition_d_idx_1 / 1000.0;
        EX3_CircularTrajectoryNew_B.StreamPhaseSpacetoPlatform[8] =
          EX3_CircularTrajectoryNew_B.VelocitytoPosition_d_idx_2 / 1000.0;
        EX3_CircularTrajectoryNew_B.StreamPhaseSpacetoPlatform[9] =
          EX3_CircularTrajectoryNew_B.y10 / 1000.0;
        EX3_CircularTrajectoryNew_B.StreamPhaseSpacetoPlatform[10] =
          EX3_CircularTrajectoryNew_B.rtb_TmpSignalConversionAtSFun_f / 1000.0;
        EX3_CircularTrajectoryNew_B.StreamPhaseSpacetoPlatform[11] =
          EX3_CircularTrajectoryNew_B.rtb_x_ddot_idx_0 / 1000.0;
        EX3_CircularTrajectoryNew_B.StreamPhaseSpacetoPlatform[12] =
          EX3_CircularTrajectoryNew_B.rtb_TmpSignalConversionAtSFun_g / 1000.0;
        ...
        for (EX3_CircularTrajectoryNew_B.uElOffset1 = 0;
             EX3_CircularTrajectoryNew_B.uElOffset1 < 13;
             EX3_CircularTrajectoryNew_B.uElOffset1++) {
          EX3_CircularTrajectoryNew_B.Compare_p[EX3_CircularTrajectoryNew_B.uElOffset1]
            =
            (EX3_CircularTrajectoryNew_B.StreamPhaseSpacetoPlatform[EX3_CircularTrajectoryNew_B.uElOffset1]
             != EX3_CircularTrajectoryNew_P.Constant_Value);
        }
        ...
        EX3_CircularTrajectoryNew_B.rtb_Compare_p =
          (EX3_CircularTrajectoryNew_B.Compare_p[0] ||
           EX3_CircularTrajectoryNew_B.Compare_p[1] ||
           EX3_CircularTrajectoryNew_B.Compare_p[2] ||
           EX3_CircularTrajectoryNew_B.Compare_p[3] ||
           EX3_CircularTrajectoryNew_B.Compare_p[4] ||
           EX3_CircularTrajectoryNew_B.Compare_p[5] ||
           EX3_CircularTrajectoryNew_B.Compare_p[6] ||
           EX3_CircularTrajectoryNew_B.Compare_p[7] ||
           EX3_CircularTrajectoryNew_B.Compare_p[8] ||
           EX3_CircularTrajectoryNew_B.Compare_p[9] ||
           EX3_CircularTrajectoryNew_B.Compare_p[10] ||
           EX3_CircularTrajectoryNew_B.Compare_p[11]);

        // End of Outputs for SubSystem: '<S77>/Enabled Subsystem1'
        if (EX3_CircularTrajectoryNew_B.rtb_Compare_p ||
            EX3_CircularTrajectoryNew_B.Compare_p[12]) {
          if (!EX3_CircularTrajectoryNew_DW.EnabledSubsystem_MODE_j) {
            EX3_CircularTrajectoryNew_DW.EnabledSubsystem_MODE_j = true;
          }
        } else {
          if (EX3_CircularTrajectoryNew_DW.EnabledSubsystem_MODE_j) {
            EX3_CircularTrajectoryNew_DW.EnabledSubsystem_MODE_j = false;
        ...
        if (EX3_CircularTrajectoryNew_DW.EnabledSubsystem_MODE_j) {
          memcpy(&EX3_CircularTrajectoryNew_B.In1_b4[0],
                 &EX3_CircularTrajectoryNew_B.StreamPhaseSpacetoPlatform[0], 13U
                 * sizeof(real_T));
        }
        ...
        EX3_CircularTrajectoryNew_DW.ARM_Elbow_Px =
          EX3_CircularTrajectoryNew_B.In1_b4[7];

        // DataStoreWrite: '<S77>/Data Store Write4'
        EX3_CircularTrajectoryNew_DW.ARM_Elbow_Py =
          EX3_CircularTrajectoryNew_B.In1_b4[8];

        // DataStoreWrite: '<S77>/Data Store Write5'
        EX3_CircularTrajectoryNew_DW.ARM_Wrist_Px =
          EX3_CircularTrajectoryNew_B.In1_b4[9];

        // DataStoreWrite: '<S77>/Data Store Write6'
        EX3_CircularTrajectoryNew_DW.ARM_Wrist_Py =
          EX3_CircularTrajectoryNew_B.In1_b4[10];

        // DataStoreWrite: '<S77>/Data Store Write7'
        EX3_CircularTrajectoryNew_DW.ARM_EndEff_Px =
          EX3_CircularTrajectoryNew_B.In1_b4[11];

        // DataStoreWrite: '<S77>/Data Store Write8'
        EX3_CircularTrajectoryNew_DW.ARM_EndEff_Py =
          EX3_CircularTrajectoryNew_B.In1_b4[12];

        // DataStoreWrite: '<S77>/RED_Px1'
        EX3_CircularTrajectoryNew_DW.RED_Px =
          EX3_CircularTrajectoryNew_B.In1_b4[1];
        ...
        if (EX3_CircularTrajectoryNew_B.rtb_Compare_p ||
            EX3_CircularTrajectoryNew_B.Compare_p[12]) {
          if (!EX3_CircularTrajectoryNew_DW.EnabledSubsystem1_MODE_d) {
            EX3_CircularTrajectoryNew_DW.EnabledSubsystem1_MODE_d = true;
          }
        } else {
          if (EX3_CircularTrajectoryNew_DW.EnabledSubsystem1_MODE_d) {
            EX3_CircularTrajectoryNew_DW.EnabledSubsystem1_MODE_d = false;
        ...
        if (EX3_CircularTrajectoryNew_DW.EnabledSubsystem1_MODE_d) {
          EX3_CircularTrajectoryNew_B.In1_pl =
            EX3_CircularTrajectoryNew_M->Timing.t[0];
        }
        ...
        EX3_CircularTrajectoryNew_B.DataTypeConversion_h =
          (EX3_CircularTrajectoryNew_B.In1_pl != 0.0);

        // Outputs for Enabled SubSystem: '<S138>/Enabled Subsystem' incorporates:
        //   EnablePort: '<S154>/Enable'

        if (EX3_CircularTrajectoryNew_B.DataTypeConversion_h &&
            (!EX3_CircularTrajectoryNew_DW.Delay_DSTATE_o)) {
          if (!EX3_CircularTrajectoryNew_DW.EnabledSubsystem_MODE_m) {
            EX3_CircularTrajectoryNew_DW.EnabledSubsystem_MODE_m = true;
          }
        } else {
          if (EX3_CircularTrajectoryNew_DW.EnabledSubsystem_MODE_m) {
            EX3_CircularTrajectoryNew_DW.EnabledSubsystem_MODE_m = false;
        ...
        if (EX3_CircularTrajectoryNew_DW.EnabledSubsystem_MODE_m) {
          EX3_CircularTrajectoryNew_B.In1_j1 =
            EX3_CircularTrajectoryNew_B.In1_pl;
        }
        ...
        // Delay: '<S147>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_dr != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_ln =
            EX3_CircularTrajectoryNew_B.In1_b4[4];
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_d4 =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_B.dividebydeltaT_p = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_d4;

        // Delay: '<S142>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_mq != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_pv =
            EX3_CircularTrajectoryNew_B.dividebydeltaT_p;
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_ds =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_DW.BLACK_Ax = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_ds;

        // Delay: '<S148>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_lr != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_mk =
            EX3_CircularTrajectoryNew_B.In1_b4[5];
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_ljk =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_B.dividebydeltaT_nx = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_ljk;

        // Delay: '<S143>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_b != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_le =
            EX3_CircularTrajectoryNew_B.dividebydeltaT_nx;
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_dy =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_DW.BLACK_Ay = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_dy;

        // S-Function (sdspunwrap2): '<S77>/Unwrap1'
        if (EX3_CircularTrajectoryNew_DW.Unwrap1_FirstStep_d) {
          EX3_CircularTrajectoryNew_DW.Unwrap1_Prev_l =
            EX3_CircularTrajectoryNew_B.In1_b4[6];
          EX3_CircularTrajectoryNew_DW.Unwrap1_FirstStep_d = false;
        }

        EX3_CircularTrajectoryNew_B.Sum6_l1 =
          EX3_CircularTrajectoryNew_DW.Unwrap1_Cumsum_a;
        EX3_CircularTrajectoryNew_B.Sum6_dk =
          EX3_CircularTrajectoryNew_B.In1_b4[6] -
          EX3_CircularTrajectoryNew_DW.Unwrap1_Prev_l;
        EX3_CircularTrajectoryNew_B.RED_Tz_Wrist =
          EX3_CircularTrajectoryNew_B.Sum6_dk - floor
          ((EX3_CircularTrajectoryNew_B.Sum6_dk + 3.1415926535897931) /
           6.2831853071795862) * 6.2831853071795862;
        if ((EX3_CircularTrajectoryNew_B.RED_Tz_Wrist == -3.1415926535897931) &&
            (EX3_CircularTrajectoryNew_B.Sum6_dk > 0.0)) {
          EX3_CircularTrajectoryNew_B.RED_Tz_Wrist = 3.1415926535897931;
        }

        EX3_CircularTrajectoryNew_B.Sum6_dk =
          EX3_CircularTrajectoryNew_B.RED_Tz_Wrist -
          EX3_CircularTrajectoryNew_B.Sum6_dk;
        if (fabs(EX3_CircularTrajectoryNew_B.Sum6_dk) > 3.1415926535897931) {
          EX3_CircularTrajectoryNew_B.Sum6_l1 =
            EX3_CircularTrajectoryNew_DW.Unwrap1_Cumsum_a +
            EX3_CircularTrajectoryNew_B.Sum6_dk;
        }

        EX3_CircularTrajectoryNew_B.Unwrap1_c =
          EX3_CircularTrajectoryNew_B.In1_b4[6] +
          EX3_CircularTrajectoryNew_B.Sum6_l1;
        EX3_CircularTrajectoryNew_DW.Unwrap1_Prev_l =
          EX3_CircularTrajectoryNew_B.In1_b4[6];
        ...
        // Delay: '<S149>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_aa != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_de =
            EX3_CircularTrajectoryNew_B.Unwrap1_c;
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_awb =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_B.dividebydeltaT_dx = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_awb;

        // Delay: '<S144>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_cw != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_lu2 =
            EX3_CircularTrajectoryNew_B.dividebydeltaT_dx;
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_lyk =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_DW.BLACK_RzDD = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_lyk;

        // Delay: '<S141>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_nsj != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_b3 =
            EX3_CircularTrajectoryNew_B.In1_b4[1];
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_kd2 =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_B.dividebydeltaT_ph = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_kd2;

        // DataStoreWrite: '<S77>/RED_Px2'
        EX3_CircularTrajectoryNew_DW.RED_Vx =
          EX3_CircularTrajectoryNew_B.dividebydeltaT_ph;
        ...
        // Delay: '<S150>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_lrw != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_ng =
            EX3_CircularTrajectoryNew_B.dividebydeltaT_ph;
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_aw =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_DW.RED_Ax = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_aw;

        // Delay: '<S145>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_a2d != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_m3 =
            EX3_CircularTrajectoryNew_B.In1_b4[2];
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_mm =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_B.dividebydeltaT_pf = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_mm;

        // Delay: '<S151>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_mp != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_fs =
            EX3_CircularTrajectoryNew_B.dividebydeltaT_pf;
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_on =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_DW.RED_Ay = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_on;

        // S-Function (sdspunwrap2): '<S77>/Unwrap'
        if (EX3_CircularTrajectoryNew_DW.Unwrap_FirstStep_d) {
          EX3_CircularTrajectoryNew_DW.Unwrap_Prev_p =
            EX3_CircularTrajectoryNew_B.In1_b4[3];
          EX3_CircularTrajectoryNew_DW.Unwrap_FirstStep_d = false;
        }

        EX3_CircularTrajectoryNew_B.Sum6_l1 =
          EX3_CircularTrajectoryNew_DW.Unwrap_Cumsum_o;
        EX3_CircularTrajectoryNew_B.Sum6_dk =
          EX3_CircularTrajectoryNew_B.In1_b4[3] -
          EX3_CircularTrajectoryNew_DW.Unwrap_Prev_p;
        EX3_CircularTrajectoryNew_B.RED_Tz_Wrist =
        ...
        EX3_CircularTrajectoryNew_B.Unwrap_n =
          EX3_CircularTrajectoryNew_B.In1_b4[3] +
          EX3_CircularTrajectoryNew_B.Sum6_l1;
        EX3_CircularTrajectoryNew_DW.Unwrap_Prev_p =
          EX3_CircularTrajectoryNew_B.In1_b4[3];
        ...
        // Delay: '<S146>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_gb != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_c4 =
            EX3_CircularTrajectoryNew_B.Unwrap_n;
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_cp =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_B.dividebydeltaT_hu = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_cp;

        // Delay: '<S152>/Delay1'
        if (EX3_CircularTrajectoryNew_DW.icLoad_i != 0) {
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_cz =
            EX3_CircularTrajectoryNew_B.dividebydeltaT_hu;
        }
        ...
        if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
          ...
          EX3_CircularTrajectoryNew_B.In1_kt =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_DW.RED_RzDD = 1.0 /
          EX3_CircularTrajectoryNew_P.serverRate *
          EX3_CircularTrajectoryNew_B.In1_kt;
       ...
       case 1:
        ...
        if ((EX3_CircularTrajectoryNew_P.WhoAmI == 2.0) ||
          ...
          sErr = GetErrorBuffer
            (&EX3_CircularTrajectoryNew_DW.UDPReceive_NetworkLib[0U]);
          EX3_CircularTrajectoryNew_B.uElOffset1 = 13;
          LibOutputs_Network
            (&EX3_CircularTrajectoryNew_DW.UDPReceive_NetworkLib[0U],
             &EX3_CircularTrajectoryNew_B.UDPReceive_o1[0U],
             &EX3_CircularTrajectoryNew_B.uElOffset1);
          if (*sErr != 0) {
            rtmSetErrorStatus(EX3_CircularTrajectoryNew_M, sErr);
            rtmSetStopRequested(EX3_CircularTrajectoryNew_M, 1);
          }
          ...
          EX3_CircularTrajectoryNew_DW.ARM_Elbow_Px =
            EX3_CircularTrajectoryNew_B.UDPReceive_o1[7];

          // DataStoreWrite: '<S79>/Data Store Write4'
          EX3_CircularTrajectoryNew_DW.ARM_Elbow_Py =
            EX3_CircularTrajectoryNew_B.UDPReceive_o1[8];

          // DataStoreWrite: '<S79>/Data Store Write5'
          EX3_CircularTrajectoryNew_DW.ARM_Wrist_Px =
            EX3_CircularTrajectoryNew_B.UDPReceive_o1[9];

          // DataStoreWrite: '<S79>/Data Store Write6'
          EX3_CircularTrajectoryNew_DW.ARM_Wrist_Py =
            EX3_CircularTrajectoryNew_B.UDPReceive_o1[10];

          // DataStoreWrite: '<S79>/Data Store Write7'
          EX3_CircularTrajectoryNew_DW.ARM_EndEff_Px =
            EX3_CircularTrajectoryNew_B.UDPReceive_o1[11];

          // DataStoreWrite: '<S79>/Data Store Write8'
          EX3_CircularTrajectoryNew_DW.ARM_EndEff_Py =
            EX3_CircularTrajectoryNew_B.UDPReceive_o1[12];

          // DataStoreWrite: '<S79>/RED_Px1'
          EX3_CircularTrajectoryNew_DW.RED_Px =
            EX3_CircularTrajectoryNew_B.UDPReceive_o1[1];

          // DataStoreWrite: '<S79>/RED_Px10'
          EX3_CircularTrajectoryNew_DW.Univ_Time =
            EX3_CircularTrajectoryNew_B.UDPReceive_o1[0];

          // Delay: '<S87>/Delay1'
          if (EX3_CircularTrajectoryNew_DW.icLoad_ky1 != 0) {
            EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_nw =
              EX3_CircularTrajectoryNew_B.UDPReceive_o1[4];
          }
          ...
          if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
            ...
            EX3_CircularTrajectoryNew_B.In1_dn =
              EX3_CircularTrajectoryNew_B.Sum6_l1;
          ...
          EX3_CircularTrajectoryNew_B.dividebydeltaT_m = 1.0 /
            EX3_CircularTrajectoryNew_P.serverRate *
            EX3_CircularTrajectoryNew_B.In1_dn;

          // Delay: '<S82>/Delay1'
          if (EX3_CircularTrajectoryNew_DW.icLoad_of != 0) {
            EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_gx =
              EX3_CircularTrajectoryNew_B.dividebydeltaT_m;
          }
          ...
          if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
            ...
            EX3_CircularTrajectoryNew_B.In1_fg =
              EX3_CircularTrajectoryNew_B.Sum6_l1;
          ...
          // Delay: '<S88>/Delay1'
          if (EX3_CircularTrajectoryNew_DW.icLoad_oi != 0) {
            EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_ct1 =
              EX3_CircularTrajectoryNew_B.UDPReceive_o1[5];
          }
          ...
          if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
            ...
            EX3_CircularTrajectoryNew_B.In1_jk =
              EX3_CircularTrajectoryNew_B.Sum6_l1;
          ...
          EX3_CircularTrajectoryNew_B.dividebydeltaT_me = 1.0 /
            EX3_CircularTrajectoryNew_P.serverRate *
            EX3_CircularTrajectoryNew_B.In1_jk;

          // Delay: '<S83>/Delay1'
          if (EX3_CircularTrajectoryNew_DW.icLoad_hb != 0) {
            EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_i0 =
              EX3_CircularTrajectoryNew_B.dividebydeltaT_me;
          }
          ...
          if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
            ...
            EX3_CircularTrajectoryNew_B.In1_jj =
              EX3_CircularTrajectoryNew_B.Sum6_l1;
          ...
          if (EX3_CircularTrajectoryNew_DW.Unwrap1_FirstStep_o) {
            EX3_CircularTrajectoryNew_DW.Unwrap1_Prev_p =
              EX3_CircularTrajectoryNew_B.UDPReceive_o1[6];
            EX3_CircularTrajectoryNew_DW.Unwrap1_FirstStep_o = false;
          }

          EX3_CircularTrajectoryNew_B.Sum6_l1 =
            EX3_CircularTrajectoryNew_DW.Unwrap1_Cumsum_n;
          EX3_CircularTrajectoryNew_B.Sum6_dk =
            EX3_CircularTrajectoryNew_B.UDPReceive_o1[6] -
            EX3_CircularTrajectoryNew_DW.Unwrap1_Prev_p;
          EX3_CircularTrajectoryNew_B.RED_Tz_Wrist =
          ...
          EX3_CircularTrajectoryNew_DW.Unwrap1_Prev_p =
            EX3_CircularTrajectoryNew_B.UDPReceive_o1[6];
          EX3_CircularTrajectoryNew_B.Unwrap1_l =
            EX3_CircularTrajectoryNew_B.UDPReceive_o1[6] +
            EX3_CircularTrajectoryNew_B.Sum6_l1;
          EX3_CircularTrajectoryNew_DW.Unwrap1_Cumsum_n =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
          ...
          // Delay: '<S89>/Delay1'
          if (EX3_CircularTrajectoryNew_DW.icLoad_ap != 0) {
            EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_n0 =
              EX3_CircularTrajectoryNew_B.Unwrap1_l;
          }
          ...
          if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
            ...
            EX3_CircularTrajectoryNew_B.In1_fr =
              EX3_CircularTrajectoryNew_B.Sum6_l1;
          ...
          EX3_CircularTrajectoryNew_B.dividebydeltaT_g = 1.0 /
            EX3_CircularTrajectoryNew_P.serverRate *
            EX3_CircularTrajectoryNew_B.In1_fr;

          // Delay: '<S84>/Delay1'
          if (EX3_CircularTrajectoryNew_DW.icLoad_hc != 0) {
            EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_da =
              EX3_CircularTrajectoryNew_B.dividebydeltaT_g;
          }
          ...
          if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
            ...
            EX3_CircularTrajectoryNew_B.In1_gw =
              EX3_CircularTrajectoryNew_B.Sum6_l1;
          ...
          // Delay: '<S81>/Delay1'
          if (EX3_CircularTrajectoryNew_DW.icLoad_nn != 0) {
            EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_m1 =
              EX3_CircularTrajectoryNew_B.UDPReceive_o1[1];
          }
          ...
          if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
            ...
            EX3_CircularTrajectoryNew_B.In1_kw =
              EX3_CircularTrajectoryNew_B.Sum6_l1;
          ...
          EX3_CircularTrajectoryNew_B.dividebydeltaT_hw = 1.0 /
            EX3_CircularTrajectoryNew_P.serverRate *
            EX3_CircularTrajectoryNew_B.In1_kw;

          // DataStoreWrite: '<S79>/RED_Px2'
          EX3_CircularTrajectoryNew_DW.RED_Vx =
            EX3_CircularTrajectoryNew_B.dividebydeltaT_hw;
          ...
          // Delay: '<S90>/Delay1'
          if (EX3_CircularTrajectoryNew_DW.icLoad_gc != 0) {
            EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_bo =
              EX3_CircularTrajectoryNew_B.dividebydeltaT_hw;
          }
          ...
          if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
            ...
            EX3_CircularTrajectoryNew_B.In1_df =
              EX3_CircularTrajectoryNew_B.Sum6_l1;
          ...
          // Delay: '<S85>/Delay1'
          if (EX3_CircularTrajectoryNew_DW.icLoad_d0 != 0) {
            EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_ed =
              EX3_CircularTrajectoryNew_B.UDPReceive_o1[2];
          }
          ...
          if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
            ...
            EX3_CircularTrajectoryNew_B.In1_jp3 =
              EX3_CircularTrajectoryNew_B.Sum6_l1;
          ...
          EX3_CircularTrajectoryNew_B.dividebydeltaT_d = 1.0 /
            EX3_CircularTrajectoryNew_P.serverRate *
            EX3_CircularTrajectoryNew_B.In1_jp3;

          // Delay: '<S91>/Delay1'
          if (EX3_CircularTrajectoryNew_DW.icLoad_a1a != 0) {
            EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_k5 =
              EX3_CircularTrajectoryNew_B.dividebydeltaT_d;
          }
          ...
          if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
            ...
            EX3_CircularTrajectoryNew_B.In1_dr =
              EX3_CircularTrajectoryNew_B.Sum6_l1;
          ...
          if (EX3_CircularTrajectoryNew_DW.Unwrap_FirstStep_p) {
            EX3_CircularTrajectoryNew_DW.Unwrap_Prev_f =
              EX3_CircularTrajectoryNew_B.UDPReceive_o1[3];
            EX3_CircularTrajectoryNew_DW.Unwrap_FirstStep_p = false;
          }

          EX3_CircularTrajectoryNew_B.Sum6_l1 =
            EX3_CircularTrajectoryNew_DW.Unwrap_Cumsum_k;
          EX3_CircularTrajectoryNew_B.Sum6_dk =
            EX3_CircularTrajectoryNew_B.UDPReceive_o1[3] -
            EX3_CircularTrajectoryNew_DW.Unwrap_Prev_f;
          EX3_CircularTrajectoryNew_B.RED_Tz_Wrist =
          ...
          EX3_CircularTrajectoryNew_DW.Unwrap_Prev_f =
            EX3_CircularTrajectoryNew_B.UDPReceive_o1[3];
          EX3_CircularTrajectoryNew_B.Unwrap_l =
            EX3_CircularTrajectoryNew_B.UDPReceive_o1[3] +
            EX3_CircularTrajectoryNew_B.Sum6_l1;
          EX3_CircularTrajectoryNew_DW.Unwrap_Cumsum_k =
            EX3_CircularTrajectoryNew_B.Sum6_l1;
          ...
          // Delay: '<S86>/Delay1'
          if (EX3_CircularTrajectoryNew_DW.icLoad_ms != 0) {
            EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_p4 =
              EX3_CircularTrajectoryNew_B.Unwrap_l;
          }
          ...
          if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
            ...
            EX3_CircularTrajectoryNew_B.In1_cxn =
              EX3_CircularTrajectoryNew_B.Sum6_l1;
          ...
          EX3_CircularTrajectoryNew_B.dividebydeltaT_n = 1.0 /
            EX3_CircularTrajectoryNew_P.serverRate *
            EX3_CircularTrajectoryNew_B.In1_cxn;

          // Delay: '<S92>/Delay1'
          if (EX3_CircularTrajectoryNew_DW.icLoad_gi != 0) {
            EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_fr =
              EX3_CircularTrajectoryNew_B.dividebydeltaT_n;
          }
          ...
          if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
            ...
            EX3_CircularTrajectoryNew_B.In1_oi =
              EX3_CircularTrajectoryNew_B.Sum6_l1;
        ...
        EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhether_d1 =
          EX3_CircularTrajectoryNew_B.rtAction;
        ...
        EX3_CircularTrajectoryNew_B.rtPrevAction =
          EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhethero_o;
        EX3_CircularTrajectoryNew_B.rtAction = -1;
        if ((EX3_CircularTrajectoryNew_P.WhoAmI == 1.0) ||
            (EX3_CircularTrajectoryNew_P.simMode == 1.0)) {
          EX3_CircularTrajectoryNew_B.rtAction = 0;
        ...
        if (EX3_CircularTrajectoryNew_B.rtAction == 0) {
          ...
          for (EX3_CircularTrajectoryNew_B.uElOffset1 = 0;
               ...
               EX3_CircularTrajectoryNew_B.uElOffset1++) {
            EX3_CircularTrajectoryNew_B.Compare_p[EX3_CircularTrajectoryNew_B.uElOffset1]
              = (0.0 != EX3_CircularTrajectoryNew_P.Constant_Value_p);
          }
          ...
          if (EX3_CircularTrajectoryNew_B.rtb_Compare_p ||
              EX3_CircularTrajectoryNew_B.Compare_p[12]) {
            memset(&EX3_CircularTrajectoryNew_B.In1_n1[0], 0, 13U * sizeof
                   (real_T));
          }
          ...
          EX3_CircularTrajectoryNew_DW.ARM_Elbow_Px =
            EX3_CircularTrajectoryNew_B.In1_n1[7];

          // DataStoreWrite: '<S80>/Data Store Write4'
          EX3_CircularTrajectoryNew_DW.ARM_Elbow_Py =
            EX3_CircularTrajectoryNew_B.In1_n1[8];

          // DataStoreWrite: '<S80>/Data Store Write5'
          EX3_CircularTrajectoryNew_DW.ARM_Wrist_Px =
            EX3_CircularTrajectoryNew_B.In1_n1[9];

          // DataStoreWrite: '<S80>/Data Store Write6'
          EX3_CircularTrajectoryNew_DW.ARM_Wrist_Py =
            EX3_CircularTrajectoryNew_B.In1_n1[10];

          // DataStoreWrite: '<S80>/Data Store Write7'
          EX3_CircularTrajectoryNew_DW.ARM_EndEff_Px =
            EX3_CircularTrajectoryNew_B.In1_n1[11];

          // DataStoreWrite: '<S80>/Data Store Write8'
          EX3_CircularTrajectoryNew_DW.ARM_EndEff_Py =
            EX3_CircularTrajectoryNew_B.In1_n1[12];

          // DataStoreWrite: '<S80>/RED_Px1'
          EX3_CircularTrajectoryNew_DW.RED_Px =
            EX3_CircularTrajectoryNew_B.In1_n1[1];
          ...
          if (EX3_CircularTrajectoryNew_B.rtb_Compare_p ||
              EX3_CircularTrajectoryNew_B.Compare_p[12]) {
            if (!EX3_CircularTrajectoryNew_DW.EnabledSubsystem1_MODE) {
              EX3_CircularTrajectoryNew_DW.EnabledSubsystem1_MODE = true;
            }
          } else {
            if (EX3_CircularTrajectoryNew_DW.EnabledSubsystem1_MODE) {
              EX3_CircularTrajectoryNew_DW.EnabledSubsystem1_MODE = false;
          ...
          if (EX3_CircularTrajectoryNew_DW.EnabledSubsystem1_MODE) {
            EX3_CircularTrajectoryNew_B.In1_nh =
              EX3_CircularTrajectoryNew_M->Timing.t[0];
          }
          ...
          EX3_CircularTrajectoryNew_B.DataTypeConversion =
            (EX3_CircularTrajectoryNew_B.In1_nh != 0.0);

          // Outputs for Enabled SubSystem: '<S106>/Enabled Subsystem' incorporates:
          //   EnablePort: '<S122>/Enable'

          if (EX3_CircularTrajectoryNew_B.DataTypeConversion &&
              (!EX3_CircularTrajectoryNew_DW.Delay_DSTATE_p)) {
            if (!EX3_CircularTrajectoryNew_DW.EnabledSubsystem_MODE) {
              EX3_CircularTrajectoryNew_DW.EnabledSubsystem_MODE = true;
            }
          } else {
            if (EX3_CircularTrajectoryNew_DW.EnabledSubsystem_MODE) {
              EX3_CircularTrajectoryNew_DW.EnabledSubsystem_MODE = false;
          ...
          if (EX3_CircularTrajectoryNew_DW.EnabledSubsystem_MODE) {
            EX3_CircularTrajectoryNew_B.In1_it =
              EX3_CircularTrajectoryNew_B.In1_nh;
          }
          ...
          // Delay: '<S115>/Delay1'
          if (EX3_CircularTrajectoryNew_DW.icLoad_kc != 0) {
            EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_p3 =
              EX3_CircularTrajectoryNew_B.In1_n1[4];
          }
          ...
          if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
            ...
            EX3_CircularTrajectoryNew_B.In1_n5 =
              EX3_CircularTrajectoryNew_B.Sum6_l1;
          ...
          EX3_CircularTrajectoryNew_B.dividebydeltaT = 1.0 /
            EX3_CircularTrajectoryNew_P.serverRate *
            EX3_CircularTrajectoryNew_B.In1_n5;

          // Delay: '<S110>/Delay1'
          if (EX3_CircularTrajectoryNew_DW.icLoad_p1 != 0) {
            EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_bk =
              EX3_CircularTrajectoryNew_B.dividebydeltaT;
          }
          ...
          if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
            ...
            EX3_CircularTrajectoryNew_B.In1_av =
              EX3_CircularTrajectoryNew_B.Sum6_l1;
          ...
          // Delay: '<S116>/Delay1'
          if (EX3_CircularTrajectoryNew_DW.icLoad_kv != 0) {
            EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_ko =
              EX3_CircularTrajectoryNew_B.In1_n1[5];
          }
          ...
          if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
            ...
            EX3_CircularTrajectoryNew_B.In1_bi =
              EX3_CircularTrajectoryNew_B.Sum6_l1;
          ...
          EX3_CircularTrajectoryNew_B.dividebydeltaT_l = 1.0 /
            EX3_CircularTrajectoryNew_P.serverRate *
            EX3_CircularTrajectoryNew_B.In1_bi;

          // Delay: '<S111>/Delay1'
          if (EX3_CircularTrajectoryNew_DW.icLoad_cg != 0) {
            EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_kx =
              EX3_CircularTrajectoryNew_B.dividebydeltaT_l;
          }
          ...
          if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
            ...
            EX3_CircularTrajectoryNew_B.In1_ox =
              EX3_CircularTrajectoryNew_B.Sum6_l1;
          ...
          if (EX3_CircularTrajectoryNew_DW.Unwrap1_FirstStep) {
            EX3_CircularTrajectoryNew_DW.Unwrap1_Prev =
              EX3_CircularTrajectoryNew_B.In1_n1[6];
            EX3_CircularTrajectoryNew_DW.Unwrap1_FirstStep = false;
          }

          EX3_CircularTrajectoryNew_B.Sum6_l1 =
            EX3_CircularTrajectoryNew_DW.Unwrap1_Cumsum;
          EX3_CircularTrajectoryNew_B.Sum6_dk =
            EX3_CircularTrajectoryNew_B.In1_n1[6] -
            EX3_CircularTrajectoryNew_DW.Unwrap1_Prev;
          EX3_CircularTrajectoryNew_B.RED_Tz_Wrist =
          ...
          EX3_CircularTrajectoryNew_B.Unwrap1 =
            EX3_CircularTrajectoryNew_B.In1_n1[6] +
            EX3_CircularTrajectoryNew_B.Sum6_l1;
          EX3_CircularTrajectoryNew_DW.Unwrap1_Prev =
            EX3_CircularTrajectoryNew_B.In1_n1[6];
          ...
          // Delay: '<S117>/Delay1'
          if (EX3_CircularTrajectoryNew_DW.icLoad_f0 != 0) {
            EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_at =
              EX3_CircularTrajectoryNew_B.Unwrap1;
          }
          ...
          if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
            ...
            EX3_CircularTrajectoryNew_B.In1_hs =
              EX3_CircularTrajectoryNew_B.Sum6_l1;
          ...
          EX3_CircularTrajectoryNew_B.dividebydeltaT_h = 1.0 /
            EX3_CircularTrajectoryNew_P.serverRate *
            EX3_CircularTrajectoryNew_B.In1_hs;

          // Delay: '<S112>/Delay1'
          if (EX3_CircularTrajectoryNew_DW.icLoad_a5 != 0) {
            EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_hg =
              EX3_CircularTrajectoryNew_B.dividebydeltaT_h;
          }
          ...
          if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
            ...
            EX3_CircularTrajectoryNew_B.In1_kg =
              EX3_CircularTrajectoryNew_B.Sum6_l1;
          ...
          // Delay: '<S109>/Delay1'
          if (EX3_CircularTrajectoryNew_DW.icLoad_l4 != 0) {
            EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_knv =
              EX3_CircularTrajectoryNew_B.In1_n1[1];
          }
          ...
          if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
            ...
            EX3_CircularTrajectoryNew_B.In1_gd =
              EX3_CircularTrajectoryNew_B.Sum6_l1;
          ...
          EX3_CircularTrajectoryNew_B.dividebydeltaT_a = 1.0 /
            EX3_CircularTrajectoryNew_P.serverRate *
            EX3_CircularTrajectoryNew_B.In1_gd;

          // DataStoreWrite: '<S80>/RED_Px2'
          EX3_CircularTrajectoryNew_DW.RED_Vx =
            EX3_CircularTrajectoryNew_B.dividebydeltaT_a;
          ...
          // Delay: '<S118>/Delay1'
          if (EX3_CircularTrajectoryNew_DW.icLoad_go != 0) {
            EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_oz =
              EX3_CircularTrajectoryNew_B.dividebydeltaT_a;
          }
          ...
          if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
            ...
            EX3_CircularTrajectoryNew_B.In1_lj =
              EX3_CircularTrajectoryNew_B.Sum6_l1;
          ...
          // Delay: '<S113>/Delay1'
          if (EX3_CircularTrajectoryNew_DW.icLoad_ay != 0) {
            EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_cf =
              EX3_CircularTrajectoryNew_B.In1_n1[2];
          }
          ...
          if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
            ...
            EX3_CircularTrajectoryNew_B.In1_i2 =
              EX3_CircularTrajectoryNew_B.Sum6_l1;
          ...
          EX3_CircularTrajectoryNew_B.dividebydeltaT_l4 = 1.0 /
            EX3_CircularTrajectoryNew_P.serverRate *
            EX3_CircularTrajectoryNew_B.In1_i2;

          // Delay: '<S119>/Delay1'
          if (EX3_CircularTrajectoryNew_DW.icLoad_aqe != 0) {
            EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_me =
              EX3_CircularTrajectoryNew_B.dividebydeltaT_l4;
          }
          ...
          if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
            ...
            EX3_CircularTrajectoryNew_B.In1_mj =
              EX3_CircularTrajectoryNew_B.Sum6_l1;
          ...
          if (EX3_CircularTrajectoryNew_DW.Unwrap_FirstStep) {
            EX3_CircularTrajectoryNew_DW.Unwrap_Prev =
              EX3_CircularTrajectoryNew_B.In1_n1[3];
            EX3_CircularTrajectoryNew_DW.Unwrap_FirstStep = false;
          }

          EX3_CircularTrajectoryNew_B.Sum6_l1 =
            EX3_CircularTrajectoryNew_DW.Unwrap_Cumsum;
          EX3_CircularTrajectoryNew_B.Sum6_dk =
            EX3_CircularTrajectoryNew_B.In1_n1[3] -
            EX3_CircularTrajectoryNew_DW.Unwrap_Prev;
          EX3_CircularTrajectoryNew_B.RED_Tz_Wrist =
          ...
          EX3_CircularTrajectoryNew_B.Unwrap =
            EX3_CircularTrajectoryNew_B.In1_n1[3] +
            EX3_CircularTrajectoryNew_B.Sum6_l1;
          EX3_CircularTrajectoryNew_DW.Unwrap_Prev =
            EX3_CircularTrajectoryNew_B.In1_n1[3];
          ...
          // Delay: '<S114>/Delay1'
          if (EX3_CircularTrajectoryNew_DW.icLoad_ma != 0) {
            EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_gy =
              EX3_CircularTrajectoryNew_B.Unwrap;
          }
          ...
          if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
            ...
            EX3_CircularTrajectoryNew_B.In1_mc =
              EX3_CircularTrajectoryNew_B.Sum6_l1;
          ...
          EX3_CircularTrajectoryNew_B.dividebydeltaT_f = 1.0 /
            EX3_CircularTrajectoryNew_P.serverRate *
            EX3_CircularTrajectoryNew_B.In1_mc;

          // Delay: '<S120>/Delay1'
          if (EX3_CircularTrajectoryNew_DW.icLoad_hj != 0) {
            EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_hf =
              EX3_CircularTrajectoryNew_B.dividebydeltaT_f;
          }
          ...
          if (EX3_CircularTrajectoryNew_B.Sum6_l1 != 0.0) {
            ...
            EX3_CircularTrajectoryNew_B.In1_pb =
              EX3_CircularTrajectoryNew_B.Sum6_l1;
          ...
          EX3_CircularTrajectoryNew_B.TmpSignalConversionAtSendBLACKS[0] =
            EX3_CircularTrajectoryNew_DW.Univ_Time;
          memcpy(&EX3_CircularTrajectoryNew_B.TmpSignalConversionAtSendBLACKS[1],
                 &EX3_CircularTrajectoryNew_B.In1_n1[1], 12U * sizeof(real_T));
    ...
    EX3_CircularTrajectoryNew_B.status = 24U;
    memcpy((void *)&EX3_CircularTrajectoryNew_B.SwappedDataBytes, (void *)
           &EX3_CircularTrajectoryNew_B.status, (uint32_T)((size_t)1 * sizeof
            (uint8_T)));
    EX3_CircularTrajectoryNew_B.status = MW_I2C_MasterWrite
      (EX3_CircularTrajectoryNew_DW.obj.i2cobj_A_G.MW_I2C_HANDLE, 106U,
       &EX3_CircularTrajectoryNew_B.SwappedDataBytes, 1U, true, false);
    if (0 == EX3_CircularTrajectoryNew_B.status) {
      MW_I2C_MasterRead
        (EX3_CircularTrajectoryNew_DW.obj.i2cobj_A_G.MW_I2C_HANDLE, 106U,
         EX3_CircularTrajectoryNew_B.output_raw, 6U, false, true);
      memcpy((void *)&EX3_CircularTrajectoryNew_B.b_RegisterValue[0], (void *)
             &EX3_CircularTrajectoryNew_B.output_raw[0], (uint32_T)((size_t)3 *
              sizeof(int16_T)));
    } else {
      EX3_CircularTrajectoryNew_B.b_RegisterValue[0] = 0;
      EX3_CircularTrajectoryNew_B.b_RegisterValue[1] = 0;
      EX3_CircularTrajectoryNew_B.b_RegisterValue[2] = 0;
    }

    memcpy(&EX3_CircularTrajectoryNew_B.b_c[0],
           &EX3_CircularTrajectoryNew_DW.obj.CalGyroA[0], 9U * sizeof(real_T));
    for (EX3_CircularTrajectoryNew_B.uElOffset1 = 0;
         EX3_CircularTrajectoryNew_B.uElOffset1 < 3;
         EX3_CircularTrajectoryNew_B.uElOffset1++) {
      EX3_CircularTrajectoryNew_B.x_ddot_a[EX3_CircularTrajectoryNew_B.uElOffset1]
        = ((EX3_CircularTrajectoryNew_B.b_c[3 *
            EX3_CircularTrajectoryNew_B.uElOffset1 + 1] * static_cast<real_T>
            (EX3_CircularTrajectoryNew_B.b_RegisterValue[1]) +
            EX3_CircularTrajectoryNew_B.b_c[3 *
            EX3_CircularTrajectoryNew_B.uElOffset1] * static_cast<real_T>
            (EX3_CircularTrajectoryNew_B.b_RegisterValue[0])) +
           EX3_CircularTrajectoryNew_B.b_c[3 *
           EX3_CircularTrajectoryNew_B.uElOffset1 + 2] * static_cast<real_T>
           (EX3_CircularTrajectoryNew_B.b_RegisterValue[2])) +
        EX3_CircularTrajectoryNew_DW.obj.CalGyroB[EX3_CircularTrajectoryNew_B.uElOffset1];
    }

    EX3_CircularTrajectoryNew_B.status = 40U;
    memcpy((void *)&EX3_CircularTrajectoryNew_B.SwappedDataBytes, (void *)
           &EX3_CircularTrajectoryNew_B.status, (uint32_T)((size_t)1 * sizeof
            (uint8_T)));
    EX3_CircularTrajectoryNew_B.status = MW_I2C_MasterWrite
    ...
    memcpy(&EX3_CircularTrajectoryNew_B.b_c[0],
           &EX3_CircularTrajectoryNew_DW.obj.CalAccelA[0], 9U * sizeof(real_T));
    for (EX3_CircularTrajectoryNew_B.uElOffset1 = 0;
         EX3_CircularTrajectoryNew_B.uElOffset1 < 3;
         EX3_CircularTrajectoryNew_B.uElOffset1++) {
      EX3_CircularTrajectoryNew_B.VelocitytoPosition[EX3_CircularTrajectoryNew_B.uElOffset1]
        = ((EX3_CircularTrajectoryNew_B.b_c[3 *
            EX3_CircularTrajectoryNew_B.uElOffset1 + 1] * static_cast<real_T>
            (EX3_CircularTrajectoryNew_B.b_RegisterValue[1]) +
            EX3_CircularTrajectoryNew_B.b_c[3 *
           ...
           EX3_CircularTrajectoryNew_B.uElOffset1 + 2] * static_cast<real_T>
           (EX3_CircularTrajectoryNew_B.b_RegisterValue[2])) +
        EX3_CircularTrajectoryNew_DW.obj.CalAccelB[EX3_CircularTrajectoryNew_B.uElOffset1];
    }
    ...
    memcpy((void *)&EX3_CircularTrajectoryNew_B.SwappedDataBytes, (void *)
           &EX3_CircularTrajectoryNew_B.status, (uint32_T)((size_t)1 * sizeof
            (uint8_T)));
    EX3_CircularTrajectoryNew_B.status = MW_I2C_MasterWrite
      (EX3_CircularTrajectoryNew_DW.obj.i2cobj_MAG.MW_I2C_HANDLE, 28U,
       &EX3_CircularTrajectoryNew_B.SwappedDataBytes, 1U, true, false);
    if (0 == EX3_CircularTrajectoryNew_B.status) {
      MW_I2C_MasterRead
        (EX3_CircularTrajectoryNew_DW.obj.i2cobj_MAG.MW_I2C_HANDLE, 28U,
    ...
    memcpy(&EX3_CircularTrajectoryNew_B.b_c[0],
           &EX3_CircularTrajectoryNew_DW.obj.CalMagA[0], 9U * sizeof(real_T));
    for (EX3_CircularTrajectoryNew_B.uElOffset1 = 0;
         EX3_CircularTrajectoryNew_B.uElOffset1 < 3;
         EX3_CircularTrajectoryNew_B.uElOffset1++) {
      EX3_CircularTrajectoryNew_B.y5 = ((EX3_CircularTrajectoryNew_B.b_c[3 *
        EX3_CircularTrajectoryNew_B.uElOffset1 + 1] * static_cast<real_T>
        (EX3_CircularTrajectoryNew_B.b_RegisterValue[1]) +
        EX3_CircularTrajectoryNew_B.b_c[3 *
        EX3_CircularTrajectoryNew_B.uElOffset1] * static_cast<real_T>
        ...
        EX3_CircularTrajectoryNew_B.uElOffset1 + 2] * static_cast<real_T>
        (EX3_CircularTrajectoryNew_B.b_RegisterValue[2])) +
        EX3_CircularTrajectoryNew_DW.obj.CalMagB[EX3_CircularTrajectoryNew_B.uElOffset1];
      EX3_CircularTrajectoryNew_B.LSM9DS1IMUSensor_o3[EX3_CircularTrajectoryNew_B.uElOffset1]
        = EX3_CircularTrajectoryNew_B.y5 * 4.0 / 32768.0;
      EX3_CircularTrajectoryNew_B.x_ddot_a[EX3_CircularTrajectoryNew_B.uElOffset1]
        =
        EX3_CircularTrajectoryNew_B.x_ddot_a[EX3_CircularTrajectoryNew_B.uElOffset1]
        * 245.0 / 32768.0;
    ...
    if ((EX3_CircularTrajectoryNew_P.WhoAmI == 2.0) &&
        (EX3_CircularTrajectoryNew_P.simMode == 0.0)) {
      // Outputs for IfAction SubSystem: '<S6>/Change BLACK Behavior' incorporates:
      //   ActionPort: '<S169>/Action Port'

      // Gain: '<S169>/Gain'
      EX3_CircularTrajectoryNew_B.Gain_k[0] =
        EX3_CircularTrajectoryNew_P.Gain_Gain *
        EX3_CircularTrajectoryNew_B.x_ddot_a[0];
      EX3_CircularTrajectoryNew_B.Gain_k[1] =
        EX3_CircularTrajectoryNew_P.Gain_Gain *
        EX3_CircularTrajectoryNew_B.x_ddot_a[1];
      EX3_CircularTrajectoryNew_B.Gain_k[2] =
        EX3_CircularTrajectoryNew_P.Gain_Gain *
        EX3_CircularTrajectoryNew_B.x_ddot_a[2];
      ...
      if (EX3_CircularTrajectoryNew_DW.Univ_Time < 5.0) {
        // Outputs for IfAction SubSystem: '<S179>/Calculate Running Mean' incorporates:
        //   ActionPort: '<S182>/Action Port'

        EX3_Ci_CalculateRunningMean(EX3_CircularTrajectoryNew_B.Gain_k[0],
          &EX3_CircularTrajectoryNew_B.CalculateRunningMean,
          &EX3_CircularTrajectoryNew_DW.CalculateRunningMean);
        ...
        EX3_CircularTrajectoryNew_B.In1_hd = EX3_CircularTrajectoryNew_B.Gain_k
          [0];
      ...
      EX3_CircularTrajectoryNew_DW.BLACK_IMU_Q =
        EX3_CircularTrajectoryNew_B.In1_hd -
        EX3_CircularTrajectoryNew_B.CalculateRunningMean.Mean;

      // S-Function (sdspbiquad): '<S175>/Digital Filter' incorporates:
      //   Gain: '<S169>/Gain1'

      EX3_CircularTrajectoryNew_B.Sum6_l1 =
        (EX3_CircularTrajectoryNew_P.Gain1_Gain *
         EX3_CircularTrajectoryNew_B.VelocitytoPosition[0] * 0.29289321881345243
         - -1.3007071811330761E-16 *
         EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_e[0]) -
        0.17157287525380996 *
        EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_e[1];
      EX3_CircularTrajectoryNew_B.DigitalFilter_k[0] = (2.0 *
        EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_e[0] +
        EX3_CircularTrajectoryNew_B.Sum6_l1) +
        EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_e[1];
      EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_e[1] =
      ...
      EX3_CircularTrajectoryNew_B.Sum6_l1 =
        (EX3_CircularTrajectoryNew_P.Gain1_Gain *
         EX3_CircularTrajectoryNew_B.VelocitytoPosition[1] * 0.29289321881345243
         - -1.3007071811330761E-16 *
         EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_e[2]) -
        0.17157287525380996 *
        EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_e[3];
      EX3_CircularTrajectoryNew_B.DigitalFilter_k[1] = (2.0 *
        EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_e[2] +
        EX3_CircularTrajectoryNew_B.Sum6_l1) +
        EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_e[3];
      EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_e[3] =
      ...
      EX3_CircularTrajectoryNew_B.Sum6_l1 =
        (EX3_CircularTrajectoryNew_P.Gain1_Gain *
         EX3_CircularTrajectoryNew_B.VelocitytoPosition[2] * 0.29289321881345243
         - -1.3007071811330761E-16 *
         EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_e[4]) -
        0.17157287525380996 *
        EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_e[5];
      EX3_CircularTrajectoryNew_B.DigitalFilter_k[2] = (2.0 *
        EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_e[4] +
        EX3_CircularTrajectoryNew_B.Sum6_l1) +
        EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_e[5];
      EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_e[5] =
      ...
      if (EX3_CircularTrajectoryNew_DW.Univ_Time < 5.0) {
        ...
        EX3_Ci_CalculateRunningMean(EX3_CircularTrajectoryNew_B.DigitalFilter_k
          [0], &EX3_CircularTrajectoryNew_B.CalculateRunningMean_d,
          &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_d);
        ...
        EX3_CircularTrajectoryNew_B.In1_ic =
          EX3_CircularTrajectoryNew_B.DigitalFilter_k[0];
      ...
      if (EX3_CircularTrajectoryNew_DW.Univ_Time < 5.0) {
        ...
        EX3_Ci_CalculateRunningMean(EX3_CircularTrajectoryNew_B.DigitalFilter_k
          [1], &EX3_CircularTrajectoryNew_B.CalculateRunningMean_a,
          &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_a);
        ...
        EX3_CircularTrajectoryNew_B.In1_gs =
          EX3_CircularTrajectoryNew_B.DigitalFilter_k[1];
      ...
      if (EX3_CircularTrajectoryNew_DW.Univ_Time < 5.0) {
        ...
        EX3__CalculateRunningMean_a(EX3_CircularTrajectoryNew_B.DigitalFilter_k
          [2], &EX3_CircularTrajectoryNew_B.CalculateRunningMean_ab,
          &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_ab,
          &EX3_CircularTrajectoryNew_P.CalculateRunningMean_ab);
        ...
        EX3_CircularTrajectoryNew_B.In1_cd =
          EX3_CircularTrajectoryNew_B.DigitalFilter_k[2];
      ...
      EX3_Circu_ChangeOrientation(EX3_CircularTrajectoryNew_B.In1_ic -
        EX3_CircularTrajectoryNew_B.CalculateRunningMean_d.Mean,
        EX3_CircularTrajectoryNew_B.In1_gs -
        EX3_CircularTrajectoryNew_B.CalculateRunningMean_a.Mean,
        EX3_CircularTrajectoryNew_B.In1_cd -
        EX3_CircularTrajectoryNew_B.CalculateRunningMean_ab.Subtract,
        &EX3_CircularTrajectoryNew_B.sf_ChangeOrientation);

      // DataStoreWrite: '<S169>/RED_Px10'
      EX3_CircularTrajectoryNew_DW.BLACK_IMU_Ay_b =
        EX3_CircularTrajectoryNew_B.sf_ChangeOrientation.y[1];

      // DataStoreWrite: '<S169>/RED_Px11'
      EX3_CircularTrajectoryNew_DW.BLACK_IMU_Az_b =
        EX3_CircularTrajectoryNew_B.sf_ChangeOrientation.y[2];
      ...
      if (EX3_CircularTrajectoryNew_DW.Univ_Time < 5.0) {
        ...
        EX3_Ci_CalculateRunningMean(EX3_CircularTrajectoryNew_B.Gain_k[1],
          &EX3_CircularTrajectoryNew_B.CalculateRunningMean_e,
          &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_e);
        ...
        EX3_CircularTrajectoryNew_B.In1_ny = EX3_CircularTrajectoryNew_B.Gain_k
          [1];
      ...
      EX3_CircularTrajectoryNew_DW.BLACK_IMU_P =
        EX3_CircularTrajectoryNew_B.In1_ny -
        EX3_CircularTrajectoryNew_B.CalculateRunningMean_e.Mean;
      ...
      if (EX3_CircularTrajectoryNew_DW.Univ_Time < 5.0) {
        ...
        EX3_Ci_CalculateRunningMean(EX3_CircularTrajectoryNew_B.Gain_k[2],
          &EX3_CircularTrajectoryNew_B.CalculateRunningMean_h,
          &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_h);
        ...
        EX3_CircularTrajectoryNew_B.In1_jp = EX3_CircularTrajectoryNew_B.Gain_k
          [2];
      ...
      EX3_CircularTrajectoryNew_DW.BLACK_IMU_R =
        EX3_CircularTrajectoryNew_B.In1_jp -
        EX3_CircularTrajectoryNew_B.CalculateRunningMean_h.Mean;

      // MATLAB Function: '<S169>/Create Rotation Matrix' incorporates:
      //   DataStoreRead: '<S169>/Data Store Read'

      EX3_Ci_CreateRotationMatrix(EX3_CircularTrajectoryNew_DW.BLACK_Rz,
        &EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_fq);

      // DataStoreWrite: '<S169>/RED_Px4' incorporates:
      //   Product: '<S169>/Rotate F_b to F_I'

      EX3_CircularTrajectoryNew_DW.BLACK_IMU_Ax_I =
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_fq.C_Ib[0] *
        EX3_CircularTrajectoryNew_B.sf_ChangeOrientation.y[0] +
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_fq.C_Ib[2] *
        EX3_CircularTrajectoryNew_B.sf_ChangeOrientation.y[1];
      ...
      EX3_CircularTrajectoryNew_DW.BLACK_IMU_Ay_I =
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_fq.C_Ib[1] *
        EX3_CircularTrajectoryNew_B.sf_ChangeOrientation.y[0] +
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_fq.C_Ib[3] *
        EX3_CircularTrajectoryNew_B.sf_ChangeOrientation.y[1];

      // DataStoreWrite: '<S169>/RED_Px6'
      EX3_CircularTrajectoryNew_DW.BLACK_IMU_Ax_b =
        EX3_CircularTrajectoryNew_B.sf_ChangeOrientation.y[0];
      EX3_CircularTrajector_AHRS2(EX3_CircularTrajectoryNew_B.DigitalFilter_k,
        EX3_CircularTrajectoryNew_B.Gain_k,
        EX3_CircularTrajectoryNew_B.LSM9DS1IMUSensor_o3,
        &EX3_CircularTrajectoryNew_B.AHRS2, &EX3_CircularTrajectoryNew_DW.AHRS2,
        &EX3_CircularTrajectoryNew_P.AHRS2);

      // DataStoreWrite: '<S169>/RED_Px7'
      EX3_CircularTrajectoryNew_DW.BLACK_AHRS_Q =
        EX3_CircularTrajectoryNew_B.AHRS2.AHRS2_o2[0];

      // DataStoreWrite: '<S169>/RED_Px8'
      EX3_CircularTrajectoryNew_DW.BLACK_AHRS_P =
        EX3_CircularTrajectoryNew_B.AHRS2.AHRS2_o2[1];

      // DataStoreWrite: '<S169>/RED_Px9'
      EX3_CircularTrajectoryNew_DW.BLACK_AHRS_R =
        EX3_CircularTrajectoryNew_B.AHRS2.AHRS2_o2[2];
      ...
      EX3_CircularTrajectoryNew_B.rtb_Compare_p =
        (EX3_CircularTrajectoryNew_B.In1_jp ==
         EX3_CircularTrajectoryNew_P.Constant_Value_h);
      ...
      if (EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_IC_LO_i != 0) {
        EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_DSTAT_f =
          EX3_CircularTrajectoryNew_DW.BLACK_Rz;
      }

      if ((EX3_CircularTrajectoryNew_B.rtb_Compare_p &&
           (EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_PrevR_o <= 0)) ||
          ((!EX3_CircularTrajectoryNew_B.rtb_Compare_p) &&
           (EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_PrevR_o == 1)))
      {
        EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_DSTAT_f =
          EX3_CircularTrajectoryNew_DW.BLACK_Rz;
      }
      ...
      EX3_CircularTrajectoryNew_DW.BLACK_IMU_Psi =
        EX3_CircularTrajectoryNew_P.DiscreteTimeIntegrator1_gainval *
        EX3_CircularTrajectoryNew_DW.BLACK_IMU_R +
        EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_DSTAT_f;
      ...
      EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_IC_LO_i = 0U;
      EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_DSTAT_f =
        EX3_CircularTrajectoryNew_DW.BLACK_IMU_Psi;
      EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_PrevR_o =
        static_cast<int8_T>(EX3_CircularTrajectoryNew_B.rtb_Compare_p);
    ...
    if ((EX3_CircularTrajectoryNew_P.WhoAmI == 3.0) &&
      ...
      // Gain: '<S170>/Gain'
      EX3_CircularTrajectoryNew_B.Gain_o[0] =
        EX3_CircularTrajectoryNew_P.Gain_Gain_e *
        EX3_CircularTrajectoryNew_B.x_ddot_a[0];
      EX3_CircularTrajectoryNew_B.Gain_o[1] =
        EX3_CircularTrajectoryNew_P.Gain_Gain_e *
        EX3_CircularTrajectoryNew_B.x_ddot_a[1];
      EX3_CircularTrajectoryNew_B.Gain_o[2] =
        EX3_CircularTrajectoryNew_P.Gain_Gain_e *
        EX3_CircularTrajectoryNew_B.x_ddot_a[2];
      ...
      if (EX3_CircularTrajectoryNew_DW.Univ_Time < 5.0) {
        ...
        EX3_Ci_CalculateRunningMean(EX3_CircularTrajectoryNew_B.Gain_o[0],
          &EX3_CircularTrajectoryNew_B.CalculateRunningMean_c,
          &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_c);
      ...
      EX3_CircularTrajectoryNew_B.Sum6_l1 =
        (EX3_CircularTrajectoryNew_P.Gain1_Gain_e *
         EX3_CircularTrajectoryNew_B.VelocitytoPosition[0] * 0.29289321881345243
         - -1.3007071811330761E-16 *
         EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_n[0]) -
        0.17157287525380996 *
        EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_n[1];
      EX3_CircularTrajectoryNew_B.DigitalFilter_n[0] = (2.0 *
        EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_n[0] +
        EX3_CircularTrajectoryNew_B.Sum6_l1) +
        EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_n[1];
      EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_n[1] =
      ...
      EX3_CircularTrajectoryNew_B.Sum6_l1 =
        (EX3_CircularTrajectoryNew_P.Gain1_Gain_e *
         EX3_CircularTrajectoryNew_B.VelocitytoPosition[1] * 0.29289321881345243
         - -1.3007071811330761E-16 *
         EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_n[2]) -
        0.17157287525380996 *
        EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_n[3];
      EX3_CircularTrajectoryNew_B.DigitalFilter_n[1] = (2.0 *
        EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_n[2] +
        EX3_CircularTrajectoryNew_B.Sum6_l1) +
        EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_n[3];
      EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_n[3] =
      ...
      EX3_CircularTrajectoryNew_B.Sum6_l1 =
        (EX3_CircularTrajectoryNew_P.Gain1_Gain_e *
         EX3_CircularTrajectoryNew_B.VelocitytoPosition[2] * 0.29289321881345243
         - -1.3007071811330761E-16 *
         EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_n[4]) -
        0.17157287525380996 *
        EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_n[5];
      EX3_CircularTrajectoryNew_B.DigitalFilter_n[2] = (2.0 *
        EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_n[4] +
        EX3_CircularTrajectoryNew_B.Sum6_l1) +
        EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_n[5];
      EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES_n[5] =
      ...
      if (EX3_CircularTrajectoryNew_DW.Univ_Time < 5.0) {
        ...
        EX3_Ci_CalculateRunningMean(EX3_CircularTrajectoryNew_B.DigitalFilter_n
          [0], &EX3_CircularTrajectoryNew_B.CalculateRunningMean_j,
          &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_j);
        ...
        EX3_CircularTrajectoryNew_B.In1_le =
          EX3_CircularTrajectoryNew_B.DigitalFilter_n[0];
      ...
      if (EX3_CircularTrajectoryNew_DW.Univ_Time < 5.0) {
        ...
        EX3_Ci_CalculateRunningMean(EX3_CircularTrajectoryNew_B.DigitalFilter_n
          [1], &EX3_CircularTrajectoryNew_B.CalculateRunningMean_b,
          &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_b);
        ...
        EX3_CircularTrajectoryNew_B.In1_b1 =
          EX3_CircularTrajectoryNew_B.DigitalFilter_n[1];
      ...
      if (EX3_CircularTrajectoryNew_DW.Univ_Time < 5.0) {
        ...
        EX3__CalculateRunningMean_a(EX3_CircularTrajectoryNew_B.DigitalFilter_n
          [2], &EX3_CircularTrajectoryNew_B.CalculateRunningMean_o,
          &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_o,
          &EX3_CircularTrajectoryNew_P.CalculateRunningMean_o);
        ...
        EX3_CircularTrajectoryNew_B.In1_ai =
          EX3_CircularTrajectoryNew_B.DigitalFilter_n[2];
      ...
      EX3_Circu_ChangeOrientation(EX3_CircularTrajectoryNew_B.In1_le -
        EX3_CircularTrajectoryNew_B.CalculateRunningMean_j.Mean,
        EX3_CircularTrajectoryNew_B.In1_b1 -
        EX3_CircularTrajectoryNew_B.CalculateRunningMean_b.Mean,
        EX3_CircularTrajectoryNew_B.In1_ai -
        EX3_CircularTrajectoryNew_B.CalculateRunningMean_o.Subtract,
        &EX3_CircularTrajectoryNew_B.sf_ChangeOrientation_p);
      ...
      if (EX3_CircularTrajectoryNew_DW.Univ_Time < 5.0) {
        ...
        EX3_Ci_CalculateRunningMean(EX3_CircularTrajectoryNew_B.Gain_o[1],
          &EX3_CircularTrajectoryNew_B.CalculateRunningMean_f,
          &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_f);
      ...
      if (EX3_CircularTrajectoryNew_DW.Univ_Time < 5.0) {
        ...
        EX3_Ci_CalculateRunningMean(EX3_CircularTrajectoryNew_B.Gain_o[2],
          &EX3_CircularTrajectoryNew_B.CalculateRunningMean_l,
          &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_l);
        ...
        EX3_CircularTrajectoryNew_B.In1_hy = EX3_CircularTrajectoryNew_B.Gain_o
          [2];
      ...
      EX3_Ci_CreateRotationMatrix(EX3_CircularTrajectoryNew_DW.BLUE_Rz,
        &EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_h1);
      EX3_CircularTrajector_AHRS2(EX3_CircularTrajectoryNew_B.DigitalFilter_n,
        EX3_CircularTrajectoryNew_B.Gain_o,
        EX3_CircularTrajectoryNew_B.LSM9DS1IMUSensor_o3,
        &EX3_CircularTrajectoryNew_B.AHRS2_p,
        &EX3_CircularTrajectoryNew_DW.AHRS2_p,
        &EX3_CircularTrajectoryNew_P.AHRS2_p);

      // RelationalOperator: '<S220>/Compare' incorporates:
      //   Constant: '<S220>/Constant'

      EX3_CircularTrajectoryNew_B.rtb_Compare_p =
        (EX3_CircularTrajectoryNew_B.In1_hy ==
         EX3_CircularTrajectoryNew_P.Constant_Value_d);

      // DiscreteIntegrator: '<S212>/Discrete-Time Integrator1' incorporates:
      //   DataStoreRead: '<S212>/Data Store Read1'

      if (EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_IC_LO_f != 0) {
        EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_DSTAT_k =
          EX3_CircularTrajectoryNew_DW.BLUE_Rz;
      }

      if ((EX3_CircularTrajectoryNew_B.rtb_Compare_p &&
           (EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_PrevR_h <= 0)) ||
          ((!EX3_CircularTrajectoryNew_B.rtb_Compare_p) &&
           (EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_PrevR_h == 1)))
      {
        EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_DSTAT_k =
          EX3_CircularTrajectoryNew_DW.BLUE_Rz;
      }
      ...
      EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_IC_LO_f = 0U;
      EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_DSTAT_k +=
        (EX3_CircularTrajectoryNew_B.In1_hy -
         EX3_CircularTrajectoryNew_B.CalculateRunningMean_l.Mean) *
        EX3_CircularTrajectoryNew_P.DiscreteTimeIntegrator1_gainv_d;
      EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_PrevR_h =
        static_cast<int8_T>(EX3_CircularTrajectoryNew_B.rtb_Compare_p);
    ...
    if ((EX3_CircularTrajectoryNew_P.WhoAmI == 1.0) &&
      ...
      // Gain: '<S171>/Gain'
      EX3_CircularTrajectoryNew_B.Gain[0] =
        EX3_CircularTrajectoryNew_P.Gain_Gain_a *
        EX3_CircularTrajectoryNew_B.x_ddot_a[0];
      EX3_CircularTrajectoryNew_B.Gain[1] =
        EX3_CircularTrajectoryNew_P.Gain_Gain_a *
        EX3_CircularTrajectoryNew_B.x_ddot_a[1];
      EX3_CircularTrajectoryNew_B.Gain[2] =
        EX3_CircularTrajectoryNew_P.Gain_Gain_a *
        EX3_CircularTrajectoryNew_B.x_ddot_a[2];
      ...
      if (EX3_CircularTrajectoryNew_DW.Univ_Time < 5.0) {
        ...
        EX3_Ci_CalculateRunningMean(EX3_CircularTrajectoryNew_B.Gain[0],
          &EX3_CircularTrajectoryNew_B.CalculateRunningMean_oo,
          &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_oo);
        ...
        EX3_CircularTrajectoryNew_B.In1_lm = EX3_CircularTrajectoryNew_B.Gain[0];
      ...
      EX3_CircularTrajectoryNew_DW.RED_IMU_Q =
        EX3_CircularTrajectoryNew_B.In1_lm -
        EX3_CircularTrajectoryNew_B.CalculateRunningMean_oo.Mean;
      EX3_CircularTrajectoryNew_B.VelocitytoPosition[0] *=
        EX3_CircularTrajectoryNew_P.Gain1_Gain_c;
      EX3_CircularTrajectoryNew_B.VelocitytoPosition[1] *=
        EX3_CircularTrajectoryNew_P.Gain1_Gain_c;
      ...
      EX3_CircularTrajectoryNew_B.Sum6_l1 = (0.29289321881345243 *
        EX3_CircularTrajectoryNew_B.VelocitytoPosition[0] -
        -1.3007071811330761E-16 *
        EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES[0]) -
        0.17157287525380996 *
        EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES[1];
      EX3_CircularTrajectoryNew_B.DigitalFilter[0] = (2.0 *
        EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES[0] +
        EX3_CircularTrajectoryNew_B.Sum6_l1) +
        EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES[1];
      EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES[1] =
      ...
      EX3_CircularTrajectoryNew_B.Sum6_l1 = (0.29289321881345243 *
        EX3_CircularTrajectoryNew_B.VelocitytoPosition[1] -
        -1.3007071811330761E-16 *
        EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES[2]) -
        0.17157287525380996 *
        EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES[3];
      EX3_CircularTrajectoryNew_B.DigitalFilter[1] = (2.0 *
        EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES[2] +
        EX3_CircularTrajectoryNew_B.Sum6_l1) +
        EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES[3];
      EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES[3] =
      ...
      EX3_CircularTrajectoryNew_B.Sum6_l1 =
        (EX3_CircularTrajectoryNew_P.Gain1_Gain_c *
         EX3_CircularTrajectoryNew_B.VelocitytoPosition[2] * 0.29289321881345243
         - -1.3007071811330761E-16 *
         EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES[4]) -
        0.17157287525380996 *
        EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES[5];
      EX3_CircularTrajectoryNew_B.DigitalFilter[2] = (2.0 *
        EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES[4] +
        EX3_CircularTrajectoryNew_B.Sum6_l1) +
        EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES[5];
      EX3_CircularTrajectoryNew_DW.DigitalFilter_FILT_STATES[5] =
      ...
      if (EX3_CircularTrajectoryNew_DW.Univ_Time < 5.0) {
        ...
        EX3_Ci_CalculateRunningMean(EX3_CircularTrajectoryNew_B.DigitalFilter[0],
          &EX3_CircularTrajectoryNew_B.CalculateRunningMean_j1,
          &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_j1);
        ...
        EX3_CircularTrajectoryNew_B.In1_gy =
          EX3_CircularTrajectoryNew_B.DigitalFilter[0];
      ...
      if (EX3_CircularTrajectoryNew_DW.Univ_Time < 5.0) {
        ...
        EX3_Ci_CalculateRunningMean(EX3_CircularTrajectoryNew_B.DigitalFilter[1],
          &EX3_CircularTrajectoryNew_B.CalculateRunningMean_jr,
          &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_jr);
        ...
        EX3_CircularTrajectoryNew_B.In1_e5 =
          EX3_CircularTrajectoryNew_B.DigitalFilter[1];
      ...
      if (EX3_CircularTrajectoryNew_DW.Univ_Time < 5.0) {
        ...
        EX3__CalculateRunningMean_a(EX3_CircularTrajectoryNew_B.DigitalFilter[2],
          &EX3_CircularTrajectoryNew_B.CalculateRunningMean_cf,
          &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_cf,
          &EX3_CircularTrajectoryNew_P.CalculateRunningMean_cf);
        ...
        EX3_CircularTrajectoryNew_B.In1_gv =
          EX3_CircularTrajectoryNew_B.DigitalFilter[2];
      ...
      EX3_Circu_ChangeOrientation(EX3_CircularTrajectoryNew_B.In1_gy -
        EX3_CircularTrajectoryNew_B.CalculateRunningMean_j1.Mean,
        EX3_CircularTrajectoryNew_B.In1_e5 -
        EX3_CircularTrajectoryNew_B.CalculateRunningMean_jr.Mean,
        EX3_CircularTrajectoryNew_B.In1_gv -
        EX3_CircularTrajectoryNew_B.CalculateRunningMean_cf.Subtract,
        &EX3_CircularTrajectoryNew_B.sf_ChangeOrientation_b);

      // DataStoreWrite: '<S171>/RED_Px10'
      EX3_CircularTrajectoryNew_DW.RED_IMU_Ax_b =
        EX3_CircularTrajectoryNew_B.sf_ChangeOrientation_b.y[0];

      // DataStoreWrite: '<S171>/RED_Px11'
      EX3_CircularTrajectoryNew_DW.RED_IMU_Ay_b =
        EX3_CircularTrajectoryNew_B.sf_ChangeOrientation_b.y[1];

      // DataStoreWrite: '<S171>/RED_Px12'
      EX3_CircularTrajectoryNew_DW.RED_IMU_Az_b =
        EX3_CircularTrajectoryNew_B.sf_ChangeOrientation_b.y[2];
      ...
      if (EX3_CircularTrajectoryNew_DW.Univ_Time < 5.0) {
        ...
        EX3_Ci_CalculateRunningMean(EX3_CircularTrajectoryNew_B.Gain[1],
          &EX3_CircularTrajectoryNew_B.CalculateRunningMean_om,
          &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_om);
        ...
        EX3_CircularTrajectoryNew_B.In1_cx = EX3_CircularTrajectoryNew_B.Gain[1];
      ...
      EX3_CircularTrajectoryNew_DW.RED_IMU_P =
        EX3_CircularTrajectoryNew_B.In1_cx -
        EX3_CircularTrajectoryNew_B.CalculateRunningMean_om.Mean;
      ...
      if (EX3_CircularTrajectoryNew_DW.Univ_Time < 5.0) {
        ...
        EX3_Ci_CalculateRunningMean(EX3_CircularTrajectoryNew_B.Gain[2],
          &EX3_CircularTrajectoryNew_B.CalculateRunningMean_et,
          &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_et);
        ...
        EX3_CircularTrajectoryNew_B.In1_f1 = EX3_CircularTrajectoryNew_B.Gain[2];
      ...
      EX3_CircularTrajectoryNew_DW.RED_IMU_R =
        EX3_CircularTrajectoryNew_B.In1_f1 -
        EX3_CircularTrajectoryNew_B.CalculateRunningMean_et.Mean;

      // MATLAB Function: '<S171>/Create Rotation Matrix' incorporates:
      //   DataStoreRead: '<S171>/Data Store Read'

      EX3_Ci_CreateRotationMatrix(EX3_CircularTrajectoryNew_DW.RED_Rz,
        &EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_k);

      // DataStoreWrite: '<S171>/RED_Px4' incorporates:
      //   Product: '<S171>/Rotate F_b to F_I'

      EX3_CircularTrajectoryNew_DW.RED_IMU_Ax_I =
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_k.C_Ib[0] *
        EX3_CircularTrajectoryNew_B.sf_ChangeOrientation_b.y[0] +
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_k.C_Ib[2] *
        EX3_CircularTrajectoryNew_B.sf_ChangeOrientation_b.y[1];
      ...
      EX3_CircularTrajectoryNew_DW.RED_IMU_Ay_I =
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_k.C_Ib[1] *
        EX3_CircularTrajectoryNew_B.sf_ChangeOrientation_b.y[0] +
        EX3_CircularTrajectoryNew_B.sf_CreateRotationMatrix_k.C_Ib[3] *
        EX3_CircularTrajectoryNew_B.sf_ChangeOrientation_b.y[1];
      EX3_CircularTrajector_AHRS2(EX3_CircularTrajectoryNew_B.DigitalFilter,
        EX3_CircularTrajectoryNew_B.Gain,
        EX3_CircularTrajectoryNew_B.LSM9DS1IMUSensor_o3,
        &EX3_CircularTrajectoryNew_B.AHRS2_pn,
        &EX3_CircularTrajectoryNew_DW.AHRS2_pn,
        &EX3_CircularTrajectoryNew_P.AHRS2_pn);

      // DataStoreWrite: '<S171>/RED_Px7'
      EX3_CircularTrajectoryNew_DW.RED_AHRS_P =
        EX3_CircularTrajectoryNew_B.AHRS2_pn.AHRS2_o2[1];

      // DataStoreWrite: '<S171>/RED_Px8'
      EX3_CircularTrajectoryNew_DW.RED_AHRS_Q =
        EX3_CircularTrajectoryNew_B.AHRS2_pn.AHRS2_o2[0];

      // DataStoreWrite: '<S171>/RED_Px9'
      EX3_CircularTrajectoryNew_DW.RED_AHRS_R =
        EX3_CircularTrajectoryNew_B.AHRS2_pn.AHRS2_o2[2];
      ...
      EX3_CircularTrajectoryNew_B.rtb_Compare_p =
        (EX3_CircularTrajectoryNew_B.In1_f1 ==
         EX3_CircularTrajectoryNew_P.Constant_Value_k);
      ...
      if (EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_IC_LO_g != 0) {
        EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_DSTAT_h =
          EX3_CircularTrajectoryNew_DW.RED_Rz;
      }

      if ((EX3_CircularTrajectoryNew_B.rtb_Compare_p &&
           (EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_PrevR_f <= 0)) ||
          ((!EX3_CircularTrajectoryNew_B.rtb_Compare_p) &&
           (EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_PrevR_f == 1)))
      {
        EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_DSTAT_h =
          EX3_CircularTrajectoryNew_DW.RED_Rz;
      }
      ...
      EX3_CircularTrajectoryNew_DW.RED_IMU_Psi =
        EX3_CircularTrajectoryNew_P.DiscreteTimeIntegrator1_gainv_k *
        EX3_CircularTrajectoryNew_DW.RED_IMU_R +
        EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_DSTAT_h;
      ...
      EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_IC_LO_g = 0U;
      EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_DSTAT_h =
        EX3_CircularTrajectoryNew_DW.RED_IMU_Psi;
      EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_PrevR_f =
        static_cast<int8_T>(EX3_CircularTrajectoryNew_B.rtb_Compare_p);
    ...
    EX3_CircularTrajectoryNew_B.SetUniversalTimeIfthisisasimula =
      EX3_CircularTrajectoryNew_M->Timing.t[0];

    // MATLABSystem: '<Root>/Initialization Block for Position Control'
    if (EX3_CircularTrajectoryNew_DW.obj_i.P_GAIN !=
        EX3_CircularTrajectoryNew_P.InitializationBlockforPositionC) {
      EX3_CircularTrajectoryNew_DW.obj_i.P_GAIN =
        EX3_CircularTrajectoryNew_P.InitializationBlockforPositionC;
    }

    if (EX3_CircularTrajectoryNew_DW.obj_i.I_GAIN !=
        EX3_CircularTrajectoryNew_P.InitializationBlockforPositio_b) {
      EX3_CircularTrajectoryNew_DW.obj_i.I_GAIN =
        EX3_CircularTrajectoryNew_P.InitializationBlockforPositio_b;
    }

    if (EX3_CircularTrajectoryNew_DW.obj_i.D_GAIN !=
        EX3_CircularTrajectoryNew_P.InitializationBlockforPositio_g) {
      EX3_CircularTrajectoryNew_DW.obj_i.D_GAIN =
        EX3_CircularTrajectoryNew_P.InitializationBlockforPositio_g;
    }

    if (EX3_CircularTrajectoryNew_DW.obj_i.MAX_POSITION !=
        EX3_CircularTrajectoryNew_P.InitializationBlockforPositio_i) {
      EX3_CircularTrajectoryNew_DW.obj_i.MAX_POSITION =
        EX3_CircularTrajectoryNew_P.InitializationBlockforPositio_i;
    }

    if (EX3_CircularTrajectoryNew_DW.obj_i.MIN_POSITION !=
        EX3_CircularTrajectoryNew_P.InitializationBlockforPositio_k) {
      EX3_CircularTrajectoryNew_DW.obj_i.MIN_POSITION =
        EX3_CircularTrajectoryNew_P.InitializationBlockforPositio_k;
    }

    if (EX3_CircularTrajectoryNew_DW.obj_i.MOVE_TIME !=
        EX3_CircularTrajectoryNew_P.InitializationBlockforPositi_ba) {
      EX3_CircularTrajectoryNew_DW.obj_i.MOVE_TIME =
        EX3_CircularTrajectoryNew_P.InitializationBlockforPositi_ba;
    }
  ...
  // Matfile logging
  rt_UpdateTXYLogVars(EX3_CircularTrajectoryNew_M->rtwLogInfo,
                      (EX3_CircularTrajectoryNew_M->Timing.t));

  {
    char_T *sErr;

    // Update for If: '<Root>/Separate Phases'
    switch (EX3_CircularTrajectoryNew_DW.SeparatePhases_ActiveSubsystem) {
     case 0:
     case 1:
     case 6:
      break;
     ...
     case 2:
      ...
      if (EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhether_dy == 0) {
        // Update for IfAction SubSystem: '<S10>/Change BLACK Behavior' incorporates:
        //   ActionPort: '<S274>/Action Port'

        // Update for Delay: '<S284>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_ns = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_k =
          EX3_CircularTrajectoryNew_B.Subtract_ou;

        // Update for Delay: '<S286>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_k1 = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_d =
          EX3_CircularTrajectoryNew_B.Subtract1_m0;

        // Update for Delay: '<S282>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_ep = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_j =
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction4.e_out;
      ...
      if (EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhether_jm == 0) {
        // Update for IfAction SubSystem: '<S10>/Change BLUE Behavior' incorporates:
        //   ActionPort: '<S275>/Action Port'

        // Update for Delay: '<S297>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_dy = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_fb =
          EX3_CircularTrajectoryNew_B.Subtract_j;

        // Update for Delay: '<S299>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_hf = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_n1 =
          EX3_CircularTrajectoryNew_B.Subtract1_o;

        // Update for Delay: '<S295>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_kl = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_cq =
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_c.e_out;
      ...
      if (EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhether_aj == 0) {
        // Update for IfAction SubSystem: '<S10>/Change RED Behavior' incorporates:
        //   ActionPort: '<S276>/Action Port'

        // Update for Delay: '<S308>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_ji = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_ct =
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_b.e_out;

        // Update for Delay: '<S310>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_a1 = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_bm =
          EX3_CircularTrajectoryNew_B.Subtract_f;

        // Update for Delay: '<S312>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_o0 = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_pr =
          EX3_CircularTrajectoryNew_B.Subtract1_dr;
     ...
     case 3:
      ...
      if (EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhethero_p == 0) {
        // Update for IfAction SubSystem: '<S11>/Change BLACK Behavior' incorporates:
        //   ActionPort: '<S317>/Action Port'

        // Update for If: '<S317>/Experiment Sub-Phases'
        switch (EX3_CircularTrajectoryNew_DW.ExperimentSubPhases_ActiveSub_o) {
         case 0:
          // Update for IfAction SubSystem: '<S317>/Sub-Phase #1' incorporates:
          //   ActionPort: '<S321>/Action Port'

          // Update for Delay: '<S332>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_ot = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_g =
            EX3_CircularTrajectoryNew_B.Subtract_oi;

          // Update for Delay: '<S334>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_k = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_pe =
            EX3_CircularTrajectoryNew_B.Subtract1_d2;

          // Update for Delay: '<S330>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_l = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_lu =
            EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_d.e_out;
         ...
         case 3:
          ...
          EX3_CircularTrajectoryNew_DW.icLoad_fr = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_hp =
            EX3_CircularTrajectoryNew_B.Subtract_a;

          // Update for Delay: '<S351>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_me = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_ha =
            EX3_CircularTrajectoryNew_B.Subtract1_h;

          // Update for Delay: '<S347>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_ey = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_li =
            EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_dk.e_out;
      ...
      if (EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhether_pu == 0) {
        // Update for IfAction SubSystem: '<S11>/Change BLUE Behavior' incorporates:
        //   ActionPort: '<S318>/Action Port'

        // Update for If: '<S318>/Experiment Sub-Phases'
        switch (EX3_CircularTrajectoryNew_DW.ExperimentSubPhases_ActiveSub_e) {
         case 0:
          // Update for IfAction SubSystem: '<S318>/Sub-Phase #1' incorporates:
          //   ActionPort: '<S356>/Action Port'

          EX3_Circul_SubPhase1_Update(&EX3_CircularTrajectoryNew_B.SubPhase1_a,
            &EX3_CircularTrajectoryNew_DW.SubPhase1_a);
         ...
         case 3:
          ...
          EX3_Circul_SubPhase1_Update(&EX3_CircularTrajectoryNew_B.SubPhase4_f,
            &EX3_CircularTrajectoryNew_DW.SubPhase4_f);
      ...
      if (EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhether_au == 0) {
        // Update for IfAction SubSystem: '<S11>/Change RED Behavior' incorporates:
        //   ActionPort: '<S319>/Action Port'

        // Update for If: '<S319>/Experiment Sub-Phases'
        if (EX3_CircularTrajectoryNew_DW.ExperimentSubPhases_ActiveSubsy == 3) {
          // Update for IfAction SubSystem: '<S319>/Sub-Phase #4' incorporates:
          //   ActionPort: '<S390>/Action Port'

          // Update for Delay: '<S400>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_jl = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_c =
            EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_n.e_out;

          // Update for Delay: '<S402>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_n = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_mu =
            EX3_CircularTrajectoryNew_B.Subtract_b;

          // Update for Delay: '<S404>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_g = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_il =
            EX3_CircularTrajectoryNew_B.Subtract1_m;
     ...
     case 4:
      ...
      if (EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhethero_d == 0) {
        // Update for IfAction SubSystem: '<S12>/Change BLACK Behavior' incorporates:
        //   ActionPort: '<S410>/Action Port'

        // Update for Delay: '<S420>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_dq = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_lt =
          EX3_CircularTrajectoryNew_B.Subtract_d;

        // Update for Delay: '<S422>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_h = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_im =
          EX3_CircularTrajectoryNew_B.Subtract1_d;

        // Update for Delay: '<S418>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_o = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_f =
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_l.e_out;
      ...
      if (EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhether_jc == 0) {
        // Update for IfAction SubSystem: '<S12>/Change BLUE Behavior' incorporates:
        //   ActionPort: '<S411>/Action Port'

        E_ChangeBLUEBehavior_Update
          (&EX3_CircularTrajectoryNew_B.ChangeBLUEBehavior_gj,
           &EX3_CircularTrajectoryNew_DW.ChangeBLUEBehavior_gj);
      ...
      if (EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhether_a4 == 0) {
        // Update for IfAction SubSystem: '<S12>/Change RED Behavior' incorporates:
        //   ActionPort: '<S412>/Action Port'

        // Update for Delay: '<S444>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_dh = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_i =
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_na.e_out;

        // Update for Delay: '<S446>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_a2 = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_h =
          EX3_CircularTrajectoryNew_B.Subtract_l;

        // Update for Delay: '<S448>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_f = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_l =
          EX3_CircularTrajectoryNew_B.Subtract1_g;
     ...
     case 5:
      ...
      if (EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhethero_b == 0) {
        // Update for IfAction SubSystem: '<S13>/Change BLACK Behavior' incorporates:
        //   ActionPort: '<S453>/Action Port'

        // Update for Delay: '<S463>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_e = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_o =
          EX3_CircularTrajectoryNew_B.Subtract_o;

        // Update for Delay: '<S465>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_m = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_p =
          EX3_CircularTrajectoryNew_B.Subtract1_c;

        // Update for Delay: '<S461>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_d = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_b =
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_de.e_out;
      ...
      if (EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhethero_n == 0) {
      ...
      if (EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhethero_j == 0) {
        // Update for IfAction SubSystem: '<S13>/Change RED Behavior' incorporates:
        //   ActionPort: '<S455>/Action Port'

        // Update for Delay: '<S489>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE =
          EX3_CircularTrajectoryNew_B.Subtract;

        // Update for Delay: '<S491>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_j = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_m =
          EX3_CircularTrajectoryNew_B.Subtract1;

        // Update for Delay: '<S487>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_a = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_n =
          EX3_CircularTrajectoryNew_B.sf_MATLABFunction4_df.e_out;
    ...
    if (EX3_CircularTrajectoryNew_DW.Ifperforminganexperimentgrabthe == 0) {
      ...
      switch (EX3_CircularTrajectoryNew_DW.Checkwhetherbothplatformsarebei) {
       case 0:
        ...
        EX3_CircularTrajectoryNew_DW.icLoad_dr = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_ln =
          EX3_CircularTrajectoryNew_B.In1_b4[4];

        // Update for Delay: '<S142>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_mq = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_pv =
          EX3_CircularTrajectoryNew_B.dividebydeltaT_p;

        // Update for Delay: '<S148>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_lr = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_mk =
          EX3_CircularTrajectoryNew_B.In1_b4[5];

        // Update for Delay: '<S143>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_b = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_le =
          EX3_CircularTrajectoryNew_B.dividebydeltaT_nx;

        // Update for Delay: '<S149>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_aa = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_de =
          EX3_CircularTrajectoryNew_B.Unwrap1_c;

        // Update for Delay: '<S144>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_cw = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_lu2 =
          EX3_CircularTrajectoryNew_B.dividebydeltaT_dx;

        // Update for Delay: '<S141>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_nsj = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_b3 =
          EX3_CircularTrajectoryNew_B.In1_b4[1];

        // Update for Delay: '<S150>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_lrw = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_ng =
          EX3_CircularTrajectoryNew_B.dividebydeltaT_ph;

        // Update for Delay: '<S145>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_a2d = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_m3 =
          EX3_CircularTrajectoryNew_B.In1_b4[2];

        // Update for Delay: '<S151>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_mp = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_fs =
          EX3_CircularTrajectoryNew_B.dividebydeltaT_pf;

        // Update for Delay: '<S146>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_gb = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_c4 =
          EX3_CircularTrajectoryNew_B.Unwrap_n;

        // Update for Delay: '<S152>/Delay1'
        EX3_CircularTrajectoryNew_DW.icLoad_i = 0U;
        EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_cz =
          EX3_CircularTrajectoryNew_B.dividebydeltaT_hu;
       ...
       case 1:
        ...
        if (EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhether_d1 == 0) {
          // Update for IfAction SubSystem: '<S76>/Obtain BLACK States' incorporates:
          //   ActionPort: '<S79>/Action Port'

          // Update for Delay: '<S87>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_ky1 = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_nw =
            EX3_CircularTrajectoryNew_B.UDPReceive_o1[4];

          // Update for Delay: '<S82>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_of = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_gx =
            EX3_CircularTrajectoryNew_B.dividebydeltaT_m;

          // Update for Delay: '<S88>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_oi = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_ct1 =
            EX3_CircularTrajectoryNew_B.UDPReceive_o1[5];

          // Update for Delay: '<S83>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_hb = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_i0 =
            EX3_CircularTrajectoryNew_B.dividebydeltaT_me;

          // Update for Delay: '<S89>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_ap = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_n0 =
            EX3_CircularTrajectoryNew_B.Unwrap1_l;

          // Update for Delay: '<S84>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_hc = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_da =
            EX3_CircularTrajectoryNew_B.dividebydeltaT_g;

          // Update for Delay: '<S81>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_nn = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_m1 =
            EX3_CircularTrajectoryNew_B.UDPReceive_o1[1];

          // Update for Delay: '<S90>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_gc = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_bo =
            EX3_CircularTrajectoryNew_B.dividebydeltaT_hw;

          // Update for Delay: '<S85>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_d0 = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_ed =
            EX3_CircularTrajectoryNew_B.UDPReceive_o1[2];

          // Update for Delay: '<S91>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_a1a = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_k5 =
            EX3_CircularTrajectoryNew_B.dividebydeltaT_d;

          // Update for Delay: '<S86>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_ms = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_p4 =
            EX3_CircularTrajectoryNew_B.Unwrap_l;

          // Update for Delay: '<S92>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_gi = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_fr =
            EX3_CircularTrajectoryNew_B.dividebydeltaT_n;
        ...
        if (EX3_CircularTrajectoryNew_DW.ThisIFblockdetermineswhethero_o == 0) {
          ...
          EX3_CircularTrajectoryNew_DW.icLoad_kc = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_p3 =
            EX3_CircularTrajectoryNew_B.In1_n1[4];

          // Update for Delay: '<S110>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_p1 = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_bk =
            EX3_CircularTrajectoryNew_B.dividebydeltaT;

          // Update for Delay: '<S116>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_kv = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_ko =
            EX3_CircularTrajectoryNew_B.In1_n1[5];

          // Update for Delay: '<S111>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_cg = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_kx =
            EX3_CircularTrajectoryNew_B.dividebydeltaT_l;

          // Update for Delay: '<S117>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_f0 = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_at =
            EX3_CircularTrajectoryNew_B.Unwrap1;

          // Update for Delay: '<S112>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_a5 = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_hg =
            EX3_CircularTrajectoryNew_B.dividebydeltaT_h;

          // Update for Delay: '<S109>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_l4 = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_knv =
            EX3_CircularTrajectoryNew_B.In1_n1[1];

          // Update for Delay: '<S118>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_go = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_oz =
            EX3_CircularTrajectoryNew_B.dividebydeltaT_a;

          // Update for Delay: '<S113>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_ay = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_cf =
            EX3_CircularTrajectoryNew_B.In1_n1[2];

          // Update for Delay: '<S119>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_aqe = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_me =
            EX3_CircularTrajectoryNew_B.dividebydeltaT_l4;

          // Update for Delay: '<S114>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_ma = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_gy =
            EX3_CircularTrajectoryNew_B.Unwrap;

          // Update for Delay: '<S120>/Delay1'
          EX3_CircularTrajectoryNew_DW.icLoad_hj = 0U;
          EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_hf =
            EX3_CircularTrajectoryNew_B.dividebydeltaT_f;

          // Update for S-Function (sdspToNetwork): '<S80>/Send BLACK States to  BLACK Platform' 
          sErr = GetErrorBuffer
            (&EX3_CircularTrajectoryNew_DW.SendBLACKStatestoBLACKPlatform_[0U]);
          LibUpdate_Network
            (&EX3_CircularTrajectoryNew_DW.SendBLACKStatestoBLACKPlatform_[0U],
             &EX3_CircularTrajectoryNew_B.TmpSignalConversionAtSendBLACKS[0U],
             13);
          if (*sErr != 0) {
            rtmSetErrorStatus(EX3_CircularTrajectoryNew_M, sErr);
            rtmSetStopRequested(EX3_CircularTrajectoryNew_M, 1);
    ...
    sErr = GetErrorBuffer(&EX3_CircularTrajectoryNew_DW.UDPSend_NetworkLib[0U]);
    LibUpdate_Network(&EX3_CircularTrajectoryNew_DW.UDPSend_NetworkLib[0U],
                      &EX3_CircularTrajectoryNew_B.SetUniversalTimeIfthisisasimula,
                      1);
    if (*sErr != 0) {
      rtmSetErrorStatus(EX3_CircularTrajectoryNew_M, sErr);
  ...
  {                                    // Sample time: [0.0s, 0.0s]
    if ((rtmGetTFinal(EX3_CircularTrajectoryNew_M)!=-1) &&
        !((rtmGetTFinal(EX3_CircularTrajectoryNew_M)-
           EX3_CircularTrajectoryNew_M->Timing.t[0]) >
          EX3_CircularTrajectoryNew_M->Timing.t[0] * (DBL_EPSILON))) {
      rtmSetErrorStatus(EX3_CircularTrajectoryNew_M, "Simulation finished");
    }
  }
  ...
  EX3_CircularTrajectoryNew_M->Timing.t[0] =
    ((time_T)(++EX3_CircularTrajectoryNew_M->Timing.clockTick0)) *
    EX3_CircularTrajectoryNew_M->Timing.stepSize0;
  ...
  EX3_CircularTrajectoryNew_M->Timing.clockTick1++;
}

// Model step function for TID2
void EX3_CircularTrajectoryNew_step2(void) // Sample time: [0.1s, 0.0s]
{
  ...
  if (EX3_CircularTrajectoryNew_DW.RateTransition_Buffer < 1.0) {
    rtb_SaturateMotor = EX3_CircularTrajectoryNew_DW.RateTransition_Buffer;
  } else {
  ...
  EXT_PWMBlock_setDutyCycle(EX3_CircularTrajectoryNew_DW.obj_m.PinNumber,
    rtb_SaturateMotor);
  ...
  if (EX3_CircularTrajectoryNew_DW.RateTransition1_Buffer < 1.0) {
    rtb_SaturateMotor = EX3_CircularTrajectoryNew_DW.RateTransition1_Buffer;
  } else {
    rtb_SaturateMotor = 1.0;
  }
  ...
  EXT_PWMBlock_setDutyCycle(EX3_CircularTrajectoryNew_DW.obj_ma.PinNumber,
    rtb_SaturateMotor);
  ...
  if (EX3_CircularTrajectoryNew_DW.RateTransition2_Buffer < 1.0) {
    rtb_SaturateMotor = EX3_CircularTrajectoryNew_DW.RateTransition2_Buffer;
  } else {
    rtb_SaturateMotor = 1.0;
  }
  ...
  EXT_PWMBlock_setDutyCycle(EX3_CircularTrajectoryNew_DW.obj_h.PinNumber,
    rtb_SaturateMotor);
  ...
  if (EX3_CircularTrajectoryNew_DW.RateTransition3_Buffer < 1.0) {
    rtb_SaturateMotor = EX3_CircularTrajectoryNew_DW.RateTransition3_Buffer;
  } else {
    rtb_SaturateMotor = 1.0;
  }
  ...
  EXT_PWMBlock_setDutyCycle(EX3_CircularTrajectoryNew_DW.obj_k.PinNumber,
    rtb_SaturateMotor);
  ...
  if (EX3_CircularTrajectoryNew_DW.RateTransition4_Buffer < 1.0) {
    rtb_SaturateMotor = EX3_CircularTrajectoryNew_DW.RateTransition4_Buffer;
  } else {
    rtb_SaturateMotor = 1.0;
  }
  ...
  EXT_PWMBlock_setDutyCycle(EX3_CircularTrajectoryNew_DW.obj_hw.PinNumber,
    rtb_SaturateMotor);
  ...
  if (EX3_CircularTrajectoryNew_DW.RateTransition5_Buffer < 1.0) {
    rtb_SaturateMotor = EX3_CircularTrajectoryNew_DW.RateTransition5_Buffer;
  } else {
    rtb_SaturateMotor = 1.0;
  }
  ...
  EXT_PWMBlock_setDutyCycle(EX3_CircularTrajectoryNew_DW.obj_hf.PinNumber,
    rtb_SaturateMotor);
  ...
  if (EX3_CircularTrajectoryNew_DW.RateTransition6_Buffer < 1.0) {
    rtb_SaturateMotor = EX3_CircularTrajectoryNew_DW.RateTransition6_Buffer;
  } else {
    rtb_SaturateMotor = 1.0;
  }
  ...
  EXT_PWMBlock_setDutyCycle(EX3_CircularTrajectoryNew_DW.obj_c.PinNumber,
    rtb_SaturateMotor);
  ...
  if (EX3_CircularTrajectoryNew_DW.RateTransition7_Buffer < 1.0) {
    rtb_SaturateMotor = EX3_CircularTrajectoryNew_DW.RateTransition7_Buffer;
  } else {
    rtb_SaturateMotor = 1.0;
  }
  ...
  EXT_PWMBlock_setDutyCycle(EX3_CircularTrajectoryNew_DW.obj_fo.PinNumber,
    rtb_SaturateMotor);
  ...
  if (EX3_CircularTrajectoryNew_DW.RateTransition8_Buffer < 1.0) {
    rtb_SaturateMotor = EX3_CircularTrajectoryNew_DW.RateTransition8_Buffer;
  } else {
    rtb_SaturateMotor = 1.0;
  }
  ...
  EXT_PWMBlock_setDutyCycle(EX3_CircularTrajectoryNew_DW.obj_ci.PinNumber,
    rtb_SaturateMotor);
  ...
  if ((EX3_CircularTrajectoryNew_P.WhoAmI == 1.0) ||
    ...
    if (EX3_CircularTrajectoryNew_DW.RED_Tz_RW >
        EX3_CircularTrajectoryNew_P.SaturateTorque_UpperSat) {
      EX3_CircularTrajectoryNew_DW.RED_Tz_RW_Sat =
        EX3_CircularTrajectoryNew_P.SaturateTorque_UpperSat;
    } else if (EX3_CircularTrajectoryNew_DW.RED_Tz_RW <
               EX3_CircularTrajectoryNew_P.SaturateTorque_LowerSat) {
      EX3_CircularTrajectoryNew_DW.RED_Tz_RW_Sat =
        EX3_CircularTrajectoryNew_P.SaturateTorque_LowerSat;
    } else {
      EX3_CircularTrajectoryNew_DW.RED_Tz_RW_Sat =
    ...
    if (EX3_CircularTrajectoryNew_DW.obj_fq.SampleTime !=
        EX3_CircularTrajectoryNew_P.DigitalRead_SampleTime) {
      if (((!rtIsInf(EX3_CircularTrajectoryNew_P.DigitalRead_SampleTime)) &&
           (!rtIsNaN(EX3_CircularTrajectoryNew_P.DigitalRead_SampleTime))) ||
          rtIsInf(EX3_CircularTrajectoryNew_P.DigitalRead_SampleTime)) {
        sampleTime = EX3_CircularTrajectoryNew_P.DigitalRead_SampleTime;
      }

      EX3_CircularTrajectoryNew_DW.obj_fq.SampleTime = sampleTime;
    }
    ...
    sampleTime = EX3_CircularTrajectoryNew_DW.RED_Tz_RW_Sat / 0.00724472 *
      9.5492965855137211 * 0.1 + EX3_CircularTrajectoryNew_DW.Delay_DSTATE;
    ...
    // '<S61>:1:3' if Status == 0
    if ((!rtb_DigitalRead_0) || (!EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_kt)
        || (!EX3_CircularTrajectoryNew_DW.Delay2_DSTATE[0U]) ||
        (!EX3_CircularTrajectoryNew_DW.Delay5_DSTATE[0U]) ||
        (!EX3_CircularTrajectoryNew_DW.Delay3_DSTATE[0U]) ||
        (!EX3_CircularTrajectoryNew_DW.Delay4_DSTATE[0U])) {
      // '<S61>:1:4' EnableSig    = 1;
      rtb_EnableSig = 1;

      // '<S61>:1:5' WheelRPM_Out = WheelRPM_In;
      EX3_CircularTrajectoryNew_DW.RED_dRz_RW_Sat = sampleTime;
    } else {
      // '<S61>:1:6' else
      // '<S61>:1:7' EnableSig    = 0;
      rtb_EnableSig = 0;
      ...
      EX3_CircularTrajectoryNew_DW.RED_dRz_RW_Sat = 0.0;
    }
    ...
    rtb_SaturateMotor = EX3_CircularTrajectoryNew_DW.RED_dRz_RW_Sat *
      EX3_CircularTrajectoryNew_P.GearboxRatio_Value;

    // Saturate: '<S59>/Saturate Motor'
    if (rtb_SaturateMotor > EX3_CircularTrajectoryNew_P.SaturateMotor_UpperSat)
    {
      rtb_SaturateMotor = EX3_CircularTrajectoryNew_P.SaturateMotor_UpperSat;
    } else {
      if (rtb_SaturateMotor < EX3_CircularTrajectoryNew_P.SaturateMotor_LowerSat)
      {
        rtb_SaturateMotor = EX3_CircularTrajectoryNew_P.SaturateMotor_LowerSat;
      }
    }
    ...
    EXT_PWMBlock_setDutyCycle(EX3_CircularTrajectoryNew_DW.obj_d.PinNumber,
      rtb_SaturateMotor);
    ...
    EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_kt = rtb_DigitalRead_0;
    ...
    EX3_CircularTrajectoryNew_DW.Delay2_DSTATE[0] =
      EX3_CircularTrajectoryNew_DW.Delay2_DSTATE[1];

    // Outputs for Atomic SubSystem: '<S59>/Obtain RW Status'
    EX3_CircularTrajectoryNew_DW.Delay2_DSTATE[1] = rtb_DigitalRead_0;
    ...
    EX3_CircularTrajectoryNew_DW.Delay5_DSTATE[0] =
      EX3_CircularTrajectoryNew_DW.Delay5_DSTATE[1];
    EX3_CircularTrajectoryNew_DW.Delay5_DSTATE[1] =
      EX3_CircularTrajectoryNew_DW.Delay5_DSTATE[2];

    // Outputs for Atomic SubSystem: '<S59>/Obtain RW Status'
    EX3_CircularTrajectoryNew_DW.Delay5_DSTATE[2] = rtb_DigitalRead_0;
    ...
    EX3_CircularTrajectoryNew_DW.Delay3_DSTATE[0] =
      EX3_CircularTrajectoryNew_DW.Delay3_DSTATE[1];
    EX3_CircularTrajectoryNew_DW.Delay3_DSTATE[1] =
      EX3_CircularTrajectoryNew_DW.Delay3_DSTATE[2];
    EX3_CircularTrajectoryNew_DW.Delay3_DSTATE[2] =
      EX3_CircularTrajectoryNew_DW.Delay3_DSTATE[3];

    // Outputs for Atomic SubSystem: '<S59>/Obtain RW Status'
    EX3_CircularTrajectoryNew_DW.Delay3_DSTATE[3] = rtb_DigitalRead_0;
    ...
    EX3_CircularTrajectoryNew_DW.Delay4_DSTATE[0] =
      EX3_CircularTrajectoryNew_DW.Delay4_DSTATE[1];
    EX3_CircularTrajectoryNew_DW.Delay4_DSTATE[1] =
      EX3_CircularTrajectoryNew_DW.Delay4_DSTATE[2];
    EX3_CircularTrajectoryNew_DW.Delay4_DSTATE[2] =
      EX3_CircularTrajectoryNew_DW.Delay4_DSTATE[3];
    EX3_CircularTrajectoryNew_DW.Delay4_DSTATE[3] =
      EX3_CircularTrajectoryNew_DW.Delay4_DSTATE[4];

    // Outputs for Atomic SubSystem: '<S59>/Obtain RW Status'
    EX3_CircularTrajectoryNew_DW.Delay4_DSTATE[4] = rtb_DigitalRead_0;

    // End of Outputs for SubSystem: '<S59>/Obtain RW Status'

    // Saturate: '<S58>/Saturate RPM'
    if (sampleTime > EX3_CircularTrajectoryNew_P.SaturateRPM_UpperSat) {
      // Update for Delay: '<S58>/Delay'
      EX3_CircularTrajectoryNew_DW.Delay_DSTATE =
        EX3_CircularTrajectoryNew_P.SaturateRPM_UpperSat;
    } else if (sampleTime < EX3_CircularTrajectoryNew_P.SaturateRPM_LowerSat) {
      // Update for Delay: '<S58>/Delay'
      EX3_CircularTrajectoryNew_DW.Delay_DSTATE =
        EX3_CircularTrajectoryNew_P.SaturateRPM_LowerSat;
    } else {
      // Update for Delay: '<S58>/Delay'
      EX3_CircularTrajectoryNew_DW.Delay_DSTATE = sampleTime;
    }
...
void EX3_CircularTrajectoryNew_step(int_T tid)
{
  switch (tid) {
   case 0 :
    EX3_CircularTrajectoryNew_step0();
    break;

   case 2 :
    EX3_CircularTrajectoryNew_step2();
    break;
...
void EX3_CircularTrajectoryNew_initialize(void)
{
  // Registration code
  ...
  {
    // Setup solver object
    rtsiSetSimTimeStepPtr(&EX3_CircularTrajectoryNew_M->solverInfo,
                          &EX3_CircularTrajectoryNew_M->Timing.simTimeStep);
    rtsiSetTPtr(&EX3_CircularTrajectoryNew_M->solverInfo, &rtmGetTPtr
                (EX3_CircularTrajectoryNew_M));
    rtsiSetStepSizePtr(&EX3_CircularTrajectoryNew_M->solverInfo,
                       &EX3_CircularTrajectoryNew_M->Timing.stepSize0);
    rtsiSetErrorStatusPtr(&EX3_CircularTrajectoryNew_M->solverInfo,
                          (&rtmGetErrorStatus(EX3_CircularTrajectoryNew_M)));
    rtsiSetRTModelPtr(&EX3_CircularTrajectoryNew_M->solverInfo,
                      EX3_CircularTrajectoryNew_M);
  }

  rtsiSetSimTimeStep(&EX3_CircularTrajectoryNew_M->solverInfo, MAJOR_TIME_STEP);
  rtsiSetSolverName(&EX3_CircularTrajectoryNew_M->solverInfo,"FixedStepDiscrete");
  rtmSetTPtr(EX3_CircularTrajectoryNew_M,
             &EX3_CircularTrajectoryNew_M->Timing.tArray[0]);
  rtmSetTFinal(EX3_CircularTrajectoryNew_M, 291.0);
  EX3_CircularTrajectoryNew_M->Timing.stepSize0 = 0.05;

  // Setup for data logging
  {
    static RTWLogInfo rt_DataLoggingInfo;
    rt_DataLoggingInfo.loggingInterval = NULL;
    EX3_CircularTrajectoryNew_M->rtwLogInfo = &rt_DataLoggingInfo;
  }

  // Setup for data logging
  {
    rtliSetLogXSignalInfo(EX3_CircularTrajectoryNew_M->rtwLogInfo, (NULL));
    rtliSetLogXSignalPtrs(EX3_CircularTrajectoryNew_M->rtwLogInfo, (NULL));
    rtliSetLogT(EX3_CircularTrajectoryNew_M->rtwLogInfo, "tout");
    rtliSetLogX(EX3_CircularTrajectoryNew_M->rtwLogInfo, "");
    rtliSetLogXFinal(EX3_CircularTrajectoryNew_M->rtwLogInfo, "");
    rtliSetLogVarNameModifier(EX3_CircularTrajectoryNew_M->rtwLogInfo, "rt_");
    rtliSetLogFormat(EX3_CircularTrajectoryNew_M->rtwLogInfo, 4);
    rtliSetLogMaxRows(EX3_CircularTrajectoryNew_M->rtwLogInfo, 0);
    rtliSetLogDecimation(EX3_CircularTrajectoryNew_M->rtwLogInfo, 1);
    rtliSetLogY(EX3_CircularTrajectoryNew_M->rtwLogInfo, "");
    rtliSetLogYSignalInfo(EX3_CircularTrajectoryNew_M->rtwLogInfo, (NULL));
    rtliSetLogYSignalPtrs(EX3_CircularTrajectoryNew_M->rtwLogInfo, (NULL));
  }

  // Matfile logging
  rt_StartDataLoggingWithStartTime(EX3_CircularTrajectoryNew_M->rtwLogInfo, 0.0,
    rtmGetTFinal(EX3_CircularTrajectoryNew_M),
    EX3_CircularTrajectoryNew_M->Timing.stepSize0, (&rtmGetErrorStatus
    (EX3_CircularTrajectoryNew_M)));

  {
    ...
    // SetupRuntimeResources for ToWorkspace: '<S1>/To Workspace'
    {
      ...
      EX3_CircularTrajectoryNew_DW.ToWorkspace_PWORK.LoggedData =
        rt_CreateLogVar(
                        EX3_CircularTrajectoryNew_M->rtwLogInfo,
                        0.0,
                        rtmGetTFinal(EX3_CircularTrajectoryNew_M),
                        EX3_CircularTrajectoryNew_M->Timing.stepSize0,
                        (&rtmGetErrorStatus(EX3_CircularTrajectoryNew_M)),
                        ...
                        0.05,
                        1);
      if (EX3_CircularTrajectoryNew_DW.ToWorkspace_PWORK.LoggedData == (NULL))
        return;
    }
    ...
    EX3_CircularTrajectoryNew_DW.Ifperforminganexperimentgrabthe = -1;

    // Start for S-Function (sdspToNetwork): '<S15>/UDP Send'
    sErr = GetErrorBuffer(&EX3_CircularTrajectoryNew_DW.UDPSend_NetworkLib[0U]);
    CreateUDPInterface(&EX3_CircularTrajectoryNew_DW.UDPSend_NetworkLib[0U]);
    if (*sErr == 0) {
      LibCreate_Network(&EX3_CircularTrajectoryNew_DW.UDPSend_NetworkLib[0U], 1,
                        "0.0.0.0", -1, "192.168.0.105",
                        EX3_CircularTrajectoryNew_P.UDPSend_Port, 8192, 8, 0);
    }

    if (*sErr == 0) {
      LibStart(&EX3_CircularTrajectoryNew_DW.UDPSend_NetworkLib[0U]);
    }

    if (*sErr != 0) {
      DestroyUDPInterface(&EX3_CircularTrajectoryNew_DW.UDPSend_NetworkLib[0U]);
      if (*sErr != 0) {
        rtmSetErrorStatus(EX3_CircularTrajectoryNew_M, sErr);
        rtmSetStopRequested(EX3_CircularTrajectoryNew_M, 1);
      }
    ...
    EX3_CircularTrajectoryNew_DW.BLACK_Fx =
      EX3_CircularTrajectoryNew_P.BLACK_Fx_InitialValue;

    // Start for DataStoreMemory: '<Root>/BLACK_Fx1'
    EX3_CircularTrajectoryNew_DW.BLUE_Fx =
      EX3_CircularTrajectoryNew_P.BLACK_Fx1_InitialValue;

    // Start for DataStoreMemory: '<Root>/BLACK_Fx_Sat'
    EX3_CircularTrajectoryNew_DW.BLACK_Fx_Sat =
      EX3_CircularTrajectoryNew_P.BLACK_Fx_Sat_InitialValue;

    // Start for DataStoreMemory: '<Root>/BLACK_Fx_Sat1'
    EX3_CircularTrajectoryNew_DW.ARM_Elbow_Py =
      EX3_CircularTrajectoryNew_P.BLACK_Fx_Sat1_InitialValue;

    // Start for DataStoreMemory: '<Root>/BLACK_Fx_Sat2'
    EX3_CircularTrajectoryNew_DW.BLUE_Fx_Sat =
      EX3_CircularTrajectoryNew_P.BLACK_Fx_Sat2_InitialValue;

    // Start for DataStoreMemory: '<Root>/BLACK_Fy'
    EX3_CircularTrajectoryNew_DW.BLACK_Fy =
      EX3_CircularTrajectoryNew_P.BLACK_Fy_InitialValue;

    // Start for DataStoreMemory: '<Root>/BLACK_Fy1'
    EX3_CircularTrajectoryNew_DW.BLUE_Fy =
      EX3_CircularTrajectoryNew_P.BLACK_Fy1_InitialValue;

    // Start for DataStoreMemory: '<Root>/BLACK_Fy_Sat'
    EX3_CircularTrajectoryNew_DW.BLACK_Fy_Sat =
      EX3_CircularTrajectoryNew_P.BLACK_Fy_Sat_InitialValue;

    // Start for DataStoreMemory: '<Root>/BLACK_Fy_Sat1'
    EX3_CircularTrajectoryNew_DW.ARM_Wrist_Px =
      EX3_CircularTrajectoryNew_P.BLACK_Fy_Sat1_InitialValue;

    // Start for DataStoreMemory: '<Root>/BLACK_Fy_Sat2'
    EX3_CircularTrajectoryNew_DW.BLUE_Fy_Sat =
      EX3_CircularTrajectoryNew_P.BLACK_Fy_Sat2_InitialValue;

    // Start for DataStoreMemory: '<Root>/BLACK_Px'
    EX3_CircularTrajectoryNew_DW.BLACK_Px =
      EX3_CircularTrajectoryNew_P.BLACK_Px_InitialValue;

    // Start for DataStoreMemory: '<Root>/BLACK_Px1'
    EX3_CircularTrajectoryNew_DW.BLUE_Px =
      EX3_CircularTrajectoryNew_P.BLACK_Px1_InitialValue;

    // Start for DataStoreMemory: '<Root>/BLACK_Py'
    EX3_CircularTrajectoryNew_DW.BLACK_Py =
      EX3_CircularTrajectoryNew_P.BLACK_Py_InitialValue;

    // Start for DataStoreMemory: '<Root>/BLACK_Py1'
    EX3_CircularTrajectoryNew_DW.BLUE_Py =
      EX3_CircularTrajectoryNew_P.BLACK_Py1_InitialValue;

    // Start for DataStoreMemory: '<Root>/BLACK_Rz'
    EX3_CircularTrajectoryNew_DW.BLACK_Rz =
      EX3_CircularTrajectoryNew_P.BLACK_Rz_InitialValue;

    // Start for DataStoreMemory: '<Root>/BLACK_Rz1'
    EX3_CircularTrajectoryNew_DW.BLUE_Rz =
      EX3_CircularTrajectoryNew_P.BLACK_Rz1_InitialValue;

    // Start for DataStoreMemory: '<Root>/BLACK_Tz'
    EX3_CircularTrajectoryNew_DW.BLACK_Tz =
      EX3_CircularTrajectoryNew_P.BLACK_Tz_InitialValue;

    // Start for DataStoreMemory: '<Root>/BLACK_Tz1'
    EX3_CircularTrajectoryNew_DW.BLUE_Tz =
      EX3_CircularTrajectoryNew_P.BLACK_Tz1_InitialValue;

    // Start for DataStoreMemory: '<Root>/BLACK_Tz_Sat'
    EX3_CircularTrajectoryNew_DW.BLACK_Tz_Sat =
      EX3_CircularTrajectoryNew_P.BLACK_Tz_Sat_InitialValue;

    // Start for DataStoreMemory: '<Root>/BLACK_Tz_Sat1'
    EX3_CircularTrajectoryNew_DW.ARM_Wrist_Py =
      EX3_CircularTrajectoryNew_P.BLACK_Tz_Sat1_InitialValue;

    // Start for DataStoreMemory: '<Root>/BLACK_Tz_Sat2'
    EX3_CircularTrajectoryNew_DW.BLUE_Tz_Sat =
      EX3_CircularTrajectoryNew_P.BLACK_Tz_Sat2_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Fx'
    EX3_CircularTrajectoryNew_DW.RED_Fx =
      EX3_CircularTrajectoryNew_P.RED_Fx_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Fx_Sat'
    EX3_CircularTrajectoryNew_DW.RED_Fx_Sat =
      EX3_CircularTrajectoryNew_P.RED_Fx_Sat_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Fy'
    EX3_CircularTrajectoryNew_DW.RED_Fy =
      EX3_CircularTrajectoryNew_P.RED_Fy_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Fy_Sat'
    EX3_CircularTrajectoryNew_DW.RED_Fy_Sat =
      EX3_CircularTrajectoryNew_P.RED_Fy_Sat_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Px'
    EX3_CircularTrajectoryNew_DW.RED_Px =
      EX3_CircularTrajectoryNew_P.RED_Px_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Px1'
    EX3_CircularTrajectoryNew_DW.RED_AHRS_Q =
      EX3_CircularTrajectoryNew_P.RED_Px1_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Px10'
    EX3_CircularTrajectoryNew_DW.BLACK_IMU_Ax_b =
      EX3_CircularTrajectoryNew_P.RED_Px10_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Px11'
    EX3_CircularTrajectoryNew_DW.BLACK_IMU_Ay_b =
      EX3_CircularTrajectoryNew_P.RED_Px11_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Px12'
    EX3_CircularTrajectoryNew_DW.BLACK_IMU_Az_b =
      EX3_CircularTrajectoryNew_P.RED_Px12_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Px19'
    EX3_CircularTrajectoryNew_DW.RED_IMU_Q =
      EX3_CircularTrajectoryNew_P.RED_Px19_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Px2'
    EX3_CircularTrajectoryNew_DW.RED_AHRS_P =
      EX3_CircularTrajectoryNew_P.RED_Px2_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Px20'
    EX3_CircularTrajectoryNew_DW.RED_IMU_P =
      EX3_CircularTrajectoryNew_P.RED_Px20_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Px21'
    EX3_CircularTrajectoryNew_DW.RED_IMU_R =
      EX3_CircularTrajectoryNew_P.RED_Px21_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Px22'
    EX3_CircularTrajectoryNew_DW.BLACK_IMU_Q =
      EX3_CircularTrajectoryNew_P.RED_Px22_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Px23'
    EX3_CircularTrajectoryNew_DW.BLACK_IMU_P =
      EX3_CircularTrajectoryNew_P.RED_Px23_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Px24'
    EX3_CircularTrajectoryNew_DW.BLACK_IMU_R =
      EX3_CircularTrajectoryNew_P.RED_Px24_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Px25'
    EX3_CircularTrajectoryNew_DW.RED_IMU_Psi =
      EX3_CircularTrajectoryNew_P.RED_Px25_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Px26'
    EX3_CircularTrajectoryNew_DW.BLACK_IMU_Psi =
      EX3_CircularTrajectoryNew_P.RED_Px26_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Px3'
    EX3_CircularTrajectoryNew_DW.RED_AHRS_R =
      EX3_CircularTrajectoryNew_P.RED_Px3_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Px31'
    EX3_CircularTrajectoryNew_DW.RED_IMU_Ax_I =
      EX3_CircularTrajectoryNew_P.RED_Px31_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Px32'
    EX3_CircularTrajectoryNew_DW.RED_IMU_Ay_I =
      EX3_CircularTrajectoryNew_P.RED_Px32_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Px37'
    EX3_CircularTrajectoryNew_DW.BLACK_IMU_Ax_I =
      EX3_CircularTrajectoryNew_P.RED_Px37_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Px38'
    EX3_CircularTrajectoryNew_DW.BLACK_IMU_Ay_I =
      EX3_CircularTrajectoryNew_P.RED_Px38_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Px4'
    EX3_CircularTrajectoryNew_DW.BLACK_AHRS_Q =
      EX3_CircularTrajectoryNew_P.RED_Px4_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Px5'
    EX3_CircularTrajectoryNew_DW.BLACK_AHRS_P =
      EX3_CircularTrajectoryNew_P.RED_Px5_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Px6'
    EX3_CircularTrajectoryNew_DW.BLACK_AHRS_R =
      EX3_CircularTrajectoryNew_P.RED_Px6_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Px7'
    EX3_CircularTrajectoryNew_DW.RED_IMU_Ax_b =
      EX3_CircularTrajectoryNew_P.RED_Px7_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Px8'
    EX3_CircularTrajectoryNew_DW.RED_IMU_Ay_b =
      EX3_CircularTrajectoryNew_P.RED_Px8_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Px9'
    EX3_CircularTrajectoryNew_DW.RED_IMU_Az_b =
      EX3_CircularTrajectoryNew_P.RED_Px9_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Py'
    EX3_CircularTrajectoryNew_DW.RED_Py =
      EX3_CircularTrajectoryNew_P.RED_Py_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Rz'
    EX3_CircularTrajectoryNew_DW.RED_Rz =
      EX3_CircularTrajectoryNew_P.RED_Rz_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Tz'
    EX3_CircularTrajectoryNew_DW.RED_Tz =
      EX3_CircularTrajectoryNew_P.RED_Tz_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Tz7'
    EX3_CircularTrajectoryNew_DW.Float_State =
      EX3_CircularTrajectoryNew_P.RED_Tz7_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Tz8'
    EX3_CircularTrajectoryNew_DW.Magnet_State =
      EX3_CircularTrajectoryNew_P.RED_Tz8_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Tz_RW'
    EX3_CircularTrajectoryNew_DW.RED_Tz_RW =
      EX3_CircularTrajectoryNew_P.RED_Tz_RW_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Tz_RW Sat'
    EX3_CircularTrajectoryNew_DW.RED_Tz_RW_Sat =
      EX3_CircularTrajectoryNew_P.RED_Tz_RWSat_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Tz_RW Sat1'
    EX3_CircularTrajectoryNew_DW.ARM_EndEff_Py =
      EX3_CircularTrajectoryNew_P.RED_Tz_RWSat1_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Tz_RW1'
    EX3_CircularTrajectoryNew_DW.ARM_EndEff_Px =
      EX3_CircularTrajectoryNew_P.RED_Tz_RW1_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Tz_Sat'
    EX3_CircularTrajectoryNew_DW.RED_Tz_Sat =
      EX3_CircularTrajectoryNew_P.RED_Tz_Sat_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_Tz_Sat1'
    EX3_CircularTrajectoryNew_DW.ARM_Elbow_Px =
      EX3_CircularTrajectoryNew_P.RED_Tz_Sat1_InitialValue;

    // Start for DataStoreMemory: '<Root>/RED_dRz_RW Sat'
    EX3_CircularTrajectoryNew_DW.RED_dRz_RW_Sat =
      EX3_CircularTrajectoryNew_P.RED_dRz_RWSat_InitialValue;

    // Start for DataStoreMemory: '<Root>/Universal_Time'
    EX3_CircularTrajectoryNew_DW.Univ_Time =
      EX3_CircularTrajectoryNew_P.Universal_Time_InitialValue;

    // Start for DataStoreMemory: '<Root>/Universal_Time1'
    EX3_CircularTrajectoryNew_DW.RED_Vx =
      EX3_CircularTrajectoryNew_P.Universal_Time1_InitialValue;

    // Start for DataStoreMemory: '<Root>/Universal_Time10'
    EX3_CircularTrajectoryNew_DW.RED_Ax =
      EX3_CircularTrajectoryNew_P.Universal_Time10_InitialValue;

    // Start for DataStoreMemory: '<Root>/Universal_Time11'
    EX3_CircularTrajectoryNew_DW.RED_Ay =
      EX3_CircularTrajectoryNew_P.Universal_Time11_InitialValue;

    // Start for DataStoreMemory: '<Root>/Universal_Time12'
    EX3_CircularTrajectoryNew_DW.BLACK_Ax =
      EX3_CircularTrajectoryNew_P.Universal_Time12_InitialValue;

    // Start for DataStoreMemory: '<Root>/Universal_Time13'
    EX3_CircularTrajectoryNew_DW.BLACK_Ay =
      EX3_CircularTrajectoryNew_P.Universal_Time13_InitialValue;

    // Start for DataStoreMemory: '<Root>/Universal_Time14'
    EX3_CircularTrajectoryNew_DW.BLACK_RzDD =
      EX3_CircularTrajectoryNew_P.Universal_Time14_InitialValue;

    // Start for DataStoreMemory: '<Root>/Universal_Time15'
    EX3_CircularTrajectoryNew_DW.RED_RzDD =
      EX3_CircularTrajectoryNew_P.Universal_Time15_InitialValue;

    // Start for DataStoreMemory: '<Root>/Universal_Time2'
    EX3_CircularTrajectoryNew_DW.RED_Vy =
      EX3_CircularTrajectoryNew_P.Universal_Time2_InitialValue;

    // Start for DataStoreMemory: '<Root>/Universal_Time3'
    EX3_CircularTrajectoryNew_DW.RED_RzD =
      EX3_CircularTrajectoryNew_P.Universal_Time3_InitialValue;

    // Start for DataStoreMemory: '<Root>/Universal_Time4'
    EX3_CircularTrajectoryNew_DW.BLACK_Vx =
      EX3_CircularTrajectoryNew_P.Universal_Time4_InitialValue;

    // Start for DataStoreMemory: '<Root>/Universal_Time5'
    EX3_CircularTrajectoryNew_DW.BLACK_Vy =
      EX3_CircularTrajectoryNew_P.Universal_Time5_InitialValue;

    // Start for DataStoreMemory: '<Root>/Universal_Time6'
    EX3_CircularTrajectoryNew_DW.BLACK_RzD =
      EX3_CircularTrajectoryNew_P.Universal_Time6_InitialValue;

    // Start for DataStoreMemory: '<Root>/Universal_Time7'
    EX3_CircularTrajectoryNew_DW.BLUE_Vx =
      EX3_CircularTrajectoryNew_P.Universal_Time7_InitialValue;

    // Start for DataStoreMemory: '<Root>/Universal_Time8'
    EX3_CircularTrajectoryNew_DW.BLUE_Vy =
      EX3_CircularTrajectoryNew_P.Universal_Time8_InitialValue;

    // Start for DataStoreMemory: '<Root>/Universal_Time9'
    EX3_CircularTrajectoryNew_DW.BLUE_RzD =
      EX3_CircularTrajectoryNew_P.Universal_Time9_InitialValue;
    EX3_CircularTrajectoryN_PrevZCX.SampleandHold1_Trig_ZCE_c =
      UNINITIALIZED_ZCSIG;
    EX3_CircularTrajectoryN_PrevZCX.SampleandHold1_Trig_ZCE =
      UNINITIALIZED_ZCSIG;
    EX3_CircularTrajectoryN_PrevZCX.SampleandHold_Trig_ZCE = UNINITIALIZED_ZCSIG;
    ...
    EX3_CircularTrajectoryNew_DW.icLoad_ns = 1U;

    // InitializeConditions for Delay: '<S286>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_k1 = 1U;

    // InitializeConditions for Delay: '<S282>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_ep = 1U;

    // SystemInitialize for IfAction SubSystem: '<S284>/Hold this value'
    // SystemInitialize for Outport: '<S285>/Out1'
    EX3_CircularTrajectoryNew_B.In1_e = EX3_CircularTrajectoryNew_P.Out1_Y0_av;
    ...
    EX3_CircularTrajectoryNew_B.In1_gc = EX3_CircularTrajectoryNew_P.Out1_Y0_g1;
    ...
    EX3_CircularTrajectoryNew_B.In1_fau = EX3_CircularTrajectoryNew_P.Out1_Y0_mp;
    ...
    EX3_CircularTrajectoryNew_DW.icLoad_dy = 1U;

    // InitializeConditions for Delay: '<S299>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_hf = 1U;

    // InitializeConditions for Delay: '<S295>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_kl = 1U;

    // SystemInitialize for IfAction SubSystem: '<S297>/Hold this value'
    // SystemInitialize for Outport: '<S298>/Out1'
    EX3_CircularTrajectoryNew_B.In1_lc = EX3_CircularTrajectoryNew_P.Out1_Y0_a4;
    ...
    EX3_CircularTrajectoryNew_B.In1_jw = EX3_CircularTrajectoryNew_P.Out1_Y0_nv;
    ...
    EX3_CircularTrajectoryNew_B.In1_o = EX3_CircularTrajectoryNew_P.Out1_Y0_ovt;
    ...
    EX3_CircularTrajectoryNew_DW.icLoad_ji = 1U;

    // InitializeConditions for Delay: '<S310>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_a1 = 1U;

    // InitializeConditions for Delay: '<S312>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_o0 = 1U;

    // SystemInitialize for IfAction SubSystem: '<S308>/Hold this value'
    // SystemInitialize for Outport: '<S309>/Out1'
    EX3_CircularTrajectoryNew_B.In1_k = EX3_CircularTrajectoryNew_P.Out1_Y0_frl;
    ...
    EX3_CircularTrajectoryNew_B.In1_cr = EX3_CircularTrajectoryNew_P.Out1_Y0_bka;
    ...
    EX3_CircularTrajectoryNew_B.In1_if = EX3_CircularTrajectoryNew_P.Out1_Y0_j2;
    ...
    SendPositionCommandsto_Init
      (&EX3_CircularTrajectoryNew_DW.SendPositionCommandstoManipulat);
    ...
    EX3_CircularTrajectoryNew_DW.icLoad_ot = 1U;

    // InitializeConditions for Delay: '<S334>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_k = 1U;

    // InitializeConditions for Delay: '<S330>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_l = 1U;

    // SystemInitialize for IfAction SubSystem: '<S332>/Hold this value'
    // SystemInitialize for Outport: '<S333>/Out1'
    EX3_CircularTrajectoryNew_B.In1_cw = EX3_CircularTrajectoryNew_P.Out1_Y0_bd;
    ...
    EX3_CircularTrajectoryNew_B.In1_ly = EX3_CircularTrajectoryNew_P.Out1_Y0_ai;
    ...
    EX3_CircularTrajectoryNew_B.In1_a = EX3_CircularTrajectoryNew_P.Out1_Y0_pn;
    ...
    EX3_CircularTrajectoryNew_DW.icLoad_fr = 1U;

    // InitializeConditions for Delay: '<S351>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_me = 1U;

    // InitializeConditions for Delay: '<S347>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_ey = 1U;

    // SystemInitialize for IfAction SubSystem: '<S349>/Hold this value'
    // SystemInitialize for Outport: '<S350>/Out1'
    EX3_CircularTrajectoryNew_B.In1_l = EX3_CircularTrajectoryNew_P.Out1_Y0_dz;
    ...
    EX3_CircularTrajectoryNew_B.In1_n = EX3_CircularTrajectoryNew_P.Out1_Y0_jz;
    ...
    EX3_CircularTrajectoryNew_B.In1_ck = EX3_CircularTrajectoryNew_P.Out1_Y0_pz;
    ...
    EX3_Circular_SubPhase1_Init(&EX3_CircularTrajectoryNew_B.SubPhase1_a,
      &EX3_CircularTrajectoryNew_DW.SubPhase1_a,
      &EX3_CircularTrajectoryNew_P.SubPhase1_a);
    ...
    EX3_Circular_SubPhase1_Init(&EX3_CircularTrajectoryNew_B.SubPhase4_f,
      &EX3_CircularTrajectoryNew_DW.SubPhase4_f,
      &EX3_CircularTrajectoryNew_P.SubPhase4_f);
    ...
    // Start for FromWorkspace: '<S389>/From Workspace'
    {
      ...
      EX3_CircularTrajectoryNew_DW.FromWorkspace_PWORK.TimePtr = static_cast<
        void *>(pTimeValues0);
      EX3_CircularTrajectoryNew_DW.FromWorkspace_PWORK.DataPtr = static_cast<
        void *>(pDataValues0);
      EX3_CircularTrajectoryNew_DW.FromWorkspace_IWORK.PrevIndex = 0;
    }
    ...
    // Start for FromWorkspace: '<S389>/From Workspace1'
    {
      ...
      EX3_CircularTrajectoryNew_DW.FromWorkspace1_PWORK.TimePtr = static_cast<
        void *>(pTimeValues0);
      EX3_CircularTrajectoryNew_DW.FromWorkspace1_PWORK.DataPtr = static_cast<
        void *>(pDataValues0);
      EX3_CircularTrajectoryNew_DW.FromWorkspace1_IWORK.PrevIndex = 0;
    }
    ...
    // Start for FromWorkspace: '<S389>/From Workspace2'
    {
      ...
      EX3_CircularTrajectoryNew_DW.FromWorkspace2_PWORK.TimePtr = static_cast<
        void *>(pTimeValues0);
      EX3_CircularTrajectoryNew_DW.FromWorkspace2_PWORK.DataPtr = static_cast<
        void *>(pDataValues0);
      EX3_CircularTrajectoryNew_DW.FromWorkspace2_IWORK.PrevIndex = 0;
    }

    SendPositionCommandsto_Init
      (&EX3_CircularTrajectoryNew_DW.SendPositionCommandstoManipul_p);
    ...
    EX3_CircularTrajectoryNew_DW.icLoad_jl = 1U;

    // InitializeConditions for Delay: '<S402>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_n = 1U;

    // InitializeConditions for Delay: '<S404>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_g = 1U;

    // SystemInitialize for IfAction SubSystem: '<S400>/Hold this value'
    // SystemInitialize for Outport: '<S401>/Out1'
    EX3_CircularTrajectoryNew_B.In1_fa = EX3_CircularTrajectoryNew_P.Out1_Y0_pz4;
    ...
    EX3_CircularTrajectoryNew_B.In1_go = EX3_CircularTrajectoryNew_P.Out1_Y0_of;
    ...
    EX3_CircularTrajectoryNew_B.In1_g4 = EX3_CircularTrajectoryNew_P.Out1_Y0_ko;
    ...
    EX3_CircularTrajectoryNew_DW.icLoad_dq = 1U;

    // InitializeConditions for Delay: '<S422>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_h = 1U;

    // InitializeConditions for Delay: '<S418>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_o = 1U;

    // SystemInitialize for IfAction SubSystem: '<S420>/Hold this value'
    // SystemInitialize for Outport: '<S421>/Out1'
    EX3_CircularTrajectoryNew_B.In1_fx = EX3_CircularTrajectoryNew_P.Out1_Y0_mr;
    ...
    EX3_CircularTrajectoryNew_B.In1_d0 = EX3_CircularTrajectoryNew_P.Out1_Y0_i0r;
    ...
    EX3_CircularTrajectoryNew_B.In1_fk = EX3_CircularTrajectoryNew_P.Out1_Y0_jr;
    ...
    EX3_CircularTrajectoryNew_DW.icLoad_dh = 1U;

    // InitializeConditions for Delay: '<S446>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_a2 = 1U;

    // InitializeConditions for Delay: '<S448>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_f = 1U;

    // SystemInitialize for IfAction SubSystem: '<S444>/Hold this value'
    // SystemInitialize for Outport: '<S445>/Out1'
    EX3_CircularTrajectoryNew_B.In1_h = EX3_CircularTrajectoryNew_P.Out1_Y0_nf;
    ...
    EX3_CircularTrajectoryNew_B.In1_b = EX3_CircularTrajectoryNew_P.Out1_Y0_gb;
    ...
    EX3_CircularTrajectoryNew_B.In1_f = EX3_CircularTrajectoryNew_P.Out1_Y0_da;
    ...
    EX3_CircularTrajectoryNew_DW.icLoad_e = 1U;

    // InitializeConditions for Delay: '<S465>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_m = 1U;

    // InitializeConditions for Delay: '<S461>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_d = 1U;

    // SystemInitialize for IfAction SubSystem: '<S463>/Hold this value'
    // SystemInitialize for Outport: '<S464>/Out1'
    EX3_CircularTrajectoryNew_B.In1_i = EX3_CircularTrajectoryNew_P.Out1_Y0_fj;
    ...
    EX3_CircularTrajectoryNew_B.In1_c = EX3_CircularTrajectoryNew_P.Out1_Y0_bm;
    ...
    EX3_CircularTrajectoryNew_B.In1_g = EX3_CircularTrajectoryNew_P.Out1_Y0_gx1;
    ...
    EX3_CircularTrajectoryNew_DW.icLoad = 1U;

    // InitializeConditions for Delay: '<S491>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_j = 1U;

    // InitializeConditions for Delay: '<S487>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_a = 1U;

    // SystemInitialize for IfAction SubSystem: '<S489>/Hold this value'
    // SystemInitialize for Outport: '<S490>/Out1'
    EX3_CircularTrajectoryNew_B.In1_j = EX3_CircularTrajectoryNew_P.Out1_Y0_bs;
    ...
    EX3_CircularTrajectoryNew_B.In1 = EX3_CircularTrajectoryNew_P.Out1_Y0_c5;
    ...
    EX3_CircularTrajectoryNew_B.In1_d = EX3_CircularTrajectoryNew_P.Out1_Y0_i3;
    ...
    EX3_CircularTrajectoryNew_DW.AccelerationtoVelocity_DSTATE[0] =
      EX3_CircularTrajectoryNew_P.AccelerationtoVelocity_IC;

    // InitializeConditions for DiscreteIntegrator: '<S500>/Velocity to Position' 
    EX3_CircularTrajectoryNew_DW.VelocitytoPosition_DSTATE[0] =
      EX3_CircularTrajectoryNew_P.drop_states_BLACK[0];
    ...
    // InitializeConditions for DiscreteIntegrator: '<S500>/Velocity to Position' 
    EX3_CircularTrajectoryNew_DW.VelocitytoPosition_DSTATE[1] =
      EX3_CircularTrajectoryNew_P.drop_states_BLACK[1];
    ...
    // InitializeConditions for DiscreteIntegrator: '<S500>/Velocity to Position' 
    EX3_CircularTrajectoryNew_DW.VelocitytoPosition_DSTATE[2] =
      EX3_CircularTrajectoryNew_P.drop_states_BLACK[2];

    // InitializeConditions for RandomNumber: '<S500>/Random Number'
    EX3_CircularTrajectoryNew_B.d = floor
      (EX3_CircularTrajectoryNew_P.RandomNumber_Seed);
    if (rtIsNaN(EX3_CircularTrajectoryNew_B.d) || rtIsInf
        (EX3_CircularTrajectoryNew_B.d)) {
      EX3_CircularTrajectoryNew_B.d = 0.0;
    } else {
      EX3_CircularTrajectoryNew_B.d = fmod(EX3_CircularTrajectoryNew_B.d,
        4.294967296E+9);
    }

    tseed = EX3_CircularTrajectoryNew_B.d < 0.0 ? static_cast<uint32_T>(-
      static_cast<int32_T>(static_cast<uint32_T>(-EX3_CircularTrajectoryNew_B.d)))
      : static_cast<uint32_T>(EX3_CircularTrajectoryNew_B.d);
    ...
    EX3_CircularTrajectoryNew_DW.RandSeed = tseed;
    EX3_CircularTrajectoryNew_DW.NextOutput = EX3__rt_nrand_Upu32_Yd_f_pw_snf
      (&EX3_CircularTrajectoryNew_DW.RandSeed) * sqrt
      (EX3_CircularTrajectoryNew_P.noise_variance_BLACK) +
      EX3_CircularTrajectoryNew_P.RandomNumber_Mean;
    ...
    EX3_CircularTrajectoryNew_DW.icLoad_lm = 1U;

    // InitializeConditions for Delay: '<S512>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_em = 1U;

    // InitializeConditions for RandomNumber: '<S16>/Random Number1'
    EX3_CircularTrajectoryNew_B.d = floor
      (EX3_CircularTrajectoryNew_P.RandomNumber1_Seed);
    if (rtIsNaN(EX3_CircularTrajectoryNew_B.d) || rtIsInf
        (EX3_CircularTrajectoryNew_B.d)) {
      EX3_CircularTrajectoryNew_B.d = 0.0;
    } else {
    ...
    EX3_CircularTrajectoryNew_DW.RandSeed_p = tseed;
    EX3_CircularTrajectoryNew_DW.NextOutput_g = EX3__rt_nrand_Upu32_Yd_f_pw_snf(
      &EX3_CircularTrajectoryNew_DW.RandSeed_p) *
      EX3_CircularTrajectoryNew_P.RandomNumber1_StdDev +
      EX3_CircularTrajectoryNew_P.RandomNumber1_Mean;
    ...
    EX3_CircularTrajectoryNew_DW.icLoad_nw = 1U;

    // InitializeConditions for Delay: '<S513>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_og = 1U;

    // InitializeConditions for RandomNumber: '<S16>/Random Number'
    EX3_CircularTrajectoryNew_B.d = floor
      (EX3_CircularTrajectoryNew_P.RandomNumber_Seed_d);
    if (rtIsNaN(EX3_CircularTrajectoryNew_B.d) || rtIsInf
        (EX3_CircularTrajectoryNew_B.d)) {
      EX3_CircularTrajectoryNew_B.d = 0.0;
    } else {
    ...
    EX3_CircularTrajectoryNew_DW.RandSeed_i = tseed;
    EX3_CircularTrajectoryNew_DW.NextOutput_h = EX3__rt_nrand_Upu32_Yd_f_pw_snf(
      &EX3_CircularTrajectoryNew_DW.RandSeed_i) *
      EX3_CircularTrajectoryNew_P.RandomNumber_StdDev +
      EX3_CircularTrajectoryNew_P.RandomNumber_Mean_g;
    ...
    EX3_CircularTrajectoryNew_DW.icLoad_ka = 1U;

    // InitializeConditions for RandomNumber: '<S16>/Random Number2'
    EX3_CircularTrajectoryNew_B.d = floor
      (EX3_CircularTrajectoryNew_P.RandomNumber2_Seed);
    if (rtIsNaN(EX3_CircularTrajectoryNew_B.d) || rtIsInf
        (EX3_CircularTrajectoryNew_B.d)) {
      EX3_CircularTrajectoryNew_B.d = 0.0;
    } else {
    ...
    EX3_CircularTrajectoryNew_DW.RandSeed_b = tseed;
    EX3_CircularTrajectoryNew_DW.NextOutput_e = EX3__rt_nrand_Upu32_Yd_f_pw_snf(
      &EX3_CircularTrajectoryNew_DW.RandSeed_b) *
      EX3_CircularTrajectoryNew_P.RandomNumber2_StdDev +
      EX3_CircularTrajectoryNew_P.RandomNumber2_Mean;
    ...
    EX3_CircularTrajectoryNew_DW.AccelerationtoVelocity_DSTATE_k[0] =
      EX3_CircularTrajectoryNew_P.AccelerationtoVelocity_IC_f;

    // InitializeConditions for DiscreteIntegrator: '<S501>/Velocity to Position' 
    EX3_CircularTrajectoryNew_DW.VelocitytoPosition_DSTATE_p[0] =
      EX3_CircularTrajectoryNew_P.drop_states_BLUE[0];
    ...
    // InitializeConditions for DiscreteIntegrator: '<S501>/Velocity to Position' 
    EX3_CircularTrajectoryNew_DW.VelocitytoPosition_DSTATE_p[1] =
      EX3_CircularTrajectoryNew_P.drop_states_BLUE[1];
    ...
    // InitializeConditions for DiscreteIntegrator: '<S501>/Velocity to Position' 
    EX3_CircularTrajectoryNew_DW.VelocitytoPosition_DSTATE_p[2] =
      EX3_CircularTrajectoryNew_P.drop_states_BLUE[2];

    // InitializeConditions for RandomNumber: '<S501>/Random Number'
    EX3_CircularTrajectoryNew_B.d = floor
      (EX3_CircularTrajectoryNew_P.RandomNumber_Seed_a);
    if (rtIsNaN(EX3_CircularTrajectoryNew_B.d) || rtIsInf
        (EX3_CircularTrajectoryNew_B.d)) {
      EX3_CircularTrajectoryNew_B.d = 0.0;
    } else {
    ...
    EX3_CircularTrajectoryNew_DW.RandSeed_m = tseed;
    EX3_CircularTrajectoryNew_DW.NextOutput_m = EX3__rt_nrand_Upu32_Yd_f_pw_snf(
      &EX3_CircularTrajectoryNew_DW.RandSeed_m) * sqrt
      (EX3_CircularTrajectoryNew_P.noise_variance_BLUE) +
      EX3_CircularTrajectoryNew_P.RandomNumber_Mean_o;

    // End of InitializeConditions for RandomNumber: '<S501>/Random Number'

    // InitializeConditions for Delay: '<S521>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_lf = 1U;

    // InitializeConditions for Delay: '<S514>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_aq = 1U;

    // InitializeConditions for RandomNumber: '<S16>/Random Number4'
    EX3_CircularTrajectoryNew_B.d = floor
      (EX3_CircularTrajectoryNew_P.RandomNumber4_Seed);
    if (rtIsNaN(EX3_CircularTrajectoryNew_B.d) || rtIsInf
        (EX3_CircularTrajectoryNew_B.d)) {
      EX3_CircularTrajectoryNew_B.d = 0.0;
    } else {
    ...
    EX3_CircularTrajectoryNew_DW.RandSeed_g = tseed;
    EX3_CircularTrajectoryNew_DW.NextOutput_f = EX3__rt_nrand_Upu32_Yd_f_pw_snf(
      &EX3_CircularTrajectoryNew_DW.RandSeed_g) *
      EX3_CircularTrajectoryNew_P.RandomNumber5_StdDev +
      EX3_CircularTrajectoryNew_P.RandomNumber5_Mean;
    ...
    EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator_PrevRese = 2;
    EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator_IC_LOADI = 1U;

    // InitializeConditions for DiscreteIntegrator: '<S16>/Discrete-Time Integrator1' 
    EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_PrevRes = 2;
    EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_IC_LOAD = 1U;

    // InitializeConditions for DiscreteIntegrator: '<S16>/Discrete-Time Integrator2' 
    EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator2_PrevRes = 2;
    EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator2_IC_LOAD = 1U;

    // InitializeConditions for DiscreteIntegrator: '<S505>/Acceleration  to Velocity' 
    EX3_CircularTrajectoryNew_DW.AccelerationtoVelocity_DSTATE_j[0] =
      EX3_CircularTrajectoryNew_P.AccelerationtoVelocity_IC_k;

    // InitializeConditions for DiscreteIntegrator: '<S505>/Velocity to Position' 
    EX3_CircularTrajectoryNew_DW.VelocitytoPosition_DSTATE_h[0] =
      EX3_CircularTrajectoryNew_P.drop_states_RED[0];
    ...
    // InitializeConditions for DiscreteIntegrator: '<S505>/Velocity to Position' 
    EX3_CircularTrajectoryNew_DW.VelocitytoPosition_DSTATE_h[1] =
      EX3_CircularTrajectoryNew_P.drop_states_RED[1];
    ...
    // InitializeConditions for DiscreteIntegrator: '<S505>/Velocity to Position' 
    EX3_CircularTrajectoryNew_DW.VelocitytoPosition_DSTATE_h[2] =
      EX3_CircularTrajectoryNew_P.drop_states_RED[2];

    // InitializeConditions for RandomNumber: '<S505>/Random Number'
    EX3_CircularTrajectoryNew_B.d = floor
      (EX3_CircularTrajectoryNew_P.RandomNumber_Seed_n);
    if (rtIsNaN(EX3_CircularTrajectoryNew_B.d) || rtIsInf
        (EX3_CircularTrajectoryNew_B.d)) {
      EX3_CircularTrajectoryNew_B.d = 0.0;
    } else {
    ...
    EX3_CircularTrajectoryNew_DW.RandSeed_pz = tseed;
    EX3_CircularTrajectoryNew_DW.NextOutput_l = EX3__rt_nrand_Upu32_Yd_f_pw_snf(
      &EX3_CircularTrajectoryNew_DW.RandSeed_pz) * sqrt
      (EX3_CircularTrajectoryNew_P.noise_variance_RED) +
      EX3_CircularTrajectoryNew_P.RandomNumber_Mean_n;
    ...
    EX3_CircularTrajectoryNew_DW.icLoad_ky = 1U;

    // InitializeConditions for Delay: '<S510>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_eg = 1U;

    // InitializeConditions for RandomNumber: '<S16>/Random Number7'
    EX3_CircularTrajectoryNew_B.d = floor
      (EX3_CircularTrajectoryNew_P.RandomNumber7_Seed);
    if (rtIsNaN(EX3_CircularTrajectoryNew_B.d) || rtIsInf
        (EX3_CircularTrajectoryNew_B.d)) {
      EX3_CircularTrajectoryNew_B.d = 0.0;
    } else {
    ...
    EX3_CircularTrajectoryNew_DW.RandSeed_a = tseed;
    EX3_CircularTrajectoryNew_DW.NextOutput_n = EX3__rt_nrand_Upu32_Yd_f_pw_snf(
      &EX3_CircularTrajectoryNew_DW.RandSeed_a) *
      EX3_CircularTrajectoryNew_P.RandomNumber7_StdDev +
      EX3_CircularTrajectoryNew_P.RandomNumber7_Mean;
    ...
    EX3_CircularTrajectoryNew_DW.icLoad_h5 = 1U;

    // InitializeConditions for Delay: '<S511>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_p = 1U;

    // InitializeConditions for RandomNumber: '<S16>/Random Number6'
    EX3_CircularTrajectoryNew_B.d = floor
      (EX3_CircularTrajectoryNew_P.RandomNumber6_Seed);
    if (rtIsNaN(EX3_CircularTrajectoryNew_B.d) || rtIsInf
        (EX3_CircularTrajectoryNew_B.d)) {
      EX3_CircularTrajectoryNew_B.d = 0.0;
    } else {
    ...
    EX3_CircularTrajectoryNew_DW.RandSeed_b3 = tseed;
    EX3_CircularTrajectoryNew_DW.NextOutput_hl = EX3__rt_nrand_Upu32_Yd_f_pw_snf
      (&EX3_CircularTrajectoryNew_DW.RandSeed_b3) *
      EX3_CircularTrajectoryNew_P.RandomNumber6_StdDev +
      EX3_CircularTrajectoryNew_P.RandomNumber6_Mean;
    ...
    EX3_CircularTrajectoryNew_DW.icLoad_c = 1U;

    // InitializeConditions for RandomNumber: '<S16>/Random Number8'
    EX3_CircularTrajectoryNew_B.d = floor
      (EX3_CircularTrajectoryNew_P.RandomNumber8_Seed);
    if (rtIsNaN(EX3_CircularTrajectoryNew_B.d) || rtIsInf
        (EX3_CircularTrajectoryNew_B.d)) {
      EX3_CircularTrajectoryNew_B.d = 0.0;
    } else {
    ...
    EX3_CircularTrajectoryNew_DW.RandSeed_iv = tseed;
    EX3_CircularTrajectoryNew_DW.NextOutput_fw = EX3__rt_nrand_Upu32_Yd_f_pw_snf
      (&EX3_CircularTrajectoryNew_DW.RandSeed_iv) *
      EX3_CircularTrajectoryNew_P.RandomNumber8_StdDev +
      EX3_CircularTrajectoryNew_P.RandomNumber8_Mean;
    ...
    EX3_CircularTrajectoryNew_B.In1_k0 = EX3_CircularTrajectoryNew_P.Out1_Y0_fg;
    ...
    EX3_CircularTrajectoryNew_B.In1_fw = EX3_CircularTrajectoryNew_P.Out1_Y0_pt;
    ...
    EX3_CircularTrajectoryNew_B.In1_gi = EX3_CircularTrajectoryNew_P.Out1_Y0_ls;
    ...
    EX3_CircularTrajectoryNew_B.In1_fu = EX3_CircularTrajectoryNew_P.Out1_Y0_c4g;
    ...
    EX3_CircularTrajectoryNew_B.In1_m = EX3_CircularTrajectoryNew_P.Out1_Y0_gp;
    ...
    EX3_CircularTrajectoryNew_B.In1_b0 = EX3_CircularTrajectoryNew_P.Out1_Y0_m2;
    ...
    EX3_CircularTrajectoryNew_B.In1_hg = EX3_CircularTrajectoryNew_P.Out1_Y0_gr;
    ...
    EX3_CircularTrajectoryNew_B.In1_n0 = EX3_CircularTrajectoryNew_P.Out1_Y0_gq;
    ...
    EX3_CircularTrajectoryNew_B.In_l[0] = EX3_CircularTrajectoryNew_P._Y0[0];
    ...
    EX3_CircularTrajectoryNew_B.In_k[0] = EX3_CircularTrajectoryNew_P._Y0_g[0];
    ...
    EX3_CircularTrajectoryNew_B.In[0] = EX3_CircularTrajectoryNew_P._Y0_e[0];

    // End of SystemInitialize for SubSystem: '<S508>/Sample and Hold'

    // SystemInitialize for Triggered SubSystem: '<S506>/Sample and Hold1'
    // SystemInitialize for Outport: '<S528>/ '
    EX3_CircularTrajectoryNew_B.In_l[1] = EX3_CircularTrajectoryNew_P._Y0[1];

    // End of SystemInitialize for SubSystem: '<S506>/Sample and Hold1'

    // SystemInitialize for Triggered SubSystem: '<S507>/Sample and Hold1'
    // SystemInitialize for Outport: '<S530>/ '
    EX3_CircularTrajectoryNew_B.In_k[1] = EX3_CircularTrajectoryNew_P._Y0_g[1];

    // End of SystemInitialize for SubSystem: '<S507>/Sample and Hold1'

    // SystemInitialize for Triggered SubSystem: '<S508>/Sample and Hold'
    // SystemInitialize for Outport: '<S532>/ '
    EX3_CircularTrajectoryNew_B.In[1] = EX3_CircularTrajectoryNew_P._Y0_e[1];

    // End of SystemInitialize for SubSystem: '<S508>/Sample and Hold'

    // SystemInitialize for Triggered SubSystem: '<S506>/Sample and Hold1'
    // SystemInitialize for Outport: '<S528>/ '
    EX3_CircularTrajectoryNew_B.In_l[2] = EX3_CircularTrajectoryNew_P._Y0[2];

    // End of SystemInitialize for SubSystem: '<S506>/Sample and Hold1'

    // SystemInitialize for Triggered SubSystem: '<S507>/Sample and Hold1'
    // SystemInitialize for Outport: '<S530>/ '
    EX3_CircularTrajectoryNew_B.In_k[2] = EX3_CircularTrajectoryNew_P._Y0_g[2];

    // End of SystemInitialize for SubSystem: '<S507>/Sample and Hold1'

    // SystemInitialize for Triggered SubSystem: '<S508>/Sample and Hold'
    // SystemInitialize for Outport: '<S532>/ '
    EX3_CircularTrajectoryNew_B.In[2] = EX3_CircularTrajectoryNew_P._Y0_e[2];

    // End of SystemInitialize for SubSystem: '<S508>/Sample and Hold'

    // SystemInitialize for IfAction SubSystem: '<S509>/Hold this value'
    // SystemInitialize for Outport: '<S533>/Out1'
    EX3_CircularTrajectoryNew_B.In1_p = EX3_CircularTrajectoryNew_P.Out1_Y0_cg;
    ...
    EX3_CircularTrajectoryNew_B.In1_kd = EX3_CircularTrajectoryNew_P.Out1_Y0_lc;
    ...
    EX3_CircularTrajectoryNew_B.In1_ed = EX3_CircularTrajectoryNew_P.Out1_Y0_j5;
    ...
    EX3_CircularTrajectoryNew_B.In1_dl = EX3_CircularTrajectoryNew_P.Out1_Y0_cu;
    ...
    EX3_CircularTrajectoryNew_B.In1_ju = EX3_CircularTrajectoryNew_P.Out1_Y0_or;
    ...
    EX3_CircularTrajectoryNew_DW.obj_iv.matlabCodegenIsDeleted = true;
    EX3_CircularTrajectoryNew_DW.obj_iv.isInitialized = 0;
    EX3_CircularTrajectoryNew_DW.obj_iv.matlabCodegenIsDeleted = false;
    EX3_CircularTrajectoryNew_DW.obj_iv.isSetupComplete = false;
    EX3_CircularTrajectoryNew_DW.obj_iv.isInitialized = 1;
    MW_gpioInit(10U, true);
    EX3_CircularTrajectoryNew_DW.obj_iv.isSetupComplete = true;

    // Start for MATLABSystem: '<S21>/Digital Write'
    EX3_CircularTrajectoryNew_DW.obj_a.matlabCodegenIsDeleted = true;
    EX3_CircularTrajectoryNew_DW.obj_a.isInitialized = 0;
    EX3_CircularTrajectoryNew_DW.obj_a.matlabCodegenIsDeleted = false;
    EX3_CircularTrajectoryNew_DW.obj_a.isSetupComplete = false;
    EX3_CircularTrajectoryNew_DW.obj_a.isInitialized = 1;
    MW_gpioInit(26U, true);
    EX3_CircularTrajectoryNew_DW.obj_a.isSetupComplete = true;
    ...
    EX3_CircularTrajectoryNew_DW.obj_m.matlabCodegenIsDeleted = true;
    EX3_CircularTrajectoryNew_DW.obj_m.isInitialized = 0;
    EX3_CircularTrajectoryNew_DW.obj_m.matlabCodegenIsDeleted = false;
    EX3_CircularTrajectoryNew_DW.obj_m.isSetupComplete = false;
    EX3_CircularTrajectoryNew_DW.obj_m.isInitialized = 1;
    EX3_CircularTrajectoryNew_DW.obj_m.PinNumber = 27U;
    ret = EXT_PWMBlock_init(EX3_CircularTrajectoryNew_DW.obj_m.PinNumber, 10U,
      0.0);
    if (ret != 0) {
      for (ret = 0; ret < 45; ret++) {
        EX3_CircularTrajectoryNew_B.cv[ret] = tmp[ret];
      }

      printf(EX3_CircularTrajectoryNew_B.cv,
             EX3_CircularTrajectoryNew_DW.obj_m.PinNumber);
    }

    EX3_CircularTrajectoryNew_DW.obj_m.isSetupComplete = true;

    // End of Start for MATLABSystem: '<S26>/RED T1 - BLACK T8'

    // Start for MATLABSystem: '<S26>/RED T2 - BLACK T3'
    EX3_CircularTrajectoryNew_DW.obj_ma.matlabCodegenIsDeleted = true;
    EX3_CircularTrajectoryNew_DW.obj_ma.isInitialized = 0;
    EX3_CircularTrajectoryNew_DW.obj_ma.matlabCodegenIsDeleted = false;
    EX3_CircularTrajectoryNew_DW.obj_ma.isSetupComplete = false;
    EX3_CircularTrajectoryNew_DW.obj_ma.isInitialized = 1;
    EX3_CircularTrajectoryNew_DW.obj_ma.PinNumber = 19U;
    ret = EXT_PWMBlock_init(EX3_CircularTrajectoryNew_DW.obj_ma.PinNumber, 10U,
      0.0);
    if (ret != 0) {
      for (ret = 0; ret < 45; ret++) {
        EX3_CircularTrajectoryNew_B.cv[ret] = tmp[ret];
      ...
      printf(EX3_CircularTrajectoryNew_B.cv,
             EX3_CircularTrajectoryNew_DW.obj_ma.PinNumber);
    }

    EX3_CircularTrajectoryNew_DW.obj_ma.isSetupComplete = true;

    // End of Start for MATLABSystem: '<S26>/RED T2 - BLACK T3'

    // Start for MATLABSystem: '<S26>/RED T3'
    EX3_CircularTrajectoryNew_DW.obj_h.matlabCodegenIsDeleted = true;
    EX3_CircularTrajectoryNew_DW.obj_h.isInitialized = 0;
    EX3_CircularTrajectoryNew_DW.obj_h.matlabCodegenIsDeleted = false;
    EX3_CircularTrajectoryNew_DW.obj_h.isSetupComplete = false;
    EX3_CircularTrajectoryNew_DW.obj_h.isInitialized = 1;
    EX3_CircularTrajectoryNew_DW.obj_h.PinNumber = 4U;
    ret = EXT_PWMBlock_init(EX3_CircularTrajectoryNew_DW.obj_h.PinNumber, 10U,
      0.0);
    if (ret != 0) {
      for (ret = 0; ret < 45; ret++) {
        EX3_CircularTrajectoryNew_B.cv[ret] = tmp[ret];
      ...
      printf(EX3_CircularTrajectoryNew_B.cv,
             EX3_CircularTrajectoryNew_DW.obj_h.PinNumber);
    }

    EX3_CircularTrajectoryNew_DW.obj_h.isSetupComplete = true;

    // End of Start for MATLABSystem: '<S26>/RED T3'

    // Start for MATLABSystem: '<S26>/RED T4 - BLACK T5'
    EX3_CircularTrajectoryNew_DW.obj_k.matlabCodegenIsDeleted = true;
    EX3_CircularTrajectoryNew_DW.obj_k.isInitialized = 0;
    EX3_CircularTrajectoryNew_DW.obj_k.matlabCodegenIsDeleted = false;
    EX3_CircularTrajectoryNew_DW.obj_k.isSetupComplete = false;
    EX3_CircularTrajectoryNew_DW.obj_k.isInitialized = 1;
    EX3_CircularTrajectoryNew_DW.obj_k.PinNumber = 22U;
    ret = EXT_PWMBlock_init(EX3_CircularTrajectoryNew_DW.obj_k.PinNumber, 10U,
      0.0);
    if (ret != 0) {
      for (ret = 0; ret < 45; ret++) {
        EX3_CircularTrajectoryNew_B.cv[ret] = tmp[ret];
      ...
      printf(EX3_CircularTrajectoryNew_B.cv,
             EX3_CircularTrajectoryNew_DW.obj_k.PinNumber);
    }

    EX3_CircularTrajectoryNew_DW.obj_k.isSetupComplete = true;

    // End of Start for MATLABSystem: '<S26>/RED T4 - BLACK T5'

    // Start for MATLABSystem: '<S26>/RED T5 - BLACK T4'
    EX3_CircularTrajectoryNew_DW.obj_hw.matlabCodegenIsDeleted = true;
    EX3_CircularTrajectoryNew_DW.obj_hw.isInitialized = 0;
    EX3_CircularTrajectoryNew_DW.obj_hw.matlabCodegenIsDeleted = false;
    EX3_CircularTrajectoryNew_DW.obj_hw.isSetupComplete = false;
    EX3_CircularTrajectoryNew_DW.obj_hw.isInitialized = 1;
    EX3_CircularTrajectoryNew_DW.obj_hw.PinNumber = 5U;
    ret = EXT_PWMBlock_init(EX3_CircularTrajectoryNew_DW.obj_hw.PinNumber, 10U,
      0.0);
    if (ret != 0) {
      for (ret = 0; ret < 45; ret++) {
        EX3_CircularTrajectoryNew_B.cv[ret] = tmp[ret];
      ...
      printf(EX3_CircularTrajectoryNew_B.cv,
             EX3_CircularTrajectoryNew_DW.obj_hw.PinNumber);
    }

    EX3_CircularTrajectoryNew_DW.obj_hw.isSetupComplete = true;

    // End of Start for MATLABSystem: '<S26>/RED T5 - BLACK T4'

    // Start for MATLABSystem: '<S26>/RED T6 - BLACK T7'
    EX3_CircularTrajectoryNew_DW.obj_hf.matlabCodegenIsDeleted = true;
    EX3_CircularTrajectoryNew_DW.obj_hf.isInitialized = 0;
    EX3_CircularTrajectoryNew_DW.obj_hf.matlabCodegenIsDeleted = false;
    EX3_CircularTrajectoryNew_DW.obj_hf.isSetupComplete = false;
    EX3_CircularTrajectoryNew_DW.obj_hf.isInitialized = 1;
    EX3_CircularTrajectoryNew_DW.obj_hf.PinNumber = 6U;
    ret = EXT_PWMBlock_init(EX3_CircularTrajectoryNew_DW.obj_hf.PinNumber, 10U,
      0.0);
    if (ret != 0) {
      for (ret = 0; ret < 45; ret++) {
        EX3_CircularTrajectoryNew_B.cv[ret] = tmp[ret];
      ...
      printf(EX3_CircularTrajectoryNew_B.cv,
             EX3_CircularTrajectoryNew_DW.obj_hf.PinNumber);
    }

    EX3_CircularTrajectoryNew_DW.obj_hf.isSetupComplete = true;

    // End of Start for MATLABSystem: '<S26>/RED T6 - BLACK T7'

    // Start for MATLABSystem: '<S26>/RED T7 - BLACK T6'
    EX3_CircularTrajectoryNew_DW.obj_c.matlabCodegenIsDeleted = true;
    EX3_CircularTrajectoryNew_DW.obj_c.isInitialized = 0;
    EX3_CircularTrajectoryNew_DW.obj_c.matlabCodegenIsDeleted = false;
    EX3_CircularTrajectoryNew_DW.obj_c.isSetupComplete = false;
    EX3_CircularTrajectoryNew_DW.obj_c.isInitialized = 1;
    EX3_CircularTrajectoryNew_DW.obj_c.PinNumber = 13U;
    ret = EXT_PWMBlock_init(EX3_CircularTrajectoryNew_DW.obj_c.PinNumber, 10U,
      0.0);
    if (ret != 0) {
      for (ret = 0; ret < 45; ret++) {
        EX3_CircularTrajectoryNew_B.cv[ret] = tmp[ret];
      ...
      printf(EX3_CircularTrajectoryNew_B.cv,
             EX3_CircularTrajectoryNew_DW.obj_c.PinNumber);
    }

    EX3_CircularTrajectoryNew_DW.obj_c.isSetupComplete = true;

    // End of Start for MATLABSystem: '<S26>/RED T7 - BLACK T6'

    // Start for MATLABSystem: '<S26>/RED T8 - BLACK T1'
    EX3_CircularTrajectoryNew_DW.obj_fo.matlabCodegenIsDeleted = true;
    EX3_CircularTrajectoryNew_DW.obj_fo.isInitialized = 0;
    EX3_CircularTrajectoryNew_DW.obj_fo.matlabCodegenIsDeleted = false;
    EX3_CircularTrajectoryNew_DW.obj_fo.isSetupComplete = false;
    EX3_CircularTrajectoryNew_DW.obj_fo.isInitialized = 1;
    EX3_CircularTrajectoryNew_DW.obj_fo.PinNumber = 17U;
    ret = EXT_PWMBlock_init(EX3_CircularTrajectoryNew_DW.obj_fo.PinNumber, 10U,
      0.0);
    if (ret != 0) {
      for (ret = 0; ret < 45; ret++) {
        EX3_CircularTrajectoryNew_B.cv[ret] = tmp[ret];
      ...
      printf(EX3_CircularTrajectoryNew_B.cv,
             EX3_CircularTrajectoryNew_DW.obj_fo.PinNumber);
    }

    EX3_CircularTrajectoryNew_DW.obj_fo.isSetupComplete = true;

    // End of Start for MATLABSystem: '<S26>/RED T8 - BLACK T1'

    // Start for MATLABSystem: '<S26>/BLACK T2'
    EX3_CircularTrajectoryNew_DW.obj_ci.matlabCodegenIsDeleted = true;
    EX3_CircularTrajectoryNew_DW.obj_ci.isInitialized = 0;
    EX3_CircularTrajectoryNew_DW.obj_ci.matlabCodegenIsDeleted = false;
    EX3_CircularTrajectoryNew_DW.obj_ci.isSetupComplete = false;
    EX3_CircularTrajectoryNew_DW.obj_ci.isInitialized = 1;
    EX3_CircularTrajectoryNew_DW.obj_ci.PinNumber = 9U;
    ret = EXT_PWMBlock_init(EX3_CircularTrajectoryNew_DW.obj_ci.PinNumber, 10U,
      0.0);
    if (ret != 0) {
      for (ret = 0; ret < 45; ret++) {
        EX3_CircularTrajectoryNew_B.cv[ret] = tmp[ret];
      ...
      printf(EX3_CircularTrajectoryNew_B.cv,
             EX3_CircularTrajectoryNew_DW.obj_ci.PinNumber);
    }

    EX3_CircularTrajectoryNew_DW.obj_ci.isSetupComplete = true;
    ...
    for (ret = 0; ret < 8; ret++) {
      EX3_CircularTrajectoryNew_B.sf_MATLABFunction2.ThrustPer_Final[ret] =
        EX3_CircularTrajectoryNew_P.BLACKPWM_Y0;
    }
    ...
    for (ret = 0; ret < 8; ret++) {
      EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_n.ThrustPer_Final[ret] =
        EX3_CircularTrajectoryNew_P.BLUEPWM_Y0;
    }
    ...
    for (ret = 0; ret < 8; ret++) {
      EX3_CircularTrajectoryNew_B.sf_MATLABFunction2_l.ThrustPer_Final[ret] =
        EX3_CircularTrajectoryNew_P.REDPWM_Y0;
    }
    ...
    EX3_CircularTrajectoryNew_DW.Delay1_DSTATE_kt =
      EX3_CircularTrajectoryNew_P.Delay1_InitialCondition;

    // InitializeConditions for Delay: '<S63>/Delay2'
    EX3_CircularTrajectoryNew_DW.Delay2_DSTATE[0] =
      EX3_CircularTrajectoryNew_P.Delay2_InitialCondition;
    EX3_CircularTrajectoryNew_DW.Delay2_DSTATE[1] =
      EX3_CircularTrajectoryNew_P.Delay2_InitialCondition;

    // InitializeConditions for Delay: '<S63>/Delay5'
    EX3_CircularTrajectoryNew_DW.Delay5_DSTATE[0] =
      EX3_CircularTrajectoryNew_P.Delay5_InitialCondition;
    EX3_CircularTrajectoryNew_DW.Delay5_DSTATE[1] =
      EX3_CircularTrajectoryNew_P.Delay5_InitialCondition;
    EX3_CircularTrajectoryNew_DW.Delay5_DSTATE[2] =
      EX3_CircularTrajectoryNew_P.Delay5_InitialCondition;
    ...
    EX3_CircularTrajectoryNew_DW.Delay3_DSTATE[0] =
      EX3_CircularTrajectoryNew_P.Delay3_InitialCondition;
    EX3_CircularTrajectoryNew_DW.Delay3_DSTATE[1] =
      EX3_CircularTrajectoryNew_P.Delay3_InitialCondition;
    EX3_CircularTrajectoryNew_DW.Delay3_DSTATE[2] =
      EX3_CircularTrajectoryNew_P.Delay3_InitialCondition;
    ...
    for (ret = 0; ret < 5; ret++) {
      EX3_CircularTrajectoryNew_DW.Delay4_DSTATE[ret] =
        EX3_CircularTrajectoryNew_P.Delay4_InitialCondition;
    }
    ...
    EX3_CircularTrajectoryNew_DW.Delay_DSTATE =
      EX3_CircularTrajectoryNew_P.Delay_InitialCondition;

    // SystemInitialize for Atomic SubSystem: '<S59>/Send Direction to Motor Controller' 
    // Start for MATLABSystem: '<S71>/Digital Write'
    EX3_CircularTrajectoryNew_DW.obj_b.matlabCodegenIsDeleted = true;
    EX3_CircularTrajectoryNew_DW.obj_b.isInitialized = 0;
    EX3_CircularTrajectoryNew_DW.obj_b.matlabCodegenIsDeleted = false;
    EX3_CircularTrajectoryNew_DW.obj_b.isSetupComplete = false;
    EX3_CircularTrajectoryNew_DW.obj_b.isInitialized = 1;
    MW_gpioInit(21U, true);
    EX3_CircularTrajectoryNew_DW.obj_b.isSetupComplete = true;
    ...
    EX3_CircularTrajectoryNew_DW.obj_d.matlabCodegenIsDeleted = true;
    EX3_CircularTrajectoryNew_DW.obj_d.isInitialized = 0;
    EX3_CircularTrajectoryNew_DW.obj_d.matlabCodegenIsDeleted = false;
    EX3_CircularTrajectoryNew_DW.obj_d.isSetupComplete = false;
    EX3_CircularTrajectoryNew_DW.obj_d.isInitialized = 1;
    EX3_CircularTrajectoryNew_DW.obj_d.PinNumber = 18U;
    ret = EXT_PWMBlock_init(EX3_CircularTrajectoryNew_DW.obj_d.PinNumber, 10U,
      0.0);
    if (ret != 0) {
      for (ret = 0; ret < 45; ret++) {
        EX3_CircularTrajectoryNew_B.cv[ret] = tmp[ret];
      ...
      printf(EX3_CircularTrajectoryNew_B.cv,
             EX3_CircularTrajectoryNew_DW.obj_d.PinNumber);
    }

    EX3_CircularTrajectoryNew_DW.obj_d.isSetupComplete = true;
    ...
    EX3_CircularTrajectoryNew_DW.obj_cp.matlabCodegenIsDeleted = true;
    EX3_CircularTrajectoryNew_DW.obj_cp.isInitialized = 0;
    EX3_CircularTrajectoryNew_DW.obj_cp.matlabCodegenIsDeleted = false;
    EX3_CircularTrajectoryNew_DW.obj_cp.isSetupComplete = false;
    EX3_CircularTrajectoryNew_DW.obj_cp.isInitialized = 1;
    MW_gpioInit(25U, true);
    EX3_CircularTrajectoryNew_DW.obj_cp.isSetupComplete = true;
    ...
    EX3_CircularTrajectoryNew_DW.obj_fq.matlabCodegenIsDeleted = true;
    EX3_CircularTrajectoryNew_DW.obj_fq.isInitialized = 0;
    EX3_CircularTrajectoryNew_DW.obj_fq.matlabCodegenIsDeleted = false;
    if (((!rtIsInf(EX3_CircularTrajectoryNew_P.DigitalRead_SampleTime)) &&
         (!rtIsNaN(EX3_CircularTrajectoryNew_P.DigitalRead_SampleTime))) ||
        rtIsInf(EX3_CircularTrajectoryNew_P.DigitalRead_SampleTime)) {
      EX3_CircularTrajectoryNew_B.sampleTime =
        EX3_CircularTrajectoryNew_P.DigitalRead_SampleTime;
    }

    EX3_CircularTrajectoryNew_DW.obj_fq.SampleTime =
      EX3_CircularTrajectoryNew_B.sampleTime;
    EX3_CircularTrajectoryNew_DW.obj_fq.isSetupComplete = false;
    EX3_CircularTrajectoryNew_DW.obj_fq.isInitialized = 1;
    MW_gpioInit(24U, false);
    EX3_CircularTrajectoryNew_DW.obj_fq.isSetupComplete = true;
    ...
    sErr = GetErrorBuffer(&EX3_CircularTrajectoryNew_DW.UDPReceive_NetworkLib[0U]);
    CreateUDPInterface(&EX3_CircularTrajectoryNew_DW.UDPReceive_NetworkLib[0U]);
    if (*sErr == 0) {
      LibCreate_Network(&EX3_CircularTrajectoryNew_DW.UDPReceive_NetworkLib[0U],
                        0, "0.0.0.0",
                        EX3_CircularTrajectoryNew_P.UDPReceive_Port, "0.0.0.0",
                        -1, 8192, 8, 0);
    }

    if (*sErr == 0) {
      LibStart(&EX3_CircularTrajectoryNew_DW.UDPReceive_NetworkLib[0U]);
    }

    if (*sErr != 0) {
      DestroyUDPInterface(&EX3_CircularTrajectoryNew_DW.UDPReceive_NetworkLib[0U]);
      if (*sErr != 0) {
        rtmSetErrorStatus(EX3_CircularTrajectoryNew_M, sErr);
        rtmSetStopRequested(EX3_CircularTrajectoryNew_M, 1);
      }
    ...
    EX3_CircularTrajectoryNew_DW.icLoad_ky1 = 1U;

    // InitializeConditions for Delay: '<S82>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_of = 1U;

    // InitializeConditions for Delay: '<S88>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_oi = 1U;

    // InitializeConditions for Delay: '<S83>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_hb = 1U;

    // InitializeConditions for S-Function (sdspunwrap2): '<S79>/Unwrap1'
    EX3_CircularTrajectoryNew_DW.Unwrap1_FirstStep_o = true;

    // InitializeConditions for Delay: '<S89>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_ap = 1U;

    // InitializeConditions for Delay: '<S84>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_hc = 1U;

    // InitializeConditions for Delay: '<S81>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_nn = 1U;

    // InitializeConditions for Delay: '<S90>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_gc = 1U;

    // InitializeConditions for Delay: '<S85>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_d0 = 1U;

    // InitializeConditions for Delay: '<S91>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_a1a = 1U;

    // InitializeConditions for S-Function (sdspunwrap2): '<S79>/Unwrap'
    EX3_CircularTrajectoryNew_DW.Unwrap_FirstStep_p = true;

    // InitializeConditions for Delay: '<S86>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_ms = 1U;

    // InitializeConditions for Delay: '<S92>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_gi = 1U;

    // SystemInitialize for IfAction SubSystem: '<S81>/Hold this value'
    // SystemInitialize for Outport: '<S93>/Out1'
    EX3_CircularTrajectoryNew_B.In1_kw = EX3_CircularTrajectoryNew_P.Out1_Y0_e2;
    ...
    EX3_CircularTrajectoryNew_B.In1_fg = EX3_CircularTrajectoryNew_P.Out1_Y0_a;
    ...
    EX3_CircularTrajectoryNew_B.In1_jj = EX3_CircularTrajectoryNew_P.Out1_Y0_bu;
    ...
    EX3_CircularTrajectoryNew_B.In1_gw = EX3_CircularTrajectoryNew_P.Out1_Y0_i;
    ...
    EX3_CircularTrajectoryNew_B.In1_jp3 = EX3_CircularTrajectoryNew_P.Out1_Y0_bw;
    ...
    EX3_CircularTrajectoryNew_B.In1_cxn = EX3_CircularTrajectoryNew_P.Out1_Y0_j;
    ...
    EX3_CircularTrajectoryNew_B.In1_dn = EX3_CircularTrajectoryNew_P.Out1_Y0_j3;
    ...
    EX3_CircularTrajectoryNew_B.In1_jk = EX3_CircularTrajectoryNew_P.Out1_Y0_lj;
    ...
    EX3_CircularTrajectoryNew_B.In1_fr = EX3_CircularTrajectoryNew_P.Out1_Y0_g;
    ...
    EX3_CircularTrajectoryNew_B.In1_df = EX3_CircularTrajectoryNew_P.Out1_Y0_id;
    ...
    EX3_CircularTrajectoryNew_B.In1_dr = EX3_CircularTrajectoryNew_P.Out1_Y0_j1;
    ...
    EX3_CircularTrajectoryNew_B.In1_oi = EX3_CircularTrajectoryNew_P.Out1_Y0_fb;
    ...
    if (*sErr == 0) {
      LibCreate_Network
        (&EX3_CircularTrajectoryNew_DW.SendBLACKStatestoBLACKPlatform_[0U], 1,
         "255.255.255.255", -1, "192.168.0.101",
         EX3_CircularTrajectoryNew_P.SendBLACKStatestoBLACKPlatform_, 8192, 8, 0);
    }

    if (*sErr == 0) {
      LibStart(&EX3_CircularTrajectoryNew_DW.SendBLACKStatestoBLACKPlatform_[0U]);
    }
    ...
    EX3_CircularTrajectoryNew_B.In1_nh =
      EX3_CircularTrajectoryNew_P.ActualTime_Y0_l;
    ...
    EX3_CircularTrajectoryNew_B.In1_gd = EX3_CircularTrajectoryNew_P.Out1_Y0_lf;
    ...
    EX3_CircularTrajectoryNew_B.In1_av = EX3_CircularTrajectoryNew_P.Out1_Y0_gx;
    ...
    EX3_CircularTrajectoryNew_B.In1_ox = EX3_CircularTrajectoryNew_P.Out1_Y0_ih;
    ...
    EX3_CircularTrajectoryNew_B.In1_kg = EX3_CircularTrajectoryNew_P.Out1_Y0_o0;
    ...
    EX3_CircularTrajectoryNew_B.In1_i2 = EX3_CircularTrajectoryNew_P.Out1_Y0_ac;
    ...
    EX3_CircularTrajectoryNew_B.In1_mc = EX3_CircularTrajectoryNew_P.Out1_Y0_bk;
    ...
    EX3_CircularTrajectoryNew_B.In1_n5 = EX3_CircularTrajectoryNew_P.Out1_Y0_l0;
    ...
    EX3_CircularTrajectoryNew_B.In1_bi = EX3_CircularTrajectoryNew_P.Out1_Y0_ok;
    ...
    EX3_CircularTrajectoryNew_B.In1_hs = EX3_CircularTrajectoryNew_P.Out1_Y0_ou;
    ...
    EX3_CircularTrajectoryNew_B.In1_lj = EX3_CircularTrajectoryNew_P.Out1_Y0_k0;
    ...
    EX3_CircularTrajectoryNew_B.In1_mj = EX3_CircularTrajectoryNew_P.Out1_Y0_ks;
    ...
    EX3_CircularTrajectoryNew_B.In1_pb = EX3_CircularTrajectoryNew_P.Out1_Y0_ju;
    ...
    EX3_CircularTrajectoryNew_DW.Delay_DSTATE_o =
      EX3_CircularTrajectoryNew_P.Delay_InitialCondition_k;

    // InitializeConditions for Delay: '<S147>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_dr = 1U;

    // InitializeConditions for Delay: '<S142>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_mq = 1U;

    // InitializeConditions for Delay: '<S148>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_lr = 1U;

    // InitializeConditions for Delay: '<S143>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_b = 1U;

    // InitializeConditions for S-Function (sdspunwrap2): '<S77>/Unwrap1'
    EX3_CircularTrajectoryNew_DW.Unwrap1_FirstStep_d = true;

    // InitializeConditions for Delay: '<S149>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_aa = 1U;

    // InitializeConditions for Delay: '<S144>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_cw = 1U;

    // InitializeConditions for Delay: '<S141>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_nsj = 1U;

    // InitializeConditions for Delay: '<S150>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_lrw = 1U;

    // InitializeConditions for Delay: '<S145>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_a2d = 1U;

    // InitializeConditions for Delay: '<S151>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_mp = 1U;

    // InitializeConditions for S-Function (sdspunwrap2): '<S77>/Unwrap'
    EX3_CircularTrajectoryNew_DW.Unwrap_FirstStep_d = true;

    // InitializeConditions for Delay: '<S146>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_gb = 1U;

    // InitializeConditions for Delay: '<S152>/Delay1'
    EX3_CircularTrajectoryNew_DW.icLoad_i = 1U;

    // SystemInitialize for Enabled SubSystem: '<S138>/Enabled Subsystem'
    // SystemInitialize for Outport: '<S154>/Out1'
    EX3_CircularTrajectoryNew_B.In1_j1 = EX3_CircularTrajectoryNew_P.Out1_Y0;
    ...
    for (ret = 0; ret < 13; ret++) {
      ...
      EX3_CircularTrajectoryNew_B.In1_n1[ret] =
        EX3_CircularTrajectoryNew_P.Out1_Y0_nx;

      // SystemInitialize for Outport: '<S139>/Out1'
      EX3_CircularTrajectoryNew_B.In1_b4[ret] =
        EX3_CircularTrajectoryNew_P.Out1_Y0_m;
    }
    ...
    EX3_CircularTrajectoryNew_B.In1_pl =
      EX3_CircularTrajectoryNew_P.ActualTime_Y0;
    ...
    EX3_CircularTrajectoryNew_B.In1_kd2 = EX3_CircularTrajectoryNew_P.Out1_Y0_l;
    ...
    EX3_CircularTrajectoryNew_B.In1_ds = EX3_CircularTrajectoryNew_P.Out1_Y0_f;
    ...
    EX3_CircularTrajectoryNew_B.In1_dy = EX3_CircularTrajectoryNew_P.Out1_Y0_e;
    ...
    EX3_CircularTrajectoryNew_B.In1_lyk = EX3_CircularTrajectoryNew_P.Out1_Y0_b;
    ...
    EX3_CircularTrajectoryNew_B.In1_mm = EX3_CircularTrajectoryNew_P.Out1_Y0_k;
    ...
    EX3_CircularTrajectoryNew_B.In1_cp = EX3_CircularTrajectoryNew_P.Out1_Y0_h;
    ...
    EX3_CircularTrajectoryNew_B.In1_d4 = EX3_CircularTrajectoryNew_P.Out1_Y0_d;
    ...
    EX3_CircularTrajectoryNew_B.In1_ljk = EX3_CircularTrajectoryNew_P.Out1_Y0_o;
    ...
    EX3_CircularTrajectoryNew_B.In1_awb = EX3_CircularTrajectoryNew_P.Out1_Y0_ec;
    ...
    EX3_CircularTrajectoryNew_B.In1_aw = EX3_CircularTrajectoryNew_P.Out1_Y0_n;
    ...
    EX3_CircularTrajectoryNew_B.In1_on = EX3_CircularTrajectoryNew_P.Out1_Y0_oi;
    ...
    EX3_CircularTrajectoryNew_B.In1_kt = EX3_CircularTrajectoryNew_P.Out1_Y0_fr;

    // End of SystemInitialize for SubSystem: '<S152>/Hold this value'

    // Start for MATLABSystem: '<S77>/Stream PhaseSpace to Platform'
    EX3_CircularTrajectoryNew_DW.obj_f.matlabCodegenIsDeleted = true;
    EX3_CircularTrajectoryNew_DW.obj_f.isInitialized = 0;
    EX3_CircularTrajectoryNew_DW.obj_f.matlabCodegenIsDeleted = false;
    EX3_CircularTrajectoryNew_DW.obj_f.platformSelection =
      EX3_CircularTrajectoryNew_P.platformSelection;
    EX3_CircularTrajectoryNew_DW.obj_f.PS_SampleRate = 1.0 /
      EX3_CircularTrajectoryNew_P.serverRate;
    EX3_CircularTrajectoryNew_DW.obj_f.isSetupComplete = false;
    EX3_CircularTrajectoryNew_DW.obj_f.isInitialized = 1;
    initialize_phasespace(EX3_CircularTrajectoryNew_DW.obj_f.platformSelection,
                          EX3_CircularTrajectoryNew_DW.obj_f.PS_SampleRate);
    EX3_CircularTrajectoryNew_DW.obj_f.isSetupComplete = true;
    ...
    EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_PrevR_o = 2;
    EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_IC_LO_i = 1U;

    // SystemInitialize for IfAction SubSystem: '<S181>/Calculate Running Mean'
    E_CalculateRunningMean_Init
      (&EX3_CircularTrajectoryNew_B.CalculateRunningMean_h,
       &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_h,
       &EX3_CircularTrajectoryNew_P.CalculateRunningMean_h);
    ...
    EX3_CircularTrajectoryNew_B.In1_jp = EX3_CircularTrajectoryNew_P.Out1_Y0_nxn;
    ...
    E_CalculateRunningMean_Init
      (&EX3_CircularTrajectoryNew_B.CalculateRunningMean,
       &EX3_CircularTrajectoryNew_DW.CalculateRunningMean,
       &EX3_CircularTrajectoryNew_P.CalculateRunningMean);
    ...
    EX3_CircularTrajectoryNew_B.In1_hd = EX3_CircularTrajectoryNew_P.Out1_Y0_l0t;
    ...
    E_CalculateRunningMean_Init
      (&EX3_CircularTrajectoryNew_B.CalculateRunningMean_e,
       &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_e,
       &EX3_CircularTrajectoryNew_P.CalculateRunningMean_e);
    ...
    EX3_CircularTrajectoryNew_B.In1_ny = EX3_CircularTrajectoryNew_P.Out1_Y0_et;
    ...
    E_CalculateRunningMean_Init
      (&EX3_CircularTrajectoryNew_B.CalculateRunningMean_d,
       &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_d,
       &EX3_CircularTrajectoryNew_P.CalculateRunningMean_d);
    ...
    EX3_CircularTrajectoryNew_B.In1_ic = EX3_CircularTrajectoryNew_P.Out1_Y0_p;
    ...
    E_CalculateRunningMean_Init
      (&EX3_CircularTrajectoryNew_B.CalculateRunningMean_a,
       &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_a,
       &EX3_CircularTrajectoryNew_P.CalculateRunningMean_a);
    ...
    EX3_CircularTrajectoryNew_B.In1_gs = EX3_CircularTrajectoryNew_P.Out1_Y0_es;
    ...
    CalculateRunningMean_n_Init
      (&EX3_CircularTrajectoryNew_B.CalculateRunningMean_ab,
       &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_ab,
       &EX3_CircularTrajectoryNew_P.CalculateRunningMean_ab);
    ...
    EX3_CircularTrajectoryNew_B.In1_cd = EX3_CircularTrajectoryNew_P.Out1_Y0_c;

    // End of SystemInitialize for SubSystem: '<S194>/Pass Current Accel'
    EX3_CircularTraj_AHRS2_Init(EX3_CircularTrajectoryNew_B.DigitalFilter_k,
      &EX3_CircularTrajectoryNew_DW.AHRS2, &EX3_CircularTrajectoryNew_P.AHRS2);
    ...
    EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_PrevR_h = 2;
    EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_IC_LO_f = 1U;

    // SystemInitialize for IfAction SubSystem: '<S212>/Calculate Running Mean'
    E_CalculateRunningMean_Init
      (&EX3_CircularTrajectoryNew_B.CalculateRunningMean_l,
       &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_l,
       &EX3_CircularTrajectoryNew_P.CalculateRunningMean_l);
    ...
    EX3_CircularTrajectoryNew_B.In1_hy = EX3_CircularTrajectoryNew_P.Out1_Y0_nl;
    ...
    E_CalculateRunningMean_Init
      (&EX3_CircularTrajectoryNew_B.CalculateRunningMean_c,
       &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_c,
       &EX3_CircularTrajectoryNew_P.CalculateRunningMean_c);
    ...
    E_CalculateRunningMean_Init
      (&EX3_CircularTrajectoryNew_B.CalculateRunningMean_f,
       &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_f,
       &EX3_CircularTrajectoryNew_P.CalculateRunningMean_f);
    ...
    E_CalculateRunningMean_Init
      (&EX3_CircularTrajectoryNew_B.CalculateRunningMean_j,
       &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_j,
       &EX3_CircularTrajectoryNew_P.CalculateRunningMean_j);
    ...
    EX3_CircularTrajectoryNew_B.In1_le = EX3_CircularTrajectoryNew_P.Out1_Y0_pj;
    ...
    E_CalculateRunningMean_Init
      (&EX3_CircularTrajectoryNew_B.CalculateRunningMean_b,
       &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_b,
       &EX3_CircularTrajectoryNew_P.CalculateRunningMean_b);
    ...
    EX3_CircularTrajectoryNew_B.In1_b1 = EX3_CircularTrajectoryNew_P.Out1_Y0_aci;
    ...
    CalculateRunningMean_n_Init
      (&EX3_CircularTrajectoryNew_B.CalculateRunningMean_o,
       &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_o,
       &EX3_CircularTrajectoryNew_P.CalculateRunningMean_o);
    ...
    EX3_CircularTrajectoryNew_B.In1_ai = EX3_CircularTrajectoryNew_P.Out1_Y0_c1;

    // End of SystemInitialize for SubSystem: '<S225>/Pass Current Accel'
    EX3_CircularTraj_AHRS2_Init(EX3_CircularTrajectoryNew_B.DigitalFilter_n,
      &EX3_CircularTrajectoryNew_DW.AHRS2_p,
      &EX3_CircularTrajectoryNew_P.AHRS2_p);
    ...
    EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_PrevR_f = 2;
    EX3_CircularTrajectoryNew_DW.DiscreteTimeIntegrator1_IC_LO_g = 1U;

    // SystemInitialize for IfAction SubSystem: '<S243>/Calculate Running Mean'
    E_CalculateRunningMean_Init
      (&EX3_CircularTrajectoryNew_B.CalculateRunningMean_et,
       &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_et,
       &EX3_CircularTrajectoryNew_P.CalculateRunningMean_et);
    ...
    EX3_CircularTrajectoryNew_B.In1_f1 = EX3_CircularTrajectoryNew_P.Out1_Y0_be;
    ...
    E_CalculateRunningMean_Init
      (&EX3_CircularTrajectoryNew_B.CalculateRunningMean_oo,
       &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_oo,
       &EX3_CircularTrajectoryNew_P.CalculateRunningMean_oo);
    ...
    EX3_CircularTrajectoryNew_B.In1_lm = EX3_CircularTrajectoryNew_P.Out1_Y0_e5;
    ...
    E_CalculateRunningMean_Init
      (&EX3_CircularTrajectoryNew_B.CalculateRunningMean_om,
       &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_om,
       &EX3_CircularTrajectoryNew_P.CalculateRunningMean_om);
    ...
    EX3_CircularTrajectoryNew_B.In1_cx = EX3_CircularTrajectoryNew_P.Out1_Y0_ov;
    ...
    E_CalculateRunningMean_Init
      (&EX3_CircularTrajectoryNew_B.CalculateRunningMean_j1,
       &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_j1,
       &EX3_CircularTrajectoryNew_P.CalculateRunningMean_j1);
    ...
    EX3_CircularTrajectoryNew_B.In1_gy = EX3_CircularTrajectoryNew_P.Out1_Y0_is;
    ...
    E_CalculateRunningMean_Init
      (&EX3_CircularTrajectoryNew_B.CalculateRunningMean_jr,
       &EX3_CircularTrajectoryNew_DW.CalculateRunningMean_jr,
       &EX3_CircularTrajectoryNew_P.CalculateRunningMean_jr);
    ...
    EX3_CircularTrajectoryNew_B.In1_e5 = EX3_CircularTrajectoryNew_P.Out1_Y0_c4;
    ...
    EX3_CircularTrajectoryNew_B.In1_gv = EX3_CircularTrajectoryNew_P.Out1_Y0_kq;

    // End of SystemInitialize for SubSystem: '<S256>/Pass Current Accel'
    EX3_CircularTraj_AHRS2_Init(EX3_CircularTrajectoryNew_B.DigitalFilter,
      &EX3_CircularTrajectoryNew_DW.AHRS2_pn,
      &EX3_CircularTrajectoryNew_P.AHRS2_pn);
    ...
    EX3_CircularTrajectoryNew_DW.obj.i2cobj_A_G.matlabCodegenIsDeleted = true;
    EX3_CircularTrajectoryNew_DW.obj.i2cobj_MAG.matlabCodegenIsDeleted = true;
    EX3_CircularTrajectoryNew_DW.obj.matlabCodegenIsDeleted = true;
    EX3_C_lsm9ds1Block_lsm9ds1Block(&EX3_CircularTrajectoryNew_DW.obj);
    EX3_CircularTr_SystemCore_setup(&EX3_CircularTrajectoryNew_DW.obj);

    // Start for MATLABSystem: '<Root>/Initialization Block for Position Control' 
    EX3_CircularTrajectoryNew_DW.obj_i.matlabCodegenIsDeleted = true;
    EX3_CircularTrajectoryNew_DW.obj_i.isInitialized = 0;
    EX3_CircularTrajectoryNew_DW.obj_i.matlabCodegenIsDeleted = false;
    EX3_CircularTrajectoryNew_DW.obj_i.P_GAIN =
      EX3_CircularTrajectoryNew_P.InitializationBlockforPositionC;
    EX3_CircularTrajectoryNew_DW.obj_i.I_GAIN =
      EX3_CircularTrajectoryNew_P.InitializationBlockforPositio_b;
    ...
    EX3_CircularTrajectoryNew_DW.obj_i.MOVE_TIME =
      EX3_CircularTrajectoryNew_P.InitializationBlockforPositi_ba;
    EX3_CircularTrajectoryNew_DW.obj_i.isSetupComplete = false;
    EX3_CircularTrajectoryNew_DW.obj_i.isInitialized = 1;
    initialize_dynamixel_position_control
      (EX3_CircularTrajectoryNew_DW.obj_i.P_GAIN,
       ...
       EX3_CircularTrajectoryNew_DW.obj_i.MIN_POSITION,
       EX3_CircularTrajectoryNew_DW.obj_i.MOVE_TIME);
    EX3_CircularTrajectoryNew_DW.obj_i.isSetupComplete = true;
  }
}

// Model terminate function
void EX3_CircularTrajectoryNew_terminate(void)
{
  char_T *sErr;
  ...
  matlabCodegenHandle_matlabCo_lo(&EX3_CircularTrajectoryNew_DW.obj_iv);

  // Terminate for MATLABSystem: '<S21>/Digital Write'
  matlabCodegenHandle_matlabC_lot(&EX3_CircularTrajectoryNew_DW.obj_a);
  ...
  EX3_CircularT_matlabCodegenHa_m(&EX3_CircularTrajectoryNew_DW.obj_f);
  ...
  sErr = GetErrorBuffer(&EX3_CircularTrajectoryNew_DW.UDPReceive_NetworkLib[0U]);
  LibTerminate(&EX3_CircularTrajectoryNew_DW.UDPReceive_NetworkLib[0U]);
  if (*sErr != 0) {
    rtmSetErrorStatus(EX3_CircularTrajectoryNew_M, sErr);
    rtmSetStopRequested(EX3_CircularTrajectoryNew_M, 1);
  }

  LibDestroy(&EX3_CircularTrajectoryNew_DW.UDPReceive_NetworkLib[0U], 0);
  DestroyUDPInterface(&EX3_CircularTrajectoryNew_DW.UDPReceive_NetworkLib[0U]);
  ...
  sErr = GetErrorBuffer
    (&EX3_CircularTrajectoryNew_DW.SendBLACKStatestoBLACKPlatform_[0U]);
  LibTerminate(&EX3_CircularTrajectoryNew_DW.SendBLACKStatestoBLACKPlatform_[0U]);
  if (*sErr != 0) {
    rtmSetErrorStatus(EX3_CircularTrajectoryNew_M, sErr);
    rtmSetStopRequested(EX3_CircularTrajectoryNew_M, 1);
  }

  LibDestroy(&EX3_CircularTrajectoryNew_DW.SendBLACKStatestoBLACKPlatform_[0U],
             1);
  DestroyUDPInterface
    (&EX3_CircularTrajectoryNew_DW.SendBLACKStatestoBLACKPlatform_[0U]);
  ...
  EX3_CircularT_matlabCodegenHa_k(&EX3_CircularTrajectoryNew_DW.obj);
  EX3_Circular_matlabCodegenHa_bq(&EX3_CircularTrajectoryNew_DW.obj.i2cobj_MAG);
  EX3_CircularT_matlabCodegenHa_b(&EX3_CircularTrajectoryNew_DW.obj.i2cobj_A_G);

  // Terminate for S-Function (sdspToNetwork): '<S15>/UDP Send'
  sErr = GetErrorBuffer(&EX3_CircularTrajectoryNew_DW.UDPSend_NetworkLib[0U]);
  LibTerminate(&EX3_CircularTrajectoryNew_DW.UDPSend_NetworkLib[0U]);
  if (*sErr != 0) {
    rtmSetErrorStatus(EX3_CircularTrajectoryNew_M, sErr);
    rtmSetStopRequested(EX3_CircularTrajectoryNew_M, 1);
  }

  LibDestroy(&EX3_CircularTrajectoryNew_DW.UDPSend_NetworkLib[0U], 1);
  DestroyUDPInterface(&EX3_CircularTrajectoryNew_DW.UDPSend_NetworkLib[0U]);
  ...
  matlabCodegenHandle_matlabCod_l(&EX3_CircularTrajectoryNew_DW.obj_i);

  // Terminate for Atomic SubSystem: '<S3>/Send Commands to PWM Blocks'
  // Terminate for MATLABSystem: '<S26>/RED T1 - BLACK T8'
  matlabCodegenHandle_matlab_loto(&EX3_CircularTrajectoryNew_DW.obj_m);

  // Terminate for MATLABSystem: '<S26>/RED T2 - BLACK T3'
  matlabCodegenHandle_matlab_loto(&EX3_CircularTrajectoryNew_DW.obj_ma);

  // Terminate for MATLABSystem: '<S26>/RED T3'
  matlabCodegenHandle_matlab_loto(&EX3_CircularTrajectoryNew_DW.obj_h);

  // Terminate for MATLABSystem: '<S26>/RED T4 - BLACK T5'
  matlabCodegenHandle_matlab_loto(&EX3_CircularTrajectoryNew_DW.obj_k);

  // Terminate for MATLABSystem: '<S26>/RED T5 - BLACK T4'
  matlabCodegenHandle_matlab_loto(&EX3_CircularTrajectoryNew_DW.obj_hw);

  // Terminate for MATLABSystem: '<S26>/RED T6 - BLACK T7'
  matlabCodegenHandle_matlab_loto(&EX3_CircularTrajectoryNew_DW.obj_hf);

  // Terminate for MATLABSystem: '<S26>/RED T7 - BLACK T6'
  matlabCodegenHandle_matlab_loto(&EX3_CircularTrajectoryNew_DW.obj_c);

  // Terminate for MATLABSystem: '<S26>/RED T8 - BLACK T1'
  matlabCodegenHandle_matlab_loto(&EX3_CircularTrajectoryNew_DW.obj_fo);

  // Terminate for MATLABSystem: '<S26>/BLACK T2'
  matlabCodegenHandle_matlab_loto(&EX3_CircularTrajectoryNew_DW.obj_ci);
  ...
  matlabCodegenHand_loto3zjx3fstw(&EX3_CircularTrajectoryNew_DW.obj_fq);
  ...
  matlabCodegenHan_loto3zjx3fstwa(&EX3_CircularTrajectoryNew_DW.obj_b);
  ...
  matlabCodegenHandle_matlab_loto(&EX3_CircularTrajectoryNew_DW.obj_d);
  ...
  EX3_CircularT_matlabCodegenHa_p(&EX3_CircularTrajectoryNew_DW.obj_cp);
